...
function Header({
  ...
  const isSingleRow = !primaryAction && !pagination && (utilities.isInterface(secondaryActions) && !secondaryActions.length || utilities.isReactElement(secondaryActions)) && !actionGroups.length;
  ...
  if (utilities.isInterface(secondaryActions) && (secondaryActions.length > 0 || ActionMenu.hasGroupsWithActions(actionGroups))) {
  ...
  } else if (utilities.isReactElement(secondaryActions)) {
...
function PrimaryActionMarkup({
  ...
  if (utilities.isInterface(primaryAction)) {
