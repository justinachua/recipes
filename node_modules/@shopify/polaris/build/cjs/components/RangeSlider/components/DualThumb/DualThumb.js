...
class DualThumb extends React.Component {
  constructor(...args) {
    ...
    this.setTrackPosition = debounce__default['default'](() => {
    ...
    this.setValue = (dirtyValue, control) => {
      ...
      if (isEqual__default['default'](sanitizedValue, value) === false) {
        this.setState({
  ...
  static getDerivedStateFromProps(props, state) {
    ...
    if (isEqual__default['default'](prevValue, value)) {
      return null;
    }

    const sanitizedValue = sanitizeValue(value, min, max, step);

    if (!isEqual__default['default'](value, sanitizedValue)) {
