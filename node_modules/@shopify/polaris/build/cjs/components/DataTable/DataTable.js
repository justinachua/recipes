...
class DataTableInner extends React.PureComponent {
  ...
  render() {
    ...
    const className = css.classNames(DataTable$1['default'].DataTable, condensed && DataTable$1['default'].condensed, totals && DataTable$1['default'].ShowTotals, showTotalsInFooter && DataTable$1['default'].ShowTotalsInFooter, increasedTableDensity && DataTable$1['default'].IncreasedTableDensity, hasZebraStripingOnData && DataTable$1['default'].ZebraStripingOnData, hasZebraStripingOnData && rowCountIsEven && DataTable$1['default'].RowCountIsEven);
