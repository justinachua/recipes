...
.Polaris-CheckableButton__Checkbox_1d6zr { pointer-events: none; height: var(--p-choice-size); width: var(--p-choice-size); margin-left: calc(var(--p-space-2)*-1 + var(--p-space-025)*-1 - var(--p-control-border-width)); }
