.Polaris-Banner_z4w8k { --pc-banner-secondary-action-horizontal-padding: var(--p-space-3); --pc-banner-secondary-action-vertical-padding: calc(var(--p-line-height-6)*0.5 - var(--p-line-height-2)*0.5); position: relative; display: flex; }
