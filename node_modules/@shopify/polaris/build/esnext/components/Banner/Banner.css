.Polaris-Banner_z4w8k { --pc-banner-rgb-text: 33, 43, 54; --pc-banner-secondary-action-horizontal-padding: var(--p-space-3); --pc-banner-secondary-action-vertical-padding: calc(var(--p-line-height-6)*0.5 - var(--p-line-height-2)*0.5); position: relative; display: flex; }
...
.Polaris-Banner--hasDismiss_kf0ua { padding-right: calc(var(--p-space-4)*2 + var(--p-icon-size-small)); }
...
.Polaris-Banner__SecondaryAction_1dl4i:hover > .Polaris-Banner__Text_yj3uv { box-shadow: 0 -0.125rem 0 0 rgba(var(--pc-banner-rgb-text), 0.75) inset; }

.Polaris-Banner__SecondaryAction_1dl4i:active > .Polaris-Banner__Text_yj3uv { box-shadow: 0 -0.125rem 0 0 rgba(var(--pc-banner-rgb-text), 0) inset; }

.Polaris-Banner__SecondaryAction_1dl4i:focus > .Polaris-Banner__Text_yj3uv { padding: 0.125rem 0.3125rem; margin: -0.125rem -0.3125rem; background: var(--p-action-secondary-hovered); border-radius: var(--p-border-radius-base); box-shadow: none; background-color: transparent; }
...
.Polaris-Banner__Text_yj3uv { position: relative; box-shadow: 0 -0.125rem 0 0 rgba(var(--pc-banner-rgb-text), 0.25) inset; -webkit-backface-visibility: hidden; backface-visibility: hidden; will-change: box-shadow; transition: box-shadow var(--p-duration-200) var(--p-ease); }
