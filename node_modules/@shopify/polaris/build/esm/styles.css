@charset "UTF-8";
:root { --polaris-version-number: '9.2.3'; }
...
.Polaris-Spinner svg { animation: Polaris-Spinner--loading var(--p-duration-500) linear infinite; fill: var(--p-border-highlight); }
...
.Polaris-Scrollable { --pc-scrollable-shadow-size: var(--p-space-5); --pc-scrollable-shadow-bottom: inset 0
    ...
    var(--p-hint-from-direct-light); -webkit-overflow-scrolling: touch; position: relative; }
...
.Polaris-Popover { max-width: calc(100vw - var(--p-space-4)*2); margin: 0.3125rem var(--p-space-2) var(--p-space-4); box-shadow: var(--p-shadow-popover); border-radius: var(--p-border-radius-2); -webkit-backface-visibility: hidden; backface-visibility: hidden; will-change: left, top; }
...
.Polaris-Badge--statusSuccess { --pc-badge-component-badge-pip-color: var(--p-icon-success); background-color: var(--p-surface-success); color: var(--p-text); }

.Polaris-Badge--statusInfo { --pc-badge-component-badge-pip-color: var(--p-icon-highlight); background-color: var(--p-surface-highlight); color: var(--p-text); }

.Polaris-Badge--statusAttention { --pc-badge-component-badge-pip-color: rgb(138, 97, 22); background-color: #ffea8a; color: var(--p-text); }

.Polaris-Badge--statusWarning { --pc-badge-component-badge-pip-color: var(--p-icon-warning); background-color: var(--p-surface-warning); color: var(--p-text); }

.Polaris-Badge--statusCritical { --pc-badge-component-badge-pip-color: var(--p-icon-critical); background-color: var(--p-surface-critical); color: var(--p-text); }

.Polaris-Badge--statusNew { background-color: var(--p-surface-neutral); color: var(--p-text); font-weight: var(--p-font-weight-medium); border: none; }

.Polaris-Badge__Pip { color: var(--pc-badge-component-badge-pip-color); height: var(--pc-badge-pip-size); width: var(--pc-badge-pip-size); margin-right: var(--pc-badge-pip-spacing); margin-left: calc(var(--pc-badge-vertical-padding) - var(--pc-badge-pip-spacing)); border: var(--p-border-width-2) solid currentColor; border-radius: var(--p-border-radius-half); flex-shrink: 0; }
...
.Polaris-TextStyle--variationCode { position: relative; padding: 0 var(--p-space-1); border-radius: var(--p-border-radius-base); background-color: var(--p-surface-subdued); display: inline-block; font-size: 1.15em; box-shadow: inset 0 0 0 0.0625rem var(--p-border-subdued); }
...
.Polaris-ActionList { --pc-action-list-image-size: 1.25rem; --pc-action-list-item-min-height: var(--p-space-10); --pc-action-list-item-vertical-padding: calc(var(--pc-action-list-item-min-height)/2 - var(--p-line-height-2)/2); outline: none; list-style: none; margin: 0; padding: 0; }
...
.Polaris-ActionList__Item { -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; position: relative; display: block; width: 100%; min-height: var(--pc-action-list-item-min-height); text-align: left; text-decoration: none; cursor: pointer; padding: var(--pc-action-list-item-vertical-padding) var(--p-space-2); border-radius: var(--p-border-radius-1); border-top: 0.0625rem solid transparent; color: inherit; }
...
.Polaris-Button { --pc-button-slim-min-height: var(--p-line-height-4); --pc-button-large-min-height: var(--p-line-height-7); --pc-button-vertical-padding: calc(var(--p-line-height-6)/2 - var(--p-line-height-2)/2 - 0.0625rem); --pc-button-slim-vertical-padding: calc(var(--pc-button-slim-min-height)/2 - var(--p-line-height-2)/2 - 0.0625rem); --pc-button-large-vertical-padding: calc(var(--pc-button-large-min-height)/2 - var(--p-line-height-2)/2 - 0.0625rem); --pc-button-spinner-size: 1.25rem; --pc-button-segment: 10; --pc-button-focused: 20; position: relative; position: relative; display: inline-flex; align-items: center; justify-content: center; min-height: var(--p-line-height-6); min-width: var(--p-line-height-6); margin: 0; padding: calc(var(--p-line-height-6)/2 - var(--p-line-height-2)/2 - var(--p-space-05)/2) var(--p-space-4); background: var(--p-surface); box-shadow: var(--p-shadow-button); border-radius: var(--p-border-radius-1); color: var(--p-text); border: 0.0625rem solid var(--p-border-neutral-subdued); border-top-color: var(--p-border-subdued); border-bottom-color: var(--p-border-shadow-subdued); line-height: 1; text-align: center; cursor: pointer; -webkit-user-select: none; user-select: none; text-decoration: none; -webkit-tap-highlight-color: transparent; }
...
.Polaris-Button--plain.Polaris-Button--iconOnly { margin: calc(var(--p-line-height-6)*-0.5 - var(--p-icon-size-medium)*-0.5); }
...
.Polaris-ButtonGroup__Item--plain:not(:first-child) { margin-left: calc(var(--p-space-2) + var(--p-space-2)); }
...
@media print { .Polaris-Subheading { font-size: 0.6875rem; } }
...
.Polaris-TextField--multiline > .Polaris-TextField__Input { overflow: auto; padding-left: calc(var(--p-space-2)*1.5); padding-right: calc(var(--p-space-2)*1.5); resize: none; }
...
.Polaris-TextField--focus > .Polaris-TextField__Input ~ .Polaris-TextField__Backdrop::after, .Polaris-TextField__Input:focus ~ .Polaris-TextField__Backdrop::after { box-shadow: 0 0 0 0.125rem var(--p-focused); outline: var(--p-border-width-1) solid transparent; }
...
.Polaris-TextField__Prefix { margin-left: calc(var(--p-space-2)*1.5); margin-right: var(--p-space-2); }

.Polaris-TextField__Suffix { margin-left: 0.25em; margin-right: calc(var(--p-space-2)*1.5); }

.Polaris-TextField__CharacterCount { color: var(--p-text-subdued); z-index: var(--pc-text-field-contents); margin: 0 calc(var(--p-space-2)*1.5) 0 0.25em; pointer-events: none; text-align: right; }

.Polaris-TextField__AlignFieldBottom { align-self: flex-end; width: 100%; padding-bottom: var(--p-space-2); }

.Polaris-TextField__ClearButton { position: relative; -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; z-index: var(--pc-text-field-contents); margin: 0 calc(var(--p-space-2)*1.5) 0 0.25em; }
...
[data-focused]:not(:focus) .Polaris-Listbox-TextOption::after { box-shadow: 0 0 0 0.125rem var(--p-focused); outline: var(--p-border-width-1) solid transparent; }
...
.Polaris-Autocomplete-MappedAction__ActionContainer { --pc-mapped-actions-image-size: 1.25rem; --pc-mapped-actions-item-min-height: var(--p-space-10); --pc-mapped-actions-item-vertical-padding: calc(var(--pc-mapped-actions-item-min-height)/2 - var(--p-line-height-2)/2); margin-bottom: var(--p-space-3); }
...
.Polaris-Backdrop { position: fixed; z-index: var(--p-z-10); top: 0; right: 0; bottom: 0; left: 0; display: block; background-color: var(--p-backdrop); animation: Polaris-Backdrop__fade--in var(--p-duration-200) 1 forwards; opacity: 1; -webkit-backface-visibility: hidden; backface-visibility: hidden; will-change: opacity; }
...
.Polaris-Banner { --pc-banner-rgb-text: 33, 43, 54; --pc-banner-secondary-action-horizontal-padding: var(--p-space-3); --pc-banner-secondary-action-vertical-padding: calc(var(--p-line-height-6)*0.5 - var(--p-line-height-2)*0.5); position: relative; display: flex; }
...
.Polaris-Banner--hasDismiss { padding-right: calc(var(--p-space-4)*2 + var(--p-icon-size-small)); }
...
.Polaris-Banner__SecondaryAction:hover > .Polaris-Banner__Text { box-shadow: 0 -0.125rem 0 0 rgba(var(--pc-banner-rgb-text), 0.75) inset; }

.Polaris-Banner__SecondaryAction:active > .Polaris-Banner__Text { box-shadow: 0 -0.125rem 0 0 rgba(var(--pc-banner-rgb-text), 0) inset; }

.Polaris-Banner__SecondaryAction:focus > .Polaris-Banner__Text { padding: 0.125rem 0.3125rem; margin: -0.125rem -0.3125rem; background: var(--p-action-secondary-hovered); border-radius: var(--p-border-radius-base); box-shadow: none; background-color: transparent; }
...
.Polaris-Banner__Text { position: relative; box-shadow: 0 -0.125rem 0 0 rgba(var(--pc-banner-rgb-text), 0.25) inset; -webkit-backface-visibility: hidden; backface-visibility: hidden; will-change: box-shadow; transition: box-shadow var(--p-duration-200) var(--p-ease); }
...
.Polaris-CheckableButton__Checkbox { pointer-events: none; height: var(--p-choice-size); width: var(--p-choice-size); margin-left: calc(var(--p-space-2)*-1 + var(--p-space-025)*-1 - var(--p-control-border-width)); }
...
.Polaris-Indicator--pulseIndicator::after { right: var(--pc-indicator-base-position); top: var(--pc-indicator-base-position); animation: Polaris-Indicator--pulse 5s ease infinite; }
...
.Polaris-CalloutCard--hasDismiss { padding-right: calc(var(--p-space-4)*2 + var(--p-icon-size-small)); }
...
.Polaris-DataTable__Cell { padding: var(--p-space-4); white-space: nowrap; text-align: left; transition: background-color 0.2s ease-in-out; }
...
.Polaris-DataTable--cellTotalFooter { border-top: var(--p-border-divider); border-bottom: none; border-bottom-left-radius: var(--p-border-radius-1); border-bottom-right-radius: var(--p-border-radius-1); }

.Polaris-DataTable__Footer { padding: var(--p-space-4); background: var(--p-surface-subdued); color: var(--p-text-subdued); text-align: center; border-top: var(--p-border-divider); border-bottom-left-radius: var(--p-border-radius-1); border-bottom-right-radius: var(--p-border-radius-1); }
...
.Polaris-DatePicker__Day { display: block; height: 100%; width: 100%; margin: 0; padding: var(--p-space-2); background: transparent; border: none; border-radius: var(--p-border-radius-1); outline: none; font-size: 0.75rem; text-align: center; color: var(--p-text); cursor: pointer; position: relative; }
...
.Polaris-DatePicker__Weekday { padding: var(--p-space-2); background: transparent; font-size: 0.75rem; font-weight: var(--p-font-weight-regular); color: var(--p-text-subdued); text-align: center; }
...
.Polaris-Tag.Polaris-Tag--clickable { -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; cursor: pointer; padding: 0 var(--p-space-2); background-color: var(--p-surface-neutral); outline: var(--p-border-width-1) solid transparent; position: relative; }
...
.Polaris-Tag__Button { -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; display: block; flex-shrink: 0; height: 1.75rem; width: 1.75rem; margin-left: var(--p-space-1); border-radius: 0 var(--p-border-radius-base) var(--p-border-radius-base) 0; position: relative; }
...
.Polaris-Tag__Link { display: inline-grid; color: var(--p-text); outline: none; border-radius: var(--p-border-radius-base); text-decoration: none; padding: var(--p-space-1) var(--p-space-2); position: relative; }
...
.Polaris-Tag__Link.Polaris-Tag--segmented::after { margin-right: var(--p-space-1); border-top-right-radius: 0; border-bottom-right-radius: 0; }
...
@media (min-width: 40em) { .Polaris-Frame-Toast__CloseButton { align-self: flex-start; margin: calc(var(--p-space-2)*-1) calc(var(--p-space-4)*-1) calc(var(--p-space-2)*-1) 0; padding: calc(var(--p-space-2)*1.5) var(--p-space-4) var(--p-space-2); } }
...
.Polaris-Modal-Footer { display: flex; align-self: flex-end; align-items: center; width: 100%; min-height: calc(var(--p-space-4)*4); padding: var(--p-space-4); border-top: var(--p-border-divider); }
...
.Polaris-Frame-ContextualSaveBar { display: flex; height: 3.5rem; background: var(--p-surface); box-shadow: 0 0.125rem 0.25rem rgba(0, 0, 0, 0.1); }
...
.Polaris-IndexTable--loadingContainerEnterActive { opacity: 1; transition: opacity var(--p-duration-100) ease-out, transform var(--p-duration-100) ease-out; transform: translateY(0); }

.Polaris-IndexTable__LoadingContainer--exit { opacity: 1; transform: translateY(0); }

.Polaris-IndexTable--loadingContainerExitActive { opacity: 0; transform: translateY(-100%); transition: opacity var(--p-duration-100) ease-in, transform var(--p-duration-100) ease-in; }
...
.Polaris-IndexTable__ScrollBar::-webkit-scrollbar-thumb { border-radius: var(--p-border-radius-1); background-color: var(--p-border-neutral-subdued); -webkit-transition: background-color var(--p-duration-100) ease-out; transition: background-color var(--p-duration-100) ease-out; }
...
.Polaris-KeyboardKey { display: inline-block; height: 1.5rem; margin: 0 calc(var(--p-space-1)/2) var(--p-space-05); padding: 0 var(--p-space-1); background-color: var(--p-surface); box-shadow: 0 0 0 0.0625rem var(--p-border-subdued), 0 var(--p-space-05) 0 0 var(--p-surface), 0 var(--p-space-05) 0 0.0625rem var(--p-border-subdued); border-radius: var(--p-border-radius-1); font-family: var(--p-font-family-sans); font-size: 0.75rem; font-weight: var(--p-font-weight-medium); line-height: 1.5rem; color: var(--p-text-subdued); text-align: center; min-width: 1.5rem; -webkit-user-select: none; user-select: none; }
...
@media print { body .Polaris-Layout { font-size: 0.6875rem; line-height: 1rem; }
...
@media (min-width: 48.0625em) { .Polaris-Navigation__Item { font-size: 1rem; font-weight: var(--p-font-weight-medium); line-height: 2rem; padding-left: var(--p-space-3); } }
...
.Polaris-Navigation__Text { flex: 1 1 auto; margin-top: calc(var(--p-space-2) + var(--p-space-05)); margin-bottom: calc(var(--p-space-2) + var(--p-space-05)); line-height: 1.25rem; font-size: 0.875rem; }

@media (min-width: 48.0625em) { .Polaris-Navigation__Text { margin-top: var(--p-space-1); margin-bottom: var(--p-space-1); } }

@media (max-width: 48.0625em) { .Polaris-Navigation__Text { font-size: 0.9375rem; line-height: 1.1875rem; } }
...
@media (min-width: 48.0625em) { .Polaris-Navigation__SecondaryNavigation .Polaris-Navigation__Item { font-size: 0.875rem; line-height: 1; padding-left: var(--p-space-10); } }
...
.Polaris-Navigation__SecondaryNavigation--noIcon .Polaris-Navigation__Item { padding-left: calc(var(--p-space-2) + var(--p-space-1)); }
...
.Polaris-OptionList-Option { -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; width: 100%; min-height: 2.25rem; text-align: left; text-decoration: none; border-radius: var(--p-border-radius-1); margin-top: calc(var(--p-space-2)/2); color: inherit; }
...
.Polaris-Header-Title { word-wrap: break-word; word-break: break-word; overflow-wrap: break-word; font-weight: var(--p-font-weight-semibold); font-size: 1.5rem; line-height: 1.75rem; }

@media (min-width: 40em) { .Polaris-Header-Title { font-size: 1.25rem; } }
...
.Polaris-Page-Header__RightAlign { grid-area: actions; display: flex; align-content: flex-end; flex: 1 1 auto; align-items: flex-start; justify-content: flex-end; margin-left: var(--p-space-4); white-space: nowrap; }
...
@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-Page { padding: 0 var(--p-space-5); } }

@media (min-width: 30.625em) { .Polaris-Page { padding: 0 var(--p-space-5); } }

@media (max-width: 48.0625em) and (min-width: 46.5em), (min-width: 61.5em) { [data-has-navigation] .Polaris-Page { padding: 0 var(--p-space-8); } }

@media (min-width: 46.5em) { .Polaris-Page { padding: 0 var(--p-space-8); } }
...
.Polaris-ProgressBar__Indicator { height: inherit; width: 0; background-color: var(--pc-progress-bar-indicator); }

@media screen and (-ms-high-contrast: active) { .Polaris-ProgressBar__Indicator { border: 1rem solid highlight; } }

.Polaris-ProgressBar__Animated { -webkit-backface-visibility: hidden; backface-visibility: hidden; will-change: width; animation: Polaris-ProgressBar--fillup var(--p-duration-500) var(--p-ease); transition: width var(--p-duration-500) var(--p-ease); }
...
.Polaris-RangeSlider-SingleThumb__Input::-webkit-slider-thumb { margin-top: calc(var(--pc-range-slider-thumb-size)*-0.5 - var(--pc-range-slider-track-height)*-0.5); }
...
.Polaris-RangeSlider-SingleThumb__Input:focus::-ms-thumb { border-color: var(--p-surface); box-shadow: 0 0 0 0.125rem var(--p-focused); }

.Polaris-RangeSlider-SingleThumb__Input:focus::-moz-range-thumb { border-color: var(--p-surface); box-shadow: 0 0 0 0.125rem var(--p-focused); }

.Polaris-RangeSlider-SingleThumb__Input:focus::-webkit-slider-thumb { border-color: var(--p-surface); box-shadow: 0 0 0 0.125rem var(--p-focused); }
...
@media (min-height: 37.5em) { .Polaris-ResourceList__EmptySearchResultWrapper { padding-top: calc(var(--p-space-8)*2); padding-bottom: calc(var(--p-space-8)*2); } }
...
.Polaris-SkeletonBodyText { height: 0.5rem; position: relative; }
...
.Polaris-SkeletonBodyText + .Polaris-SkeletonBodyText { margin-top: 0.75rem; }
...
@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-SkeletonPage__Page { padding: 0 var(--p-space-5); } }

@media (min-width: 30.625em) { .Polaris-SkeletonPage__Page { padding: 0 var(--p-space-5); } }

@media (max-width: 48.0625em) and (min-width: 46.5em), (min-width: 61.5em) { [data-has-navigation] .Polaris-SkeletonPage__Page { padding: 0 var(--p-space-8); } }

@media (min-width: 46.5em) { .Polaris-SkeletonPage__Page { padding: 0 var(--p-space-8); } }
...
.Polaris-TopBar-SearchField { --pc-search-field-backdrop: 1; --pc-search-field-input: 2; --pc-search-field-icon: 3; --pc-search-field-action: 3; z-index: var(--p-z-11); position: relative; display: flex; flex: 1 1 auto; align-items: center; border: 0.0625rem solid transparent; width: 100%; max-width: 36.25rem; }
...
.Polaris-TopBar-SearchField__Input:focus ~ .Polaris-TopBar-SearchField__BackdropShowFocusBorder { border: 0.0625rem solid var(--pc-top-bar-border); }
...
.Polaris-TopBar-SearchField--focused .Polaris-TopBar-SearchField__BackdropShowFocusBorder { border: 0.0625rem solid var(--pc-top-bar-border); }
...
.Polaris-TopBar-SearchField__Input::placeholder { color: var(--p-text); transition: var(--p-duration-150) color var(--p-ease) 33ms; }
...
.Polaris-TopBar-SearchField__Icon svg { transition: var(--p-duration-150) fill var(--p-ease) 33ms; }
...
.Polaris-TopBar-SearchField__Backdrop { position: relative; position: absolute; z-index: var(--pc-search-field-backdrop); top: 0; right: 0; bottom: 0; left: 0; background-color: var(--p-surface-search-field, var(--pc-top-bar-background-lighter)); -webkit-backface-visibility: hidden; backface-visibility: hidden; will-change: background-color; transition: background-color var(--p-duration-200) var(--p-ease); border-radius: var(--p-border-radius-1); animation: Polaris-TopBar-SearchField--toLightBackground 0.01ms; }

.Polaris-TopBar-SearchField__Backdrop::after { content: ''; position: absolute; z-index: 1; top: -0.0625rem; right: -0.0625rem; bottom: -0.0625rem; left: -0.0625rem; display: block; pointer-events: none; box-shadow: 0 0 0 -0.0625rem var(--p-focused); transition: box-shadow var(--p-duration-100) var(--p-ease); border-radius: calc(var(--p-border-radius-1) + 0.0625rem); }

@keyframes Polaris-TopBar-SearchField--toLightBackground { to { background-color: var(--p-surface-neutral, var(--pc-top-bar-background-lighter)); } }
...
.Polaris-TopBar-Menu__Activator { -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; position: relative; color: var(--p-text); position: relative; display: flex; justify-content: center; align-items: center; min-width: 2.25rem; padding: var(--p-space-1) var(--p-space-2); border: 0; cursor: pointer; transition: background-color 0.1s; margin-right: var(--p-space-2); border-radius: var(--p-border-radius-base); }
...
.Polaris-TopBar-UserMenu__Name, .Polaris-TopBar-UserMenu__Detail { transition: var(--p-duration-150) color var(--p-ease) 33ms; }


.Polaris-TopBar { position: relative; display: flex; height: 3.5rem; box-shadow: var(--p-shadow-top-bar); background-color: var(--p-surface); transition: var(--p-duration-200) background-color ease-in-out; }
...
.Polaris-TopBar__NavigationIcon { -webkit-appearance: none; appearance: none; margin: 0; padding: 0; background: none; border: none; font-size: inherit; line-height: inherit; color: inherit; cursor: pointer; position: relative; align-self: center; margin-left: calc(var(--p-space-2) + 0.125rem); margin-right: var(--p-space-2); padding: var(--p-space-2); border-radius: var(--p-border-radius-base); fill: var(--p-icon); transition: var(--p-duration-150) fill var(--p-ease) 33ms; }
...
@media (max-width: 48.0625em) and (min-width: 30.625em), (min-width: 45.625em) { [data-has-navigation] .Polaris-TopBar__SearchField { padding: 0 var(--p-space-5); } }

@media (min-width: 30.625em) { .Polaris-TopBar__SearchField { padding: 0 var(--p-space-5); } }

@media (max-width: 48.0625em) and (min-width: 46.5em), (min-width: 61.5em) { [data-has-navigation] .Polaris-TopBar__SearchField { padding: 0 var(--p-space-8); } }

@media (min-width: 46.5em) { .Polaris-TopBar__SearchField { padding: 0 var(--p-space-8); } }
...
.Polaris-VideoThumbnail__PlayButton { --pc-play-button-focused-state-overlay: rgba(223, 227, 232, 0.3); position: absolute; top: 0; left: 0; width: 100%; height: 100%; padding: 0; border: none; background: transparent; opacity: 0.8; transition: opacity 0.2s ease-in; cursor: pointer; }
