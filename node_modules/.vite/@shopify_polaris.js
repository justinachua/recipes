...
var require_debounce = __commonJS({
  "node_modules/lodash/debounce.js"(exports, module) {
    ...
    function debounce15(func, wait, options) {
...
function useIndexResourceState(resources, {
  ...
  const [selectedResources, setSelectedResources] = (0, import_react2.useState)(initSelectedResources);
  const [allResourcesSelected, setAllResourcesSelected] = (0, import_react2.useState)(initAllResourcesSelected);
  const handleSelectionChange = (0, import_react2.useCallback)((selectionType, isSelecting, selection) => {
...
// node_modules/@shopify/polaris/build/esm/tokens/token-groups/depth.json.js
...
// node_modules/@shopify/polaris/build/esm/tokens/token-groups/legacy-tokens.json.js
...
// node_modules/@shopify/polaris/build/esm/tokens/token-groups/spacing.json.js
...
// node_modules/@shopify/polaris/build/esm/tokens/token-groups/typography.json.js
...
// node_modules/@shopify/polaris/build/esm/tokens/token-groups/z-index.json.js
var zIndex = { "z-1": "100", "z-2": "400", "z-3": "510", "z-4": "512", "z-5": "513", "z-6": "514", "z-7": "515", "z-8": "516", "z-9": "517", "z-10": "518", "z-11": "519", "z-12": "520" };

// node_modules/@shopify/polaris/build/esm/tokens/utilities.js
var BASE_FONT_SIZE = 16;
function rem(value) {
  return value.replace(/\d+(?:\.\d+|\d*)px/g, (px) => `${parseInt(px, 10) / BASE_FONT_SIZE}rem`);
}
function tokensToRems(tokenGroup) {
  return Object.fromEntries(Object.entries(tokenGroup).map(([token, value]) => [token, rem(value)]));
}

// node_modules/@shopify/polaris/build/esm/tokens/tokens.js
var osColorSchemes = {
  light: "light",
  dark: "dark"
};
...
// node_modules/@shopify/polaris/build/esm/components/CustomProperties/styles.js
var defaultCustomProperties = `
  ${getColorSchemeDeclarations("light", tokens, osColorSchemes)}
  ${getStaticCustomProperties(tokens)}
`;
function getColorSchemeRules(tokens2, osColorSchemes2) {
  return Object.keys(tokens2.colorSchemes).map((key) => {
    const colorScheme = key;
    const selector = `[p-color-scheme="${colorScheme}"]`;
    const colorCustomProperties = getColorSchemeDeclarations(colorScheme, tokens2, osColorSchemes2);
    return `${selector}{${colorCustomProperties}${getStaticCustomProperties(tokens2)}}`;
  }).join("");
}
function getStaticCustomProperties(tokens2) {
  return Object.entries(tokens2).filter(([tokenGroup]) => tokenGroup !== "colorSchemes").map(([_, tokens3]) => getCustomProperties(tokens3)).join("");
}
function getColorSchemeDeclarations(colorScheme, tokens2, osColorSchemes2) {
  return [`color-scheme:${osColorSchemes2[colorScheme]};`, getCustomProperties(tokens2.colorSchemes[colorScheme])].join("");
}
function getCustomProperties(tokens2) {
  return Object.entries(tokens2).map(([name, value]) => `--p-${name}:${value};`).join("");
}
var styles = `
...
function CustomProperties(props) {
  ...
  return import_react3.default.createElement(import_react3.default.Fragment, null, import_react3.default.createElement("style", {
    "data-polaris-custom-properties": "",
    dangerouslySetInnerHTML: {
      __html: styles
    }
  }), import_react3.default.createElement(Component9, {
...
var StickyManager = class {
  constructor(container) {
    ...
    this.container = null;
    this.topBarOffset = 0;
    this.handleResize = (0, import_debounce.default)(() => {
    ...
    this.handleScroll = (0, import_debounce.default)(() => {
      this.manageStickyItems();
    }, SIXTY_FPS, {
      leading: true,
      trailing: true,
...
var I18n = class {
  ...
  translate(id, replacements) {
    const text3 = get(this.translation, id, "");
    if (!text3) {
      return "";
    }
    if (replacements) {
      return text3.replace(REPLACE_REGEX, (match) => {
...
var MediaQueryContext = (0, import_react10.createContext)(void 0);
...
var MediaQueryProvider = function MediaQueryProvider2({
  ...
  const [isNavigationCollapsed, setIsNavigationCollapsed] = (0, import_react12.useState)(navigationBarCollapsed().matches);
  const handleResize = (0, import_react12.useCallback)((0, import_debounce2.default)(() => {
  ...
  return import_react12.default.createElement(MediaQueryContext.Provider, {
    value: context
  }, import_react12.default.createElement(EventListener, {
    event: "resize",
...
var PortalsManagerContext = (0, import_react13.createContext)(void 0);
...
var PortalsContainer = (0, import_react14.forwardRef)(PortalsContainerComponent);
...
function PortalsManager({
  ...
  const [portalContainerElement, setPortalContainerElement] = (0, import_react15.useState)(null);
  ...
  return import_react15.default.createElement(PortalsManagerContext.Provider, {
    value: contextValue
  }, children2, container ? null : import_react15.default.createElement(PortalsContainer, {
...
var FocusManagerContext = (0, import_react16.createContext)(void 0);
...
function FocusManager({
  ...
  return import_react17.default.createElement(FocusManagerContext.Provider, {
    value
  }, children2);
}

// node_modules/@shopify/polaris/build/esm/components/AppProvider/AppProvider.js
var AppProvider = class extends import_react18.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return import_react18.default.createElement(FeaturesContext.Provider, {
      value: features
    }, import_react18.default.createElement(I18nContext.Provider, {
      value: intl
    }, import_react18.default.createElement(ScrollLockManagerContext.Provider, {
      value: this.scrollLockManager
    }, import_react18.default.createElement(StickyManagerContext.Provider, {
      value: this.stickyManager
    }, import_react18.default.createElement(UniqueIdFactoryContext.Provider, {
      value: this.uniqueIdFactory
    }, import_react18.default.createElement(LinkContext.Provider, {
      value: link
    }, import_react18.default.createElement(CustomProperties, {
      colorScheme
    }, import_react18.default.createElement(MediaQueryProvider, null, import_react18.default.createElement(PortalsManager, null, import_react18.default.createElement(FocusManager, null, children2))))))))));
  }
};

// node_modules/@shopify/polaris/build/esm/components/AccountConnection/AccountConnection.js
var import_react472 = __toModule(require_react());
...
var import_react468 = __toModule(require_react());
...
function useToggle(initialState) {
  const [value, setState] = (0, import_react19.useState)(initialState);
  return {
    value,
    toggle: (0, import_react19.useCallback)(() => setState((state) => !state), []),
    setTrue: (0, import_react19.useCallback)(() => setState(true), []),
    setFalse: (0, import_react19.useCallback)(() => setState(false), [])
  };
}
...
var import_react458 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/components/Button/Button.js
var import_react457 = __toModule(require_react());
...
var SvgAlertMinor = function SvgAlertMinor2(props) {
  return import_react30.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path || (_path = import_react30.default.createElement("path", {
...
var SvgArrowLeftMinor = function SvgArrowLeftMinor2(props) {
  return import_react39.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path2 || (_path2 = import_react39.default.createElement("path", {
...
var SvgArrowRightMinor = function SvgArrowRightMinor2(props) {
  return import_react40.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path3 || (_path3 = import_react40.default.createElement("path", {
...
var SvgCancelSmallMinor = function SvgCancelSmallMinor2(props) {
  return import_react70.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path4 || (_path4 = import_react70.default.createElement("path", {
...
var SvgCaretDownMinor = function SvgCaretDownMinor2(props) {
  return import_react76.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path5 || (_path5 = import_react76.default.createElement("path", {
...
var SvgCaretUpMinor = function SvgCaretUpMinor2(props) {
  return import_react77.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path6 || (_path6 = import_react77.default.createElement("path", {
...
var SvgChevronDownMinor = function SvgChevronDownMinor2(props) {
  return import_react92.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path7 || (_path7 = import_react92.default.createElement("path", {
...
var SvgChevronLeftMinor = function SvgChevronLeftMinor2(props) {
  return import_react93.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path8 || (_path8 = import_react93.default.createElement("path", {
...
var SvgChevronRightMinor = function SvgChevronRightMinor2(props) {
  return import_react94.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path9 || (_path9 = import_react94.default.createElement("path", {
...
var SvgChevronUpMinor = function SvgChevronUpMinor2(props) {
  return import_react95.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path10 || (_path10 = import_react95.default.createElement("path", {
...
var SvgCircleAlertMajor = function SvgCircleAlertMajor2(props) {
  return import_react96.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path11 || (_path11 = import_react96.default.createElement("path", {
    fillRule: "evenodd",
...
var SvgCircleCancelMinor = function SvgCircleCancelMinor2(props) {
  return import_react98.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path12 || (_path12 = import_react98.default.createElement("path", {
    fillRule: "evenodd",
...
var SvgCircleInformationMajor = function SvgCircleInformationMajor2(props) {
  return import_react107.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path13 || (_path13 = import_react107.default.createElement("path", {
    fillRule: "evenodd",
...
var SvgCircleTickMajor = function SvgCircleTickMajor2(props) {
  return import_react116.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path14 || (_path14 = import_react116.default.createElement("path", {
    fillRule: "evenodd",
...
var SvgDiamondAlertMajor = function SvgDiamondAlertMajor2(props) {
  return import_react149.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path15 || (_path15 = import_react149.default.createElement("path", {
...
var SvgEnableSelectionMinor = function SvgEnableSelectionMinor2(props) {
  return import_react170.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path16 || (_path16 = import_react170.default.createElement("path", {
    fillRule: "evenodd",
...
var SvgExternalMinor = function SvgExternalMinor2(props) {
  return import_react176.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path17 || (_path17 = import_react176.default.createElement("path", {
...
var SvgExternalSmallMinor = function SvgExternalSmallMinor2(props) {
  return import_react177.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path18 || (_path18 = import_react177.default.createElement("path", {
...
var SvgHorizontalDotsMinor = function SvgHorizontalDotsMinor2(props) {
  return import_react218.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path19 || (_path19 = import_react218.default.createElement("path", {
...
var SvgMinusMinor = function SvgMinusMinor2(props) {
  return import_react262.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path20 || (_path20 = import_react262.default.createElement("path", {
...
var SvgMobileCancelMajor = function SvgMobileCancelMajor2(props) {
  return import_react265.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path21 || (_path21 = import_react265.default.createElement("path", {
...
var SvgMobileHamburgerMajor = function SvgMobileHamburgerMajor2(props) {
  return import_react267.default.createElement("svg", Object.assign({
    viewBox: "0 0 20 20"
  }, props), _path22 || (_path22 = import_react267.default.createElement("path", {
...
var import_react431 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/utilities/use-is-after-initial-mount.js
var import_react429 = __toModule(require_react());
function useIsAfterInitialMount() {
  const [isAfterInitialMount, setIsAfterInitialMount] = (0, import_react429.useState)(false);
...
var import_react430 = __toModule(require_react());
...
function VisuallyHidden({
  ...
  return import_react430.default.createElement("span", {
    className: styles6.VisuallyHidden
  }, children2);
}
...
function Spinner({
  ...
  const spinnerSVGMarkup = size === "large" ? import_react431.default.createElement("svg", {
    viewBox: "0 0 44 44",
    xmlns: "http://www.w3.org/2000/svg"
  }, import_react431.default.createElement("path", {
    d: "M15.542 1.487A21.507 21.507 0 00.5 22c0 11.874 9.626 21.5 21.5 21.5 9.847 0 18.364-6.675 20.809-16.072a1.5 1.5 0 00-2.904-.756C37.803 34.755 30.473 40.5 22 40.5 11.783 40.5 3.5 32.217 3.5 22c0-8.137 5.3-15.247 12.942-17.65a1.5 1.5 0 10-.9-2.863z"
  })) : import_react431.default.createElement("svg", {
    viewBox: "0 0 20 20",
    xmlns: "http://www.w3.org/2000/svg"
  }, import_react431.default.createElement("path", {
  ...
  const accessibilityLabelMarkup = (isAfterInitialMount || !hasFocusableParent) && import_react431.default.createElement(VisuallyHidden, null, accessibilityLabel);
  return import_react431.default.createElement(import_react431.default.Fragment, null, import_react431.default.createElement("span", {
    className
  }, spinnerSVGMarkup), import_react431.default.createElement("span", spanAttributes, accessibilityLabelMarkup));
}

// node_modules/@shopify/polaris/build/esm/components/Popover/Popover.js
var import_react445 = __toModule(require_react());
...
var import_react434 = __toModule(require_react());
var import_react_dom = __toModule(require_react_dom());

// node_modules/@shopify/polaris/build/esm/utilities/portals/hooks.js
var import_react432 = __toModule(require_react());
function usePortalsManager() {
  const portalsManager = (0, import_react432.useContext)(PortalsManagerContext);
  if (!portalsManager) {
...
var import_react433 = __toModule(require_react());
...
function useUniqueId(prefix = "", overrideId = "") {
  const idFactory = (0, import_react433.useContext)(UniqueIdFactoryContext);
  const uniqueIdRef = (0, import_react433.useRef)(null);
  if (!idFactory) {
...
function Portal({
  ...
  return container ? (0, import_react_dom.createPortal)(import_react434.default.createElement("div", {
...
var import_react444 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/utilities/components.js
var import_react435 = __toModule(require_react());
function wrapWithComponent(element, Component9, props) {
  if (element == null) {
    return null;
  }
  return isElementOfType(element, Component9) ? element : import_react435.default.createElement(Component9, props, element);
}
...
function isElementOfType(element, Component9) {
  var _element$props;
  if (element == null || !(0, import_react435.isValidElement)(element) || typeof element.type === "string") {
    return false;
  }
  const {
    type: defaultType
...
function elementChildren(children2, predicate = () => true) {
  return import_react435.Children.toArray(children2).filter((child) => (0, import_react435.isValidElement)(child) && predicate(child));
}
...
var import_react437 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/utilities/use-isomorphic-layout-effect.js
var import_react436 = __toModule(require_react());
var useIsomorphicLayoutEffect = isServer ? import_react436.useEffect : import_react436.useLayoutEffect;
...
function KeypressListener({
  ...
  const tracked = (0, import_react437.useRef)({
    handler,
    keyCode
  });
  ...
  const handleKeyEvent = (0, import_react437.useCallback)((event) => {
    const {
      handler: handler2,
      keyCode: keyCode2
    } = tracked.current;
...
var import_react441 = __toModule(require_react());
...
var import_react440 = __toModule(require_react());
var import_debounce3 = __toModule(require_debounce());

// node_modules/@shopify/polaris/build/esm/components/Scrollable/context.js
var import_react438 = __toModule(require_react());
var ScrollableContext = (0, import_react438.createContext)(void 0);
...
var import_react439 = __toModule(require_react());
function ScrollTo() {
  const anchorNode = (0, import_react439.useRef)(null);
  const scrollToPosition = (0, import_react439.useContext)(ScrollableContext);
  ...
  return import_react439.default.createElement("a", {
    id,
    ref: anchorNode
  });
}
...
var Scrollable = class extends import_react440.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      topShadow: false,
    ...
    this.handleResize = (0, import_debounce3.default)(() => {
      this.handleScroll();
    }, 50, {
      trailing: true
    });
  ...
  render() {
    ...
    const finalClassName = classNames(className, styles9.Scrollable, vertical && styles9.vertical, horizontal && styles9.horizontal, topShadow && styles9.hasTopShadow, bottomShadow && styles9.hasBottomShadow, vertical && canScroll && styles9.verticalHasScrolling);
    return import_react440.default.createElement(ScrollableContext.Provider, {
      value: this.scrollToPosition
    }, import_react440.default.createElement(StickyManagerContext.Provider, {
      value: this.stickyManager
    }, import_react440.default.createElement("div", Object.assign({
...
var PositionedOverlay = class extends import_react441.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      measuring: true,
  ...
  render() {
    ...
    return import_react441.default.createElement("div", {
      className,
      style,
      ref: this.setOverlay
    }, import_react441.default.createElement(EventListener, {
      event: "resize",
...
var import_react443 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/components/Popover/components/Section/Section.js
var import_react442 = __toModule(require_react());
function Section({
  children: children2
}) {
  return import_react442.default.createElement("div", {
...
function Pane({
  ...
  const className = classNames(styles7.Pane, fixed && styles7["Pane-fixed"]);
  const content = sectioned ? wrapWithComponent(children2, Section, {}) : children2;
  return fixed ? import_react443.default.createElement("div", {
    className
  }, content) : import_react443.default.createElement(Scrollable, {
    shadow: true,
    className,
    onScrolledToBottom
  }, content);
...
var PopoverOverlay = class extends import_react444.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      transitionStatus: this.props.active ? TransitionStatus.Entering : TransitionStatus.Exited
    };
    this.contentNode = (0, import_react444.createRef)();
    ...
    this.renderPopover = (overlayDetails) => {
      ...
      const content = import_react444.default.createElement("div", {
        id,
      ...
      return import_react444.default.createElement("div", Object.assign({
        className
      }, overlay.props), import_react444.default.createElement(EventListener, {
        event: "click",
        handler: this.handleClick
      }), import_react444.default.createElement(EventListener, {
        event: "touchstart",
        handler: this.handleClick
      }), import_react444.default.createElement(KeypressListener, {
        keyCode: Key.Escape,
        handler: this.handleEscape
      }), import_react444.default.createElement("div", {
        className: styles7.FocusTracker,
        tabIndex: 0,
        onFocus: this.handleFocusFirstItem
      }), import_react444.default.createElement(CustomProperties, {
        colorScheme
      }, import_react444.default.createElement("div", {
        className: styles7.Wrapper
      }, content)), import_react444.default.createElement("div", {
        className: styles7.FocusTracker,
        tabIndex: 0,
    ...
    this.overlayRef = (0, import_react444.createRef)();
  }
  forceUpdatePosition() {
  ...
  render() {
    ...
    return import_react444.default.createElement(PositionedOverlay, {
      ref: this.overlayRef,
      fullWidth,
      active,
      activator,
...
function renderPopoverContent(children2, props) {
  const childrenArray = import_react444.Children.toArray(children2);
...
// node_modules/@shopify/polaris/build/esm/components/Popover/Popover.js
var PopoverComponent = (0, import_react445.forwardRef)(function Popover({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react445.useState)();
  const overlayRef = (0, import_react445.useRef)(null);
  const activatorContainer = (0, import_react445.useRef)(null);
  ...
  (0, import_react445.useImperativeHandle)(ref, () => {
    return {
      forceUpdatePosition
    };
  });
  const setAccessibilityAttributes = (0, import_react445.useCallback)(() => {
  ...
  const portal2 = activatorNode ? import_react445.default.createElement(Portal, {
    idPrefix: "popover"
  }, import_react445.default.createElement(PopoverOverlay, Object.assign({
    ref: overlayRef,
    id,
  ...
  return import_react445.default.createElement(WrapperComponent, {
    ref: activatorContainer
  }, import_react445.Children.only(activator), portal2);
});
...
var import_react455 = __toModule(require_react());
...
function Icon({
  ...
  if (backdrop3 && color && !COLORS_WITH_BACKDROPS.includes(color) && true) {
    console.warn(`The ${color} variant does not have a supported backdrop color`);
  }
  const className = classNames(styles11.Icon, color && styles11[variationName("color", color)], color && styles11.applyColor, backdrop3 && styles11.hasBackdrop);
  const SourceComponent = source;
  const contentMarkup = {
    function: import_react446.default.createElement(SourceComponent, {
      className: styles11.Svg,
      focusable: "false",
      "aria-hidden": "true"
    }),
    placeholder: import_react446.default.createElement("div", {
      className: styles11.Placeholder
    }),
    external: import_react446.default.createElement("img", {
  ...
  return import_react446.default.createElement("span", {
    className
  }, import_react446.default.createElement(VisuallyHidden, null, accessibilityLabel), contentMarkup[sourceType]);
}

// node_modules/@shopify/polaris/build/esm/components/TextStyle/TextStyle.js
var import_react447 = __toModule(require_react());
...
function TextStyle({
  ...
  const className = classNames(variation && styles12[variationName("variation", variation)], variation === VariationValue.Code && styles12.code);
  const Element2 = variationElement(variation);
  return import_react447.default.createElement(Element2, {
    className
  }, children2);
}
...
var import_react450 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/utilities/within-filter-context.js
var import_react448 = __toModule(require_react());
var WithinFilterContext = (0, import_react448.createContext)(false);
...
var import_react449 = __toModule(require_react());
function useI18n() {
  const i18n = (0, import_react449.useContext)(I18nContext);
  if (!i18n) {
...
function Badge({
  ...
  const i18n = useI18n();
  const withinFilter = (0, import_react450.useContext)(WithinFilterContext);
  const className = classNames(styles13.Badge, status && styles13[variationName("status", status)], progress && styles13[variationName("progress", progress)], size && size !== DEFAULT_SIZE && styles13[variationName("size", size)], withinFilter && styles13.withinFilter);
  let progressLabel = "";
  switch (progress) {
  ...
  let accessibilityMarkup = hasAccessibilityLabel && import_react450.default.createElement(VisuallyHidden, null, accessibilityLabel);
  if (progressLabel) {
    accessibilityMarkup = import_react450.default.createElement("span", {
      className: styles13.Pip
    }, accessibilityMarkup);
  }
  return import_react450.default.createElement("span", {
    className
  }, accessibilityMarkup, children2);
}

// node_modules/@shopify/polaris/build/esm/components/UnstyledLink/UnstyledLink.js
var import_react452 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/utilities/link/hooks.js
var import_react451 = __toModule(require_react());
function useLink() {
  return (0, import_react451.useContext)(LinkContext);
}

// node_modules/@shopify/polaris/build/esm/components/UnstyledLink/UnstyledLink.js
var UnstyledLink = (0, import_react452.memo)((0, import_react452.forwardRef)(function UnstyledLink2(props, _ref) {
  const LinkComponent = useLink();
  if (LinkComponent) {
    return import_react452.default.createElement(LinkComponent, Object.assign({}, unstyled.props, props));
  }
  const {
    external,
    url,
  ...
  return import_react452.default.createElement("a", Object.assign({
    target
  }, rest, {
    href: url,
    rel
...
function Item({
  ...
  const className = classNames(styles10.Item, disabled && styles10.disabled, destructive && styles10.destructive, active && styles10.active);
  let prefixMarkup = null;
  if (prefix) {
    prefixMarkup = import_react453.default.createElement("span", {
      className: styles10.Prefix
    }, prefix);
  } else if (icon3) {
    prefixMarkup = import_react453.default.createElement("span", {
      className: styles10.Prefix
    }, import_react453.default.createElement(Icon, {
      source: icon3
    }));
  } else if (image) {
    prefixMarkup = import_react453.default.createElement("span", {
  ...
  const contentMarkup = helpText ? import_react453.default.createElement("span", {
    className: styles10.ContentBlock
  }, import_react453.default.createElement("span", {
    className: styles10.ContentBlockInner
  }, contentText), import_react453.default.createElement(TextStyle, {
    variation: "subdued"
  }, helpText)) : contentText;
  const badgeMarkup = badge && import_react453.default.createElement("span", {
    className: styles10.Suffix
  }, import_react453.default.createElement(Badge, {
    status: badge.status
  }, badge.content));
  const suffixMarkup = suffix && import_react453.default.createElement("span", {
    className: styles10.Suffix
  }, suffix);
  const textMarkup = import_react453.default.createElement("span", {
    className: styles10.Text
  }, contentMarkup);
  const contentElement = import_react453.default.createElement("span", {
    className: styles10.Content
  }, prefixMarkup, textMarkup, badgeMarkup, suffixMarkup);
  const scrollMarkup = active ? import_react453.default.createElement(Scrollable.ScrollTo, null) : null;
  const control = url ? import_react453.default.createElement(UnstyledLink, {
    id,
    ...
    role
  }, contentElement) : import_react453.default.createElement("button", {
    id,
    type: "button",
    className,
    disabled,
  ...
  return import_react453.default.createElement("li", {
    role: role === "menuitem" ? "presentation" : void 0
...
function Section2({
  ...
  const actionMarkup = section.items.map(({
    ...
    return import_react454.default.createElement(Item, Object.assign({
      key: `${content}-${index}`,
      content,
      helpText,
      role: actionRole,
  ...
  const className = section.title ? void 0 : styles10["Section-withoutTitle"];
  const titleClassName = classNames(styles10.Title, firstSection && styles10.firstSectionWithTitle);
  const titleMarkup = section.title ? import_react454.default.createElement("p", {
  ...
  const sectionMarkup = import_react454.default.createElement("div", {
    className
  }, titleMarkup, import_react454.default.createElement("ul", {
    className: styles10.Actions,
    role: sectionRole,
    tabIndex: !hasMultipleSections ? -1 : void 0
  }, actionMarkup));
  return hasMultipleSections ? import_react454.default.createElement("li", {
    className: styles10.Section,
    role: "presentation"
...
function ActionList({
  ...
  let finalSections = [];
  const actionListRef = (0, import_react455.useRef)(null);
  if (items) {
    finalSections = [{
      items
    }, ...sections];
  ...
  const className = classNames(styles10.ActionList);
  ...
  const sectionMarkup = finalSections.map((section, index) => {
    return section.items.length > 0 ? import_react455.default.createElement(Section2, {
  ...
  const listeners = actionRole === "menuitem" ? import_react455.default.createElement(import_react455.default.Fragment, null, import_react455.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.DownArrow,
    handler: handleFocusNextItem
  }), import_react455.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.UpArrow,
    handler: handleFocusPreviousItem
  })) : null;
  return import_react455.default.createElement(Element2, {
    ref: actionListRef,
    className,
    role: elementRole,
...
var import_react456 = __toModule(require_react());
function UnstyledButton({
  ...
  if (url) {
    buttonMarkup = disabled ? import_react456.default.createElement("a", commonProps, children2) : import_react456.default.createElement(UnstyledLink, Object.assign({}, interactiveProps, {
      url,
      external,
      download
    }, rest), children2);
  } else {
    buttonMarkup = import_react456.default.createElement("button", Object.assign({}, interactiveProps, {
...
function Button({
  ...
  const className = classNames(styles4.Button, primary && styles4.primary, outline && styles4.outline, destructive && styles4.destructive, isDisabled && styles4.disabled, loading && styles4.loading, plain && styles4.plain, pressed && !disabled && !url && styles4.pressed, monochrome && styles4.monochrome, size && size !== DEFAULT_SIZE2 && styles4[variationName("size", size)], textAlign && styles4[variationName("textAlign", textAlign)], fullWidth && styles4.fullWidth, icon3 && children2 == null && styles4.iconOnly, connectedDisclosure && styles4.connectedDisclosure, removeUnderline && styles4.removeUnderline);
  const disclosureMarkup = disclosure ? import_react457.default.createElement("span", {
    className: styles4.Icon
  }, import_react457.default.createElement("div", {
    className: classNames(styles4.DisclosureIcon, loading && styles4.hidden)
  }, import_react457.default.createElement(Icon, {
    source: loading ? "placeholder" : getDisclosureIconSource(disclosure)
  }))) : null;
  const iconSource = isIconSource(icon3) ? import_react457.default.createElement(Icon, {
    source: loading ? "placeholder" : icon3
  }) : icon3;
  const iconMarkup = iconSource ? import_react457.default.createElement("span", {
    className: classNames(styles4.Icon, loading && styles4.hidden)
  }, iconSource) : null;
  const childMarkup = children2 ? import_react457.default.createElement("span", {
    className: classNames(styles4.Text, removeUnderline && styles4.removeUnderline),
    key: disabled ? "text-disabled" : "text"
  }, children2) : null;
  const spinnerSVGMarkup = loading ? import_react457.default.createElement("span", {
    className: styles4.Spinner
  }, import_react457.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: i18n.translate("Polaris.Button.spinnerAccessibilityLabel")
  })) : null;
  const [disclosureActive, setDisclosureActive] = (0, import_react457.useState)(false);
  const toggleDisclosureActive = (0, import_react457.useCallback)(() => {
  ...
  if (connectedDisclosure) {
    ...
    const connectedDisclosureActivator = import_react457.default.createElement("button", {
      type: "button",
      ...
      onMouseUp: handleMouseUpByBlurring
    }, import_react457.default.createElement("span", {
      className: styles4.Icon
    }, import_react457.default.createElement(Icon, {
      source: SvgCaretDownMinor
    })));
    connectedDisclosureMarkup = import_react457.default.createElement(Popover2, {
      active: disclosureActive,
      onClose: toggleDisclosureActive,
      activator: connectedDisclosureActivator,
      preferredAlignment: "right"
    }, import_react457.default.createElement(ActionList, {
  ...
  const buttonMarkup = import_react457.default.createElement(UnstyledButton, Object.assign({}, commonProps, linkProps, actionProps), import_react457.default.createElement("span", {
    className: styles4.Content
  }, spinnerSVGMarkup, iconMarkup, childMarkup, disclosureMarkup));
  return connectedDisclosureMarkup ? import_react457.default.createElement("div", {
...
function buttonFrom({
  ...
  return import_react458.default.createElement(Button, Object.assign({
    key,
    onClick: onAction
...
var import_react464 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/components/ButtonGroup/ButtonGroup.js
var import_react460 = __toModule(require_react());
...
var import_react459 = __toModule(require_react());
function Item2({
  button
}) {
  const {
  ...
  const className = classNames(styles14.Item, focused3 && styles14["Item-focused"], button.props.plain && styles14["Item-plain"]);
  return import_react459.default.createElement("div", {
    className,
...
function ButtonGroup({
  ...
  const className = classNames(styles14.ButtonGroup, spacing2 && styles14[spacing2], segmented && styles14.segmented, fullWidth && styles14.fullWidth);
  const contents = elementChildren(children2).map((child, index) => import_react460.default.createElement(Item2, {
    button: child,
    key: index
  }));
  return import_react460.default.createElement("div", {
    className,
...
var import_react462 = __toModule(require_react());
...
var import_react461 = __toModule(require_react());
function Item3({
  children: children2,
  fill
}) {
  const className = classNames(styles15.Item, fill && styles15["Item-fill"]);
  return import_react461.default.createElement("div", {
    className
  }, children2);
}

// node_modules/@shopify/polaris/build/esm/components/Stack/Stack.js
var Stack = (0, import_react462.memo)(function Stack2({
  children: children2,
  vertical,
  spacing: spacing2,
  distribution,
  ...
  const className = classNames(styles15.Stack, vertical && styles15.vertical, spacing2 && styles15[variationName("spacing", spacing2)], distribution && styles15[variationName("distribution", distribution)], alignment && styles15[variationName("alignment", alignment)], wrap === false && styles15.noWrap);
  ...
  return import_react462.default.createElement("div", {
    className
  }, itemMarkup);
});
Stack.Item = Item3;
...
var import_react463 = __toModule(require_react());
...
function Heading({
  ...
  return import_react463.default.createElement(Element2, {
...
function Header({
  ...
  const actionMarkup = actions ? import_react464.default.createElement(ButtonGroup, null, buttonsFrom(actions, {
    plain: true
  })) : null;
  const titleMarkup = (0, import_react464.isValidElement)(title) ? title : import_react464.default.createElement(Heading, null, title);
  const headingMarkup = actionMarkup || children2 ? import_react464.default.createElement(Stack, {
    alignment: "baseline"
  }, import_react464.default.createElement(Stack.Item, {
    fill: true
  }, titleMarkup), actionMarkup, children2) : titleMarkup;
  return import_react464.default.createElement("div", {
    className: styles3.Header
  }, headingMarkup);
}

// node_modules/@shopify/polaris/build/esm/components/Card/components/Section/Section.js
var import_react466 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/components/Subheading/Subheading.js
var import_react465 = __toModule(require_react());
...
function Subheading({
  ...
  return import_react465.default.createElement(Element2, {
...
function Section3({
  ...
  const className = classNames(styles3.Section, flush && styles3["Section-flush"], subdued && styles3["Section-subdued"], fullWidth && styles3["Section-fullWidth"], hideOnPrint && styles3["Section-hideOnPrint"]);
  const actionMarkup = actions ? import_react466.default.createElement(ButtonGroup, null, buttonsFrom(actions, {
    plain: true
  })) : null;
  const titleMarkup = typeof title === "string" ? import_react466.default.createElement(Subheading, null, title) : title;
  const titleAreaMarkup = titleMarkup || actionMarkup ? import_react466.default.createElement("div", {
    className: styles3.SectionHeader
  }, actionMarkup ? import_react466.default.createElement(Stack, {
    alignment: "baseline"
  }, import_react466.default.createElement(Stack.Item, {
    fill: true
  }, titleMarkup), actionMarkup) : titleMarkup) : null;
  return import_react466.default.createElement("div", {
    className
  }, titleAreaMarkup, children2);
}

// node_modules/@shopify/polaris/build/esm/components/Card/components/Subsection/Subsection.js
var import_react467 = __toModule(require_react());
function Subsection({
  children: children2
}) {
  return import_react467.default.createElement("div", {
...
var Card = function Card2({
  ...
  const className = classNames(styles3.Card, subdued && styles3.subdued, hideOnPrint && styles3.hideOnPrint);
  const headerMarkup = title || actions ? import_react468.default.createElement(Header, {
    actions,
    title
  }) : null;
  const content = sectioned ? import_react468.default.createElement(Section3, null, children2) : children2;
  ...
  if (secondaryFooterActions && secondaryFooterActions.length) {
    if (secondaryFooterActions.length === 1) {
      ...
      secondaryFooterActionsMarkup = import_react468.default.createElement(import_react468.default.Fragment, null, import_react468.default.createElement(Popover2, {
        active: secondaryActionsPopoverOpen,
        activator: import_react468.default.createElement(Button, {
          disclosure: true,
      ...
      }, import_react468.default.createElement(ActionList, {
        items: secondaryFooterActions
      })));
    }
  }
  const footerMarkup = primaryFooterActionMarkup || secondaryFooterActionsMarkup ? import_react468.default.createElement("div", {
    className: classNames(styles3.Footer, footerActionAlignment === "left" && styles3.LeftJustified)
  }, footerActionAlignment === "right" ? import_react468.default.createElement(ButtonGroup, null, secondaryFooterActionsMarkup, primaryFooterActionMarkup) : import_react468.default.createElement(ButtonGroup, null, primaryFooterActionMarkup, secondaryFooterActionsMarkup)) : null;
  return import_react468.default.createElement(WithinContentContext.Provider, {
    value: true
  }, import_react468.default.createElement("div", {
    className
...
var import_react469 = __toModule(require_react());
...
function SettingAction({
  ...
  return import_react469.default.createElement("div", {
    className: styles18.SettingAction
  }, import_react469.default.createElement("div", {
    className: styles18.Setting
  }, children2), import_react469.default.createElement("div", {
    className: styles18.Action
  }, action));
}

// node_modules/@shopify/polaris/build/esm/components/Avatar/Avatar.js
var import_react471 = __toModule(require_react());
...
var import_react470 = __toModule(require_react());
function Image({
  sourceSet,
  source,
  crossOrigin,
  ...
  return finalSourceSet ? import_react470.default.createElement("img", Object.assign({
    src: source,
    srcSet: finalSourceSet,
    crossOrigin
  }, rest)) : import_react470.default.createElement("img", Object.assign({
    src: source
  }, rest, {
    crossOrigin
  }));
...
function Avatar({
  ...
  const [status, setStatus] = (0, import_react471.useState)(Status.Pending);
  (0, import_react471.useEffect)(() => {
    setStatus(Status.Pending);
  }, [source]);
  const handleError = (0, import_react471.useCallback)(() => {
    setStatus(Status.Errored);
    if (onError) {
      onError();
    }
  }, [onError]);
  const handleLoad = (0, import_react471.useCallback)(() => {
  ...
  const className = classNames(styles19.Avatar, size && styles19[variationName("size", size)], !customer && styles19[variationName("style", styleClass(nameString))], (hasImage || initials && initials.length === 0) && status !== Status.Loaded && styles19.hidden, hasImage && styles19.hasImage);
  const imageMarkUp = source && isAfterInitialMount && status !== Status.Errored ? import_react471.default.createElement(Image, {
    className: styles19.Image,
    source,
    alt: "",
    role: "presentation",
    onLoad: handleLoad,
  ...
  const avatarBody = customer || !initials ? import_react471.default.createElement("path", {
    fill: "currentColor",
  ...
  }) : import_react471.default.createElement("text", {
    x: "50%",
    y: "50%",
    dy: verticalOffset,
    fill: "currentColor",
  ...
  const svgMarkup = !hasImage ? import_react471.default.createElement("span", {
    className: styles19.Initials
  }, import_react471.default.createElement("svg", {
    className: styles19.Svg,
    viewBox: "0 0 40 40"
  }, avatarBody)) : null;
  return import_react471.default.createElement("span", {
    "aria-label": label,
    role: "img",
    className
...
function AccountConnection({
  ...
  const avatarMarkup = connected ? import_react472.default.createElement(Avatar, {
    accessibilityLabel: "",
    name: accountName,
    initials,
    source: avatarUrl
  ...
  if (title) {
    titleMarkup = import_react472.default.createElement("div", null, title);
  } else if (accountName) {
    titleMarkup = import_react472.default.createElement("div", null, accountName);
  }
  const detailsMarkup = details ? import_react472.default.createElement("div", null, import_react472.default.createElement(TextStyle, {
    variation: "subdued"
  }, details)) : null;
  const termsOfServiceMarkup = termsOfService ? import_react472.default.createElement("div", {
    className: styles2.TermsOfService
  }, termsOfService) : null;
  const actionElement = action ? buttonFrom(action, {
    primary: !connected
  }) : null;
  return import_react472.default.createElement(Card, {
    sectioned: true
  }, import_react472.default.createElement(SettingAction, {
    action: actionElement
  }, import_react472.default.createElement(Stack, null, avatarMarkup, import_react472.default.createElement(Stack.Item, {
    fill: true
  }, import_react472.default.createElement("div", {
...
var import_react477 = __toModule(require_react());
...
var import_react473 = __toModule(require_react());
...
function RollupActions({
  ...
  const activatorMarkup = import_react473.default.createElement("div", {
    className: styles21.RollupActivator
  }, import_react473.default.createElement(Button, {
    outline: true,
  ...
  return import_react473.default.createElement(Popover2, {
    active: rollupOpen,
    activator: activatorMarkup,
    preferredAlignment: "right",
    onClose: toggleRollupOpen,
    hideOnPrint: true
  }, import_react473.default.createElement(ActionList, {
    items,
    sections,
...
var import_react476 = __toModule(require_react());
...
var import_react475 = __toModule(require_react());
...
var import_react474 = __toModule(require_react());
...
function SecondaryAction({
  ...
  const secondaryActionsRef = (0, import_react474.useRef)(null);
  (0, import_react474.useEffect)(() => {
  ...
  return import_react474.default.createElement("span", {
    className: classNames(styles24.SecondaryAction, destructive && styles24.destructive),
    ref: secondaryActionsRef
  }, import_react474.default.createElement(Button, Object.assign({
    onClick: onAction
  }, rest), children2));
}
...
function MenuGroup({
  ...
  const handleClose = (0, import_react475.useCallback)(() => {
    onClose(title);
  }, [onClose, title]);
  const handleOpen = (0, import_react475.useCallback)(() => {
    onOpen(title);
  }, [onOpen, title]);
  const handleOffsetWidth = (0, import_react475.useCallback)((width) => {
    if (!getOffsetWidth)
      return;
    getOffsetWidth(width);
  }, [getOffsetWidth]);
  const popoverActivator = import_react475.default.createElement(SecondaryAction, {
    disclosure: true,
    icon: icon3,
    accessibilityLabel,
    onClick: handleOpen,
  ...
  return import_react475.default.createElement(Popover2, {
    active: Boolean(active),
    activator: popoverActivator,
    preferredAlignment: "left",
    onClose: handleClose,
    hideOnPrint: true
  }, import_react475.default.createElement(ActionList, {
    items: actions,
    onActionAnyItem: handleClose
  }), details && import_react475.default.createElement("div", {
...
function Actions({
  ...
  const i18n = useI18n();
  const actionsLayoutRef = (0, import_react476.useRef)(null);
  const menuGroupWidthRef = (0, import_react476.useRef)(0);
  const availableWidthRef = (0, import_react476.useRef)(0);
  const actionsAndGroupsLengthRef = (0, import_react476.useRef)(0);
  const timesMeasured = (0, import_react476.useRef)(0);
  const actionWidthsRef = (0, import_react476.useRef)([]);
  const [activeMenuGroup, setActiveMenuGroup] = (0, import_react476.useState)(void 0);
  const [measuredActions, setMeasuredActions] = (0, import_react476.useState)({
    showable: [],
    rolledUp: []
  });
  ...
  const handleActionsOffsetWidth = (0, import_react476.useCallback)((width) => {
    actionWidthsRef.current = [...actionWidthsRef.current, width];
  }, []);
  const handleMenuGroupToggle = (0, import_react476.useCallback)((group) => setActiveMenuGroup(activeMenuGroup ? void 0 : group), [activeMenuGroup]);
  const handleMenuGroupClose = (0, import_react476.useCallback)(() => setActiveMenuGroup(void 0), []);
  const updateActions = (0, import_react476.useCallback)(() => {
  ...
  const measureActions = (0, import_react476.useCallback)(() => {
  ...
  const handleResize = (0, import_react476.useMemo)(() => (0, import_debounce4.default)(() => {
  ...
  const actionsMarkup = actions.map((action) => {
    ...
    return import_react476.default.createElement(SecondaryAction, Object.assign({
      key: content,
      onClick: onAction
    }, rest, {
  ...
  const rollUppableActionsMarkup = measuredActions.showable.length > 0 ? measuredActions.showable.map((action) => action.content && import_react476.default.createElement(SecondaryAction, Object.assign({
    key: action.content
  }, action, {
    getOffsetWidth: handleActionsOffsetWidth
  }), action.content)) : null;
  ...
  const groupsMarkup = filteredGroups.map((group) => {
    ...
    const finalRolledUpActions = measuredActions.rolledUp.reduce((memo19, action) => {
      memo19.push(...isMenuGroup(action) ? action.actions : [action]);
      return memo19;
    }, []);
    if (!isDefaultGroup && !isLastMenuGroup) {
      return import_react476.default.createElement(MenuGroup, Object.assign({
        key: title,
        title,
  ...
  const groupedActionsMarkup = import_react476.default.createElement(ButtonGroup, {
    spacing: "extraTight"
  }, rollUppableActionsMarkup, actionsMarkup, groupsMarkup);
  return import_react476.default.createElement("div", {
    className: styles22.ActionsLayout,
    ref: actionsLayoutRef
  }, groupedActionsMarkup, import_react476.default.createElement(EventListener, {
    event: "resize",
    handler: handleResize
  }));
}
...
function ActionMenu({
  ...
  return import_react477.default.createElement("div", {
    className: actionMenuClassNames
  }, rollup ? import_react477.default.createElement(RollupActions, {
    accessibilityLabel: rollupActionsLabel,
    items: actions,
    sections: rollupSections
  }) : import_react477.default.createElement(Actions, {
    actions,
    groups
  }));
}
...
var import_react506 = __toModule(require_react());
...
var import_react495 = __toModule(require_react());
...
var import_react494 = __toModule(require_react());
var import_debounce5 = __toModule(require_debounce());

// node_modules/@shopify/polaris/build/esm/utilities/closest-parent-match.js
function closestParentMatch(element, matcher) {
  let parent = element.parentElement;
  while (parent) {
    if (parent.matches(matcher))
      return parent;
...
// node_modules/@shopify/polaris/build/esm/utilities/scroll-into-view.js
...
var import_react479 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/utilities/combobox/context.js
var import_react478 = __toModule(require_react());
var ComboboxTextFieldContext = (0, import_react478.createContext)(void 0);
var ComboboxListboxContext = (0, import_react478.createContext)({});
var ComboboxListboxOptionContext = (0, import_react478.createContext)({});

// node_modules/@shopify/polaris/build/esm/utilities/combobox/hooks.js
function useComboboxTextField() {
  const context = (0, import_react479.useContext)(ComboboxTextFieldContext);
  if (!context) {
...
function useComboboxListbox() {
  const context = (0, import_react479.useContext)(ComboboxListboxContext);
  return context;
}
...
var import_react480 = __toModule(require_react());
var ListboxContext = (0, import_react480.createContext)(void 0);
var WithinListboxContext = (0, import_react480.createContext)(false);
var ActionContext = (0, import_react480.createContext)(false);

// node_modules/@shopify/polaris/build/esm/components/Listbox/components/TextOption/TextOption.js
var import_react484 = __toModule(require_react());
...
var import_react483 = __toModule(require_react());
...
var import_react482 = __toModule(require_react());
...
var import_react481 = __toModule(require_react());
...
function InlineError({
  ...
  return import_react481.default.createElement("div", {
    id: errorTextID(fieldID),
    className: styles31.InlineError
  }, import_react481.default.createElement("div", {
...
function Choice({
  ...
  const className = classNames(styles30.Choice, labelHidden && styles30.labelHidden, disabled && styles30.disabled);
  const labelMarkup = import_react482.default.createElement("label", {
    className,
    htmlFor: id,
    onClick,
    onMouseOver,
    onMouseOut
  }, import_react482.default.createElement("span", {
    className: styles30.Control
  }, children2), import_react482.default.createElement("span", {
    className: styles30.Label
  }, label));
  const helpTextMarkup = helpText ? import_react482.default.createElement("div", {
    className: styles30.HelpText,
    id: helpTextID(id)
  }, helpText) : null;
  const errorMarkup = error && typeof error !== "boolean" && import_react482.default.createElement("div", {
    className: styles30.Error
  }, import_react482.default.createElement(InlineError, {
    message: error,
    fieldID: id
  }));
  const descriptionMarkup = helpTextMarkup || errorMarkup ? import_react482.default.createElement("div", {
    className: styles30.Descriptions
  }, errorMarkup, helpTextMarkup) : null;
  return descriptionMarkup ? import_react482.default.createElement("div", null, labelMarkup, descriptionMarkup) : labelMarkup;
}
...
// node_modules/@shopify/polaris/build/esm/components/Checkbox/Checkbox.js
var Checkbox = (0, import_react483.forwardRef)(function Checkbox2({
  ariaControls,
  ...
  const inputNode = (0, import_react483.useRef)(null);
  ...
  const [keyFocused, setKeyFocused] = (0, import_react483.useState)(false);
  const isWithinListbox = (0, import_react483.useContext)(WithinListboxContext);
  (0, import_react483.useImperativeHandle)(ref, () => ({
    focus: () => {
  ...
  const wrapperClassName = classNames(styles29.Checkbox, error && styles29.error);
  const backdropClassName = classNames(styles29.Backdrop, mouseOver && styles29.hover);
  ...
  const inputClassName = classNames(styles29.Input, isIndeterminate && styles29["Input-indeterminate"], keyFocused && styles29.keyFocused);
  return import_react483.default.createElement(Choice, {
    id,
    label,
    labelHidden,
    helpText,
  ...
  }, import_react483.default.createElement("span", {
    className: wrapperClassName
  }, import_react483.default.createElement("input", Object.assign({
    ref: inputNode,
    id,
    name,
    value,
  ...
  }, indeterminateAttributes)), import_react483.default.createElement("span", {
    className: backdropClassName,
    onClick: stopPropagation,
    onKeyUp: stopPropagation
  }), import_react483.default.createElement("span", {
    className: styles29.Icon
  }, import_react483.default.createElement(Icon, {
    source: iconSource
  }))));
});
function noop3() {
...
// node_modules/@shopify/polaris/build/esm/components/Listbox/components/TextOption/TextOption.js
var TextOption = (0, import_react484.memo)(function TextOption2({
  children: children2,
  selected,
  disabled
}) {
  const {
    allowMultiple
  } = (0, import_react484.useContext)(ComboboxListboxOptionContext);
  const isAction = (0, import_react484.useContext)(ActionContext);
  const textOptionClassName = classNames(styles28.TextOption, selected && !allowMultiple && styles28.selected, disabled && styles28.disabled, allowMultiple && styles28.allowMultiple, isAction && styles28.isAction);
  return import_react484.default.createElement("div", {
    className: textOptionClassName
  }, import_react484.default.createElement("div", {
    className: styles28.Content
  }, allowMultiple && !isAction ? import_react484.default.createElement("div", {
    className: styles28.Checkbox
  }, import_react484.default.createElement(Checkbox, {
    checked: selected,
    label: children2
  })) : children2));
});
...
var import_react486 = __toModule(require_react());
...
var import_react485 = __toModule(require_react());
function useListbox() {
  const listbox = (0, import_react485.useContext)(ListboxContext);
  if (!listbox) {
...
// node_modules/@shopify/polaris/build/esm/components/Listbox/components/Loading/Loading.js
var Loading = (0, import_react486.memo)(function LoadingOption({
  children: children2,
  ...
  return import_react486.default.createElement("li", {
    className: styles32.ListItem,
    role: "presentation"
  }, children2 ? children2 : import_react486.default.createElement("div", {
    className: styles32.Loading
  }, import_react486.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: label
  })));
});
...
var import_react488 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/components/Listbox/components/Section/context.js
var import_react487 = __toModule(require_react());
var SectionContext = (0, import_react487.createContext)(null);
...
function Section4({
  children: children2,
  divider: divider3 = true,
  title
}) {
  const sectionId = useUniqueId("ListboxSection");
  return import_react488.default.createElement(SectionContext.Provider, {
    value: sectionId
  }, import_react488.default.createElement("li", Object.assign({
    role: "presentation"
  }, listboxSectionDataSelector.props), title, import_react488.default.createElement("ul", {
    role: "group",
    "aria-labelledby": sectionId,
    className: classNames(styles33.SectionGroup, !divider3 && styles33.noDivider)
  }, children2)));
}

// node_modules/@shopify/polaris/build/esm/components/Listbox/components/Header/Header.js
var import_react490 = __toModule(require_react());
...
var import_react489 = __toModule(require_react());
function useSection() {
  const context = (0, import_react489.useContext)(SectionContext);
  return context;
}
...
function Header2({
  ...
  const content = typeof children2 === "string" ? import_react490.default.createElement("div", {
...
var import_react493 = __toModule(require_react());
...
var import_react492 = __toModule(require_react());
...
var import_react491 = __toModule(require_react());
var MappedActionContext = (0, import_react491.createContext)({});

// node_modules/@shopify/polaris/build/esm/components/Listbox/components/Option/Option.js
var Option = (0, import_react492.memo)(function Option2({
  value,
  children: children2,
  selected,
  disabled = false,
  ...
  const {
    ...
    onAction,
    destructive
  } = (0, import_react492.useContext)(MappedActionContext);
  const listItemRef = (0, import_react492.useRef)(null);
  const domId = useUniqueId("ListboxOption");
  const sectionId = useSection();
  const isWithinSection = Boolean(sectionId);
  const handleOptionClick = (0, import_react492.useCallback)((evt) => {
    evt.preventDefault();
    onAction && onAction();
  ...
  const content = typeof children2 === "string" ? import_react492.default.createElement(TextOption, {
    selected,
    disabled
  }, children2) : children2;
  ...
  const contentMarkup = url ? import_react492.default.createElement(UnstyledLink, {
    url,
    external
  }, content) : content;
  return import_react492.default.createElement("li", Object.assign({}, sectionAttributes, {
    "data-within-section": isWithinSection,
    "data-listbox-option-value": value,
    "data-listbox-option-destructive": destructive,
    className: classNames(styles36.Option, divider3 && styles36.divider),
    id: domId,
    ref: listItemRef,
    tabIndex: -1,
    onMouseDown: handleMouseDown,
    "aria-disabled": disabled,
    onClick: disabled ? void 0 : handleOptionClick,
...
function Action(props) {
  ...
  const iconMarkup = icon3 && import_react493.default.createElement("div", {
    className: styles35.Icon
  }, import_react493.default.createElement(Icon, {
    color: "subdued",
    source: icon3
  }));
  const className = classNames(styles35.Action, divider3 && styles35.ActionDivider);
  return import_react493.default.createElement(Option, props, import_react493.default.createElement(ActionContext.Provider, {
    value: true
  }, import_react493.default.createElement("div", {
    className
  }, import_react493.default.createElement(TextOption, {
    selected,
    disabled
...
var LISTBOX_OPTION_SELECTOR = "[data-listbox-option]";
var LISTBOX_OPTION_VALUE_ATTRIBUTE = "data-listbox-option-value";
var DATA_ATTRIBUTE2 = "data-focused";
function Listbox({
  children: children2,
  ...
  const listboxClassName = classNames(styles27.Listbox);
  const {
  ...
  const scrollableRef = (0, import_react494.useRef)(null);
  const listboxRef = (0, import_react494.useRef)(null);
  const [loading, setLoading] = (0, import_react494.useState)();
  const [currentActiveOption, setCurrentActiveOption] = (0, import_react494.useState)();
  const {
    setActiveOptionId,
    setListboxId,
    listboxId,
  ...
  (0, import_react494.useEffect)(() => {
    if (setListboxId && !listboxId) {
      setListboxId(listId);
    }
  }, [setListboxId, listboxId, listId]);
  (0, import_react494.useEffect)(() => {
    if (!currentActiveOption || !setActiveOptionId)
      return;
    setActiveOptionId(currentActiveOption.domId);
  }, [currentActiveOption, setActiveOptionId]);
  const handleScrollIntoView = (0, import_react494.useCallback)((0, import_debounce5.default)((option, first) => {
  ...
  const handleChangeActiveOption = (0, import_react494.useCallback)((nextOption) => {
    setCurrentActiveOption((currentActiveOption2) => {
      if (currentActiveOption2) {
        currentActiveOption2.element.removeAttribute(DATA_ATTRIBUTE2);
      }
      if (nextOption) {
        nextOption.element.setAttribute(DATA_ATTRIBUTE2, "true");
        if (scrollableRef.current) {
  ...
  (0, import_react494.useEffect)(() => {
    if (listboxRef.current) {
      scrollableRef.current = listboxRef.current.closest(scrollable2.selector);
    }
  }, []);
  (0, import_react494.useEffect)(() => {
  ...
  const onOptionSelect = (0, import_react494.useCallback)((option) => {
  ...
  const listboxContext = (0, import_react494.useMemo)(() => ({
    onOptionSelect,
    setLoading
  }), [onOptionSelect]);
  function findNextValidOption(type) {
    ...
    while (count++ < navItems.length) {
      ...
      if (((_nextElement2 = nextElement) === null || _nextElement2 === void 0 ? void 0 : _nextElement2.getAttribute("aria-disabled")) === "true")
        continue;
  ...
  const listeners = keyboardEventsEnabled || textFieldFocused ? import_react494.default.createElement(import_react494.default.Fragment, null, import_react494.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.DownArrow,
    handler: handleDownArrow
  }), import_react494.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.UpArrow,
  ...
  return import_react494.default.createElement(import_react494.default.Fragment, null, listeners, import_react494.default.createElement(VisuallyHidden, null, import_react494.default.createElement("div", {
    "aria-live": "polite"
  }, loading ? loading : null)), import_react494.default.createElement(ListboxContext.Provider, {
    value: listboxContext
  }, import_react494.default.createElement(WithinListboxContext.Provider, {
    value: true
  }, children2 ? import_react494.default.createElement("ul", {
    tabIndex: 0,
    role: "listbox",
...
// node_modules/@shopify/polaris/build/esm/components/Autocomplete/components/MappedOption/MappedOption.js
var MappedOption = (0, import_react495.memo)(function MappedOption2({
  label,
  value,
  disabled,
  media,
  ...
  const mediaClassNames = classNames(styles26.Media, disabled && styles26.disabledMedia, singleSelection && styles26.singleSelectionMedia);
  const mediaMarkup = media ? import_react495.default.createElement("div", {
    className: mediaClassNames
  }, media) : null;
  const accessibilityLabel = typeof label === "string" ? label : void 0;
  return import_react495.default.createElement(Listbox.Option, {
    accessibilityLabel,
    key: value,
    selected,
    value,
    disabled
  }, import_react495.default.createElement(Listbox.TextOption, {
    selected,
    disabled
  }, import_react495.default.createElement("div", {
    className: styles26.Content
  }, mediaMarkup, label)));
});

// node_modules/@shopify/polaris/build/esm/components/Combobox/Combobox.js
var import_react504 = __toModule(require_react());
...
var import_react503 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/components/TextField/TextField.js
var import_react502 = __toModule(require_react());
...
var import_react497 = __toModule(require_react());
...
var import_react496 = __toModule(require_react());
...
function Label({
  ...
  return import_react496.default.createElement("div", {
    className
  }, import_react496.default.createElement("label", {
    id: labelID(id),
    htmlFor: id,
...
function Labelled({
  ...
  const className = classNames(labelHidden && styles39.hidden);
  const actionMarkup = action ? import_react497.default.createElement("div", {
    className: styles39.Action
  }, buttonFrom(action, {
    plain: true
  })) : null;
  const helpTextMarkup = helpText ? import_react497.default.createElement("div", {
    className: styles39.HelpText,
    id: helpTextID2(id)
  }, helpText) : null;
  const errorMarkup = error && typeof error !== "boolean" && import_react497.default.createElement("div", {
    className: styles39.Error
  }, import_react497.default.createElement(InlineError, {
    message: error,
    fieldID: id
  }));
  const labelMarkup = label ? import_react497.default.createElement("div", {
    className: styles39.LabelWrapper
  }, import_react497.default.createElement(Label, Object.assign({
    id,
    requiredIndicator
  }, rest, {
    hidden: false
...
var import_react499 = __toModule(require_react());
...
var import_react498 = __toModule(require_react());
function Item4({
  children: children2,
  position
}) {
  ...
  const className = classNames(styles41.Item, focused3 && styles41["Item-focused"], position === "primary" ? styles41["Item-primary"] : styles41["Item-connection"]);
...
function Connected({
  ...
  const leftConnectionMarkup = left ? import_react499.default.createElement(Item4, {
    position: "left"
  }, left) : null;
  const rightConnectionMarkup = right ? import_react499.default.createElement(Item4, {
    position: "right"
  }, right) : null;
  return import_react499.default.createElement("div", {
    className: styles41.Connected
  }, leftConnectionMarkup, import_react499.default.createElement(Item4, {
    position: "primary"
  }, children2), rightConnectionMarkup);
}

// node_modules/@shopify/polaris/build/esm/components/TextField/components/Spinner/Spinner.js
var import_react500 = __toModule(require_react());
function Spinner2({
  onChange,
  onClick,
  onMouseDown,
  ...
  }, import_react500.default.createElement(Icon, {
...
var import_react501 = __toModule(require_react());
function Resizer({
  contents,
  ...
  const contentNode = (0, import_react501.useRef)(null);
  const minimumLinesNode = (0, import_react501.useRef)(null);
  const animationFrame = (0, import_react501.useRef)();
  const currentHeight = (0, import_react501.useRef)(currentHeightProp);
  ...
  const minimumLinesMarkup = minimumLines ? import_react501.default.createElement("div", {
  ...
  const handleHeightCheck = (0, import_react501.useCallback)(() => {
    if (animationFrame.current) {
      cancelAnimationFrame(animationFrame.current);
    }
  ...
  (0, import_react501.useLayoutEffect)(() => {
    handleHeightCheck();
  });
  return import_react501.default.createElement("div", {
    "aria-hidden": true,
    className: styles38.Resizer
  }, import_react501.default.createElement(EventListener, {
    event: "resize",
    handler: handleHeightCheck
  }), import_react501.default.createElement("div", {
    ref: contentNode,
    className: styles38.DummyInput,
    dangerouslySetInnerHTML: {
...
function TextField({
  ...
  const i18n = useI18n();
  const [height, setHeight] = (0, import_react502.useState)(null);
  const [focus, setFocus] = (0, import_react502.useState)(Boolean(focused3));
  const isAfterInitial = useIsAfterInitialMount();
  const id = useUniqueId("TextField", idProp);
  const inputRef = (0, import_react502.useRef)(null);
  const prefixRef = (0, import_react502.useRef)(null);
  const suffixRef = (0, import_react502.useRef)(null);
  const buttonPressTimer = (0, import_react502.useRef)();
  (0, import_react502.useEffect)(() => {
    const input2 = inputRef.current;
    if (!input2 || focused3 === void 0)
      return;
    focused3 ? input2.focus() : input2.blur();
  }, [focused3]);
  const normalizedValue = typeof value === "string" ? value : "";
  const normalizedStep = step != null ? step : 1;
  const normalizedMax = max != null ? max : Infinity;
  const normalizedMin = min != null ? min : -Infinity;
  const className = classNames(styles38.TextField, Boolean(normalizedValue) && styles38.hasValue, disabled && styles38.disabled, readOnly && styles38.readOnly, error && styles38.error, multiline && styles38.multiline, focus && styles38.focus);
  const inputType = type === "currency" ? "text" : type;
  const prefixMarkup = prefix ? import_react502.default.createElement("div", {
    className: styles38.Prefix,
    id: `${id}Prefix`,
    ref: prefixRef
  }, prefix) : null;
  const suffixMarkup = suffix ? import_react502.default.createElement("div", {
  ...
  if (showCharacterCount) {
    ...
    characterCountMarkup = import_react502.default.createElement("div", {
  ...
  const clearButtonClassNames = classNames(styles38.ClearButton, !clearButtonVisible && styles38.Hidden);
  const clearButtonMarkup = clearButton ? import_react502.default.createElement("button", {
    type: "button",
    className: clearButtonClassNames,
    onClick: handleClearButtonPress,
    disabled
  }, import_react502.default.createElement(VisuallyHidden, null, i18n.translate("Polaris.Common.clear")), import_react502.default.createElement(Icon, {
    source: SvgCircleCancelMinor,
    color: "base"
  })) : null;
  const handleNumberChange = (0, import_react502.useCallback)((steps) => {
    if (onChange == null) {
      return;
    }
  ...
  const handleButtonRelease = (0, import_react502.useCallback)(() => {
    clearTimeout(buttonPressTimer.current);
  }, []);
  const handleButtonPress = (0, import_react502.useCallback)((onChange2) => {
  ...
  const spinnerMarkup = type === "number" && step !== 0 && !disabled && !readOnly ? import_react502.default.createElement(Spinner2, {
  ...
  const handleExpandingResize = (0, import_react502.useCallback)((height2) => {
    setHeight(height2);
  }, []);
  const resizer = multiline && isAfterInitial ? import_react502.default.createElement(Resizer, {
  ...
  const inputClassName = classNames(styles38.Input, align && styles38[variationName("Input-align", align)], suffix && styles38["Input-suffixed"], clearButton && styles38["Input-hasClearButton"], monospaced && styles38.monospaced);
  ...
  const input = (0, import_react502.createElement)(multiline ? "textarea" : "input", {
    name,
    id,
    disabled,
    readOnly,
  ...
  const backdropClassName = classNames(styles38.Backdrop, connectedLeft && styles38["Backdrop-connectedLeft"], connectedRight && styles38["Backdrop-connectedRight"]);
  return import_react502.default.createElement(Labelled, {
    label,
    id,
    error,
    action: labelAction,
    ...
    helpText,
    requiredIndicator
  }, import_react502.default.createElement(Connected, {
    left: connectedLeft,
    right: connectedRight
  }, import_react502.default.createElement("div", {
    className,
    onFocus: handleFocus,
    onBlur: handleBlur,
    onClick: handleClick
  }, prefixMarkup, input, suffixMarkup, characterCountMarkup, clearButtonMarkup, spinnerMarkup, import_react502.default.createElement("div", {
    className: backdropClassName
  }), resizer)));
...
function TextField2({
  ...
  const textFieldId = (0, import_react503.useMemo)(() => idProp || uniqueId, [uniqueId, idProp]);
  const labelId = (0, import_react503.useMemo)(() => labelID(idProp || uniqueId), [uniqueId, idProp]);
  (0, import_react503.useEffect)(() => {
    if (setTextFieldLabelId)
      setTextFieldLabelId(labelId);
  }, [labelId, setTextFieldLabelId]);
  const handleFocus = (0, import_react503.useCallback)(() => {
    if (onFocus)
      onFocus();
    if (onTextFieldFocus)
      onTextFieldFocus();
  ...
  const handleBlur = (0, import_react503.useCallback)(() => {
    if (onBlur)
      onBlur();
    if (onTextFieldBlur)
      onTextFieldBlur();
  ...
  const handleChange = (0, import_react503.useCallback)((value2, id) => {
    if (onChange)
      onChange(value2, id);
    if (onTextFieldChange)
      onTextFieldChange();
  }, [onChange, onTextFieldChange]);
  return import_react503.default.createElement(TextField, Object.assign({}, rest, {
    value,
    id: textFieldId,
    onFocus: handleFocus,
    onBlur: handleBlur,
...
function Combobox({
  ...
  const [popoverActive, setPopoverActive] = (0, import_react504.useState)(false);
  const [activeOptionId, setActiveOptionId] = (0, import_react504.useState)();
  const [textFieldLabelId, setTextFieldLabelId] = (0, import_react504.useState)();
  const [listboxId, setListboxId] = (0, import_react504.useState)();
  const [textFieldFocused, setTextFieldFocused] = (0, import_react504.useState)(false);
  const shouldOpen = Boolean(!popoverActive && import_react504.Children.count(children2) > 0);
  const ref = (0, import_react504.useRef)(null);
  const onOptionSelected = (0, import_react504.useCallback)(() => {
    var _ref$current;
    if (!allowMultiple) {
  ...
  const handleClose = (0, import_react504.useCallback)(() => {
    setPopoverActive(false);
    setActiveOptionId(void 0);
  }, []);
  const handleFocus = (0, import_react504.useCallback)(() => {
    if (shouldOpen) {
      setPopoverActive(true);
    }
  }, [shouldOpen]);
  const handleChange = (0, import_react504.useCallback)(() => {
    if (shouldOpen) {
      setPopoverActive(true);
    }
  }, [shouldOpen]);
  const handleBlur = (0, import_react504.useCallback)(() => {
    if (popoverActive) {
      setPopoverActive(false);
      setActiveOptionId(void 0);
    }
  }, [popoverActive]);
  const textFieldContextValue = (0, import_react504.useMemo)(() => ({
    activeOptionId,
  ...
  const listboxOptionContextValue = (0, import_react504.useMemo)(() => ({
    allowMultiple
  }), [allowMultiple]);
  const listboxContextValue = (0, import_react504.useMemo)(() => ({
    setActiveOptionId,
    setListboxId,
    listboxId,
    textFieldLabelId,
  ...
  return import_react504.default.createElement(Popover2, {
    ...
    onClose: handleClose,
    activator: import_react504.default.createElement(ComboboxTextFieldContext.Provider, {
    ...
    preferredPosition
  }, import_react504.default.createElement(Popover2.Pane, {
    onScrolledToBottom
  }, import_react504.Children.count(children2) > 0 ? import_react504.default.createElement(ComboboxListboxContext.Provider, {
    value: listboxContextValue
  }, import_react504.default.createElement(ComboboxListboxOptionContext.Provider, {
    value: listboxOptionContextValue
  }, import_react504.default.createElement("div", {
...
var import_react505 = __toModule(require_react());
...
function MappedAction({
  ...
  if (prefix) {
    prefixMarkup = import_react505.default.createElement("div", {
      className: styles42.Prefix
    }, prefix);
  } else if (icon3) {
    prefixMarkup = import_react505.default.createElement("div", {
      className: styles42.Prefix
    }, import_react505.default.createElement(Icon, {
      source: icon3
    }));
  } else if (image) {
    prefixMarkup = import_react505.default.createElement("div", {
  ...
  const badgeMarkup = badge && import_react505.default.createElement("span", {
    className: styles42.Suffix
  }, import_react505.default.createElement(Badge, {
    status: badge.status
  }, badge.content));
  const suffixMarkup = suffix && import_react505.default.createElement("span", {
    className: styles42.Suffix
  }, suffix);
  const contentText = ellipsis && content ? i18n.translate("Polaris.Autocomplete.ellipsis", {
    content
  }) : content;
  const contentMarkup = import_react505.default.createElement("div", {
    className: styles42.Text
  }, import_react505.default.createElement("div", {
    className: contentOverflowStyle
  }, contentText), helpText ? import_react505.default.createElement(TextStyle, {
    variation: "subdued"
  }, helpText) : null);
  const context = (0, import_react505.useMemo)(() => ({
    role,
    url,
    external,
    onAction,
  ...
  return import_react505.default.createElement(MappedActionContext.Provider, {
    value: context
  }, import_react505.default.createElement("div", {
    className: styles42.ActionContainer
  }, import_react505.default.createElement(Listbox.Action, {
    selected: active,
    disabled,
    value: content || ""
  }, import_react505.default.createElement("div", {
...
var Autocomplete = function Autocomplete2({
  ...
  const i18n = useI18n();
  const buildMappedOptionFromOption = (0, import_react506.useCallback)((options2) => {
    return options2.map((option) => import_react506.default.createElement(MappedOption, Object.assign({
  ...
  const optionsMarkup = (0, import_react506.useMemo)(() => {
    ...
    if (isSection(conditionalOptions)) {
      ...
      const optionsMarkup2 = conditionalOptions.map(({
        ...
        return import_react506.default.createElement(Listbox.Section, {
          divider: false,
          title: import_react506.default.createElement(Listbox.Header, null, title),
          key: title
        }, optionMarkup);
      });
      return import_react506.default.createElement("div", {
        className: styles25.SectionWrapper
      }, optionsMarkup2);
    }
    ...
    if (listTitle) {
      return import_react506.default.createElement(Listbox.Section, {
        divider: false,
        title: import_react506.default.createElement(Listbox.Header, null, listTitle)
      }, optionList);
    }
    return optionList;
  }, [listTitle, loading, options, willLoadMoreResults, buildMappedOptionFromOption]);
  const loadingMarkup = loading ? import_react506.default.createElement(Listbox.Loading, {
    accessibilityLabel: i18n.translate("Polaris.Autocomplete.spinnerAccessibilityLabel")
  }) : null;
  const updateSelection = (0, import_react506.useCallback)((newSelection) => {
    if (allowMultiple) {
  ...
  const actionMarkup = actionBefore && import_react506.default.createElement(MappedAction, actionBefore);
  const emptyStateMarkup = emptyState && options.length < 1 && !loading && import_react506.default.createElement("div", {
    role: "status"
  }, emptyState);
  return import_react506.default.createElement(Combobox, {
    activator: textField,
    allowMultiple,
    onScrolledToBottom: onLoadMoreResults,
    preferredPosition
  }, actionMarkup || optionsMarkup || loadingMarkup || emptyStateMarkup ? import_react506.default.createElement(Listbox, {
...
var import_react509 = __toModule(require_react());
...
var import_react508 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/utilities/scroll-lock-manager/hooks.js
var import_react507 = __toModule(require_react());
function useScrollLockManager() {
  const scrollLockManager = (0, import_react507.useContext)(ScrollLockManagerContext);
...
function Backdrop(props) {
  ...
  return import_react509.default.createElement(import_react509.default.Fragment, null, import_react509.default.createElement(ScrollLock, null), import_react509.default.createElement("div", {
    className,
    onClick,
    onTouchStart
  }));
...
var import_react512 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/utilities/banner-context.js
var import_react510 = __toModule(require_react());
var BannerContext = (0, import_react510.createContext)(false);
...
var import_react511 = __toModule(require_react());
function unstyledButtonFrom({
  content,
  onAction,
  ...action
}, overrides, key) {
  return import_react511.default.createElement(UnstyledButton, Object.assign({
    key,
    onClick: onAction
  }, action, overrides), content);
}
...
// node_modules/@shopify/polaris/build/esm/components/Banner/Banner.js
var Banner = (0, import_react512.forwardRef)(function Banner2({
  icon: icon3,
  action,
  secondaryAction,
  title,
  ...
  const withinContentContainer = (0, import_react512.useContext)(WithinContentContext);
  ...
  const iconName = icon3 || defaultIcon;
  const className = classNames(styles44.Banner, status && styles44[variationName("status", status)], onDismiss && styles44.hasDismiss, shouldShowFocus && styles44.keyFocused, withinContentContainer ? styles44.withinContentContainer : styles44.withinPage);
  let headingMarkup = null;
  let headingID;
  if (title) {
    headingID = `${id}Heading`;
    headingMarkup = import_react512.default.createElement("div", {
      className: styles44.Heading,
      id: headingID
    }, import_react512.default.createElement(Heading, {
      element: "p"
    }, title));
  }
  const spinnerMarkup = action !== null && action !== void 0 && action.loading ? import_react512.default.createElement("button", {
    disabled: true,
    "aria-busy": true,
    className: classNames(styles44.Button, styles44.loading)
  }, import_react512.default.createElement("span", {
    className: styles44.Spinner
  }, import_react512.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: i18n.translate("Polaris.Button.spinnerAccessibilityLabel")
  })), action.content) : null;
  const primaryActionMarkup = action ? import_react512.default.createElement("div", {
    className: styles44.PrimaryAction
  }, action.loading ? spinnerMarkup : unstyledButtonFrom(action, {
    className: styles44.Button
  })) : null;
  const secondaryActionMarkup = secondaryAction ? import_react512.default.createElement(SecondaryActionFrom, {
    action: secondaryAction
  }) : null;
  const actionMarkup = action || secondaryAction ? import_react512.default.createElement("div", {
    className: styles44.Actions
  }, import_react512.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup)) : null;
  let contentMarkup = null;
  let contentID;
  if (children2 || actionMarkup) {
    contentID = `${id}Content`;
    contentMarkup = import_react512.default.createElement("div", {
      className: styles44.Content,
      id: contentID
    }, children2, actionMarkup);
  }
  const dismissButton = onDismiss && import_react512.default.createElement("div", {
    className: styles44.Dismiss
  }, import_react512.default.createElement(Button, {
    plain: true,
    icon: SvgCancelSmallMinor,
    onClick: onDismiss,
    accessibilityLabel: "Dismiss notification"
  }));
  return import_react512.default.createElement(BannerContext.Provider, {
    value: true
  }, import_react512.default.createElement("div", {
    className,
    tabIndex: 0,
    ref: wrapperRef,
    role: ariaRoleType,
  ...
  }, dismissButton, import_react512.default.createElement("div", {
    className: styles44.Ribbon
  }, import_react512.default.createElement(Icon, {
    source: iconName,
    color: iconColor
  })), import_react512.default.createElement("div", {
...
function SecondaryActionFrom({
  ...
  if (action.url) {
    return import_react512.default.createElement(UnstyledLink, {
  ...
  return import_react512.default.createElement(UnstyledButton, {
    className: styles44.SecondaryAction,
...
function useBannerFocus(bannerRef) {
  const wrapperRef = (0, import_react512.useRef)(null);
  const [shouldShowFocus, setShouldShowFocus] = (0, import_react512.useState)(false);
  (0, import_react512.useImperativeHandle)(bannerRef, () => ({
    focus: () => {
...
var import_react513 = __toModule(require_react());
...
function Breadcrumbs({
  ...
  const contentMarkup = import_react513.default.createElement(import_react513.default.Fragment, null, import_react513.default.createElement("span", {
    className: styles45.Icon
  }, import_react513.default.createElement(Icon, {
    source: SvgArrowLeftMinor
  })), import_react513.default.createElement(VisuallyHidden, null, content));
  const breadcrumbMarkup = "url" in breadcrumb ? import_react513.default.createElement(UnstyledLink, {
    key: content,
    url: breadcrumb.url,
    className: styles45.Breadcrumb,
    onMouseUp: handleMouseUpByBlurring,
    "aria-label": breadcrumb.accessibilityLabel
  }, contentMarkup) : import_react513.default.createElement("button", {
    key: content,
    className: styles45.Breadcrumb,
  ...
  return import_react513.default.createElement("nav", {
    role: "navigation"
  }, breadcrumbMarkup);
}

// node_modules/@shopify/polaris/build/esm/components/BulkActions/BulkActions.js
var import_react527 = __toModule(require_react());
...
// node_modules/react-transition-group/esm/CSSTransition.js
var import_react516 = __toModule(require_react());

// node_modules/react-transition-group/esm/Transition.js
var import_prop_types2 = __toModule(require_prop_types());
var import_react515 = __toModule(require_react());
...
var import_react514 = __toModule(require_react());
var TransitionGroupContext_default = import_react514.default.createContext(null);
...
var Transition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react515.default.createElement(TransitionGroupContext_default.Provider, {
      value: null
    }, typeof children2 === "function" ? children2(status, childProps) : import_react515.default.cloneElement(import_react515.default.Children.only(children2), childProps));
  };
  return Transition2;
}(import_react515.default.Component);
...
var CSSTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react516.default.createElement(Transition_default, _extends({}, props, {
...
}(import_react516.default.Component);
...
var import_react519 = __toModule(require_react());
...
var import_react518 = __toModule(require_react());

// node_modules/react-transition-group/esm/utils/ChildMapping.js
var import_react517 = __toModule(require_react());
function getChildMapping(children2, mapFn) {
  var mapper = function mapper2(child) {
    return mapFn && (0, import_react517.isValidElement)(child) ? mapFn(child) : child;
  };
  var result = Object.create(null);
  if (children2)
    import_react517.Children.map(children2, function(c) {
      return c;
...
function getInitialChildMapping(props, onExited) {
  return getChildMapping(props.children, function(child) {
    return (0, import_react517.cloneElement)(child, {
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children2).forEach(function(key) {
    ...
    if (!(0, import_react517.isValidElement)(child))
      return;
    var hasPrev = key in prevChildMapping;
    var hasNext = key in nextChildMapping;
    var prevChild = prevChildMapping[key];
    var isLeaving = (0, import_react517.isValidElement)(prevChild) && !prevChild.props.in;
    if (hasNext && (!hasPrev || isLeaving)) {
      children2[key] = (0, import_react517.cloneElement)(child, {
        onExited: onExited.bind(null, child),
        in: true,
    ...
    } else if (hasNext && hasPrev && (0, import_react517.isValidElement)(prevChild)) {
      children2[key] = (0, import_react517.cloneElement)(child, {
        onExited: onExited.bind(null, child),
...
var TransitionGroup = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    delete props.exit;
    if (Component9 === null) {
      return import_react518.default.createElement(TransitionGroupContext_default.Provider, {
        value: contextValue
      }, children2);
    }
    return import_react518.default.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, import_react518.default.createElement(Component9, props, children2));
  };
  return TransitionGroup2;
}(import_react518.default.Component);
...
var ReplaceTransition = function(_React$Component) {
  ...
  _proto.handleLifecycle = function handleLifecycle(handler, idx, originalArgs) {
    ...
    var child = import_react519.default.Children.toArray(children2)[idx];
  ...
  _proto.render = function render() {
    ...
    var _React$Children$toArr = import_react519.default.Children.toArray(children2), first = _React$Children$toArr[0], second = _React$Children$toArr[1];
    ...
    return import_react519.default.createElement(TransitionGroup_default, props, inProp ? import_react519.default.cloneElement(first, {
      key: "first",
      onEnter: this.handleEnter,
      onEntering: this.handleEntering,
      onEntered: this.handleEntered
    }) : import_react519.default.cloneElement(second, {
      key: "second",
...
}(import_react519.default.Component);
ReplaceTransition.propTypes = true ? {
  in: import_prop_types5.default.bool.isRequired,
  children: function children(props, propName) {
    if (import_react519.default.Children.count(props[propName]) !== 2)
...
var import_react520 = __toModule(require_react());
...
function areChildrenDifferent(oldChildren, newChildren) {
  if (oldChildren === newChildren)
    return false;
  if (import_react520.default.isValidElement(oldChildren) && import_react520.default.isValidElement(newChildren) && oldChildren.key != null && oldChildren.key === newChildren.key) {
    return false;
  }
  return true;
}
...
var leaveRenders = (_leaveRenders = {}, _leaveRenders[modes.out] = function(_ref) {
  ...
  return import_react520.default.cloneElement(current, {
    in: false,
  ...
  return [current, import_react520.default.cloneElement(children2, {
    in: true,
...
var enterRenders = (_enterRenders = {}, _enterRenders[modes.out] = function(_ref3) {
  ...
  return import_react520.default.cloneElement(children2, {
    in: true,
    onEntered: callHook(children2, "onEntered", function() {
      changeState(ENTERED, import_react520.default.cloneElement(children2, {
        in: true
      }));
    })
  });
  ...
  }), import_react520.default.cloneElement(children2, {
    in: true
  })];
}, _enterRenders);
var SwitchTransition = function(_React$Component) {
  ...
  SwitchTransition2.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    return {
      current: import_react520.default.cloneElement(props.children, {
        in: true
      })
    };
  };
  _proto.render = function render() {
    ...
    return import_react520.default.createElement(TransitionGroupContext_default.Provider, {
      value: {
...
}(import_react520.default.Component);
...
var import_react522 = __toModule(require_react());
...
function Indicator({
  ...
  return import_react522.default.createElement("span", {
    className
  });
}
...
function BulkActionButton({
  ...
  const bulkActionButton = (0, import_react523.useRef)(null);
  ...
  return import_react523.default.createElement("div", {
  ...
  }, import_react523.default.createElement(Button, {
    external,
    url,
    "aria-label": accessibilityLabel,
    onClick: onAction,
    disabled,
    disclosure
  }, content), indicator && import_react523.default.createElement(Indicator, null));
}
...
function BulkActionMenu({
  ...
  return import_react524.default.createElement(import_react524.default.Fragment, null, import_react524.default.createElement(Popover2, {
    active: isVisible,
    activator: import_react524.default.createElement(BulkActionButton, {
      disclosure: true,
    ...
    preferInputActivator: true
  }, import_react524.default.createElement(ActionList, {
    items: actions,
...
var import_react526 = __toModule(require_react());
...
var import_react525 = __toModule(require_react());
var ResourceListContext = (0, import_react525.createContext)({});
...
function CheckableButton({
  ...
  const checkBoxRef = (0, import_react526.useRef)(null);
  const {
    registerCheckableButtons
  } = (0, import_react526.useContext)(ResourceListContext);
  ...
  const className = plain ? classNames(styles48.CheckableButton, styles48["CheckableButton-plain"]) : classNames(styles48.CheckableButton, selectMode && styles48["CheckableButton-selectMode"], selected && styles48["CheckableButton-selected"], measuring && styles48["CheckableButton-measuring"]);
  return import_react526.default.createElement("div", {
    className,
    onClick: onToggleAll
  }, import_react526.default.createElement("div", {
    className: styles48.Checkbox
  }, import_react526.default.createElement(Checkbox, {
    label: accessibilityLabel,
    labelHidden: true,
    checked: selected,
    disabled,
    ...
    ref: checkBoxRef
  })), import_react526.default.createElement("span", {
...
var slideClasses = {
  appear: classNames(styles46.Slide, styles46["Slide-appear"]),
  appearActive: classNames(styles46.Slide, styles46["Slide-appearing"]),
  enter: classNames(styles46.Slide, styles46["Slide-enter"]),
  enterActive: classNames(styles46.Slide, styles46["Slide-entering"]),
  exit: classNames(styles46.Slide, styles46["Slide-exit"])
};
var BulkActionsInner = class extends import_react527.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
    ...
    this.checkableWrapperNode = (0, import_react527.createRef)();
    this.largeScreenGroupNode = (0, import_react527.createRef)();
    this.smallScreenGroupNode = (0, import_react527.createRef)();
    this.promotedActionsWidths = [];
    this.bulkActionsWidth = 0;
    this.addedMoreActionsWidthForMeasuring = 0;
    this.handleResize = (0, import_debounce6.default)(() => {
      const {
  ...
  render() {
    ...
    const paginatedSelectAllActionMarkup = paginatedSelectAllAction ? import_react527.default.createElement(Button, {
      onClick: paginatedSelectAllAction.onAction,
      plain: true,
      disabled
    }, paginatedSelectAllAction.content) : null;
    const paginatedSelectAllTextMarkup = paginatedSelectAllText && paginatedSelectAllAction ? import_react527.default.createElement("span", {
      "aria-live": "polite"
    }, paginatedSelectAllText) : paginatedSelectAllText;
    const paginatedSelectAllMarkup = paginatedSelectAllActionMarkup || paginatedSelectAllTextMarkup ? import_react527.default.createElement("div", {
      className: styles46.PaginatedSelectAll
    }, paginatedSelectAllTextMarkup, " ", paginatedSelectAllActionMarkup) : null;
    const cancelButton = import_react527.default.createElement(Button, {
      onClick: this.setSelectMode.bind(this, false),
      disabled
    }, i18n.translate("Polaris.Common.cancel"));
    const numberOfPromotedActionsToRender = this.numberOfPromotedActionsToRender();
    const allActionsPopover = this.hasActions() ? import_react527.default.createElement("div", {
      className: styles46.Popover,
      ref: this.setMoreActionsNode
    }, import_react527.default.createElement(Popover2, {
      active: smallScreenPopoverVisible,
      activator: import_react527.default.createElement(BulkActionButton, {
        disclosure: true,
    ...
    }, import_react527.default.createElement(ActionList, {
    ...
    const promotedActionsMarkup = promotedActions && numberOfPromotedActionsToRender > 0 ? [...promotedActions].slice(0, numberOfPromotedActionsToRender).map((action, index) => {
      if (instanceOfMenuGroupDescriptor(action)) {
        return import_react527.default.createElement(BulkActionMenu, Object.assign({
          key: index
        }, action, {
          isNewBadgeInBadgeActions: this.isNewBadgeInBadgeActions()
        }));
      }
      return import_react527.default.createElement(BulkActionButton, Object.assign({
        key: index,
        disabled
      }, action, {
    ...
    const actionsPopover = actionSections || rolledInPromotedActions.length > 0 || measuring ? import_react527.default.createElement("div", {
      className: styles46.Popover,
      ref: this.setMoreActionsNode
    }, import_react527.default.createElement(Popover2, {
    ...
    const smallScreenGroup = smallScreen ? import_react527.default.createElement(Transition_default, {
      timeout: 0,
      in: selectMode,
      key: "smallGroup",
      nodeRef: this.smallScreenGroupNode
    }, (status) => {
      const smallScreenGroupClassName = classNames(styles46.Group, styles46["Group-smallScreen"], styles46[`Group-${status}`]);
      return import_react527.default.createElement("div", {
        className: smallScreenGroupClassName,
        ref: this.smallScreenGroupNode
      }, import_react527.default.createElement("div", {
        className: styles46.ButtonGroupWrapper
      }, import_react527.default.createElement(ButtonGroup, {
        segmented: true
      }, import_react527.default.createElement(CSSTransition_default, {
        ...
        className: styles46.CheckableContainer,
        ref: this.checkableWrapperNode
      }, import_react527.default.createElement(CheckableButton, Object.assign({}, checkableButtonProps, {
        smallScreen: true
      })))), allActionsPopover, cancelButton)), paginatedSelectAllMarkup);
    }) : null;
    const largeGroupContent = promotedActionsMarkup || actionsPopover ? import_react527.default.createElement(ButtonGroup, {
      segmented: true
    }, import_react527.default.createElement(CheckableButton, checkableButtonProps), promotedActionsMarkup, actionsPopover) : import_react527.default.createElement(CheckableButton, checkableButtonProps);
    const largeScreenGroup = smallScreen ? null : import_react527.default.createElement(Transition_default, {
      timeout: 0,
      in: selectMode,
      key: "largeGroup",
      nodeRef: this.largeScreenGroupNode
    }, (status) => {
      const largeScreenGroupClassName = classNames(styles46.Group, styles46["Group-largeScreen"], !measuring && styles46[`Group-${status}`], measuring && styles46["Group-measuring"]);
      return import_react527.default.createElement("div", {
        className: largeScreenGroupClassName,
        ref: this.largeScreenGroupNode
      }, import_react527.default.createElement(EventListener, {
        event: "resize",
...
function BulkActions(props) {
  const i18n = useI18n();
  return import_react527.default.createElement(BulkActionsInner, Object.assign({}, props, {
    i18n
  }));
}

// node_modules/@shopify/polaris/build/esm/components/CalloutCard/CalloutCard.js
var import_react529 = __toModule(require_react());
...
var import_react528 = __toModule(require_react());
...
function TextContainer({
  ...
  const className = classNames(styles50.TextContainer, spacing2 && styles50[variationName("spacing", spacing2)]);
  return import_react528.default.createElement("div", {
    className
  }, children2);
}
...
function CalloutCard({
  ...
  const buttonMarkup = secondaryActionMarkup ? import_react529.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup) : primaryActionMarkup;
  const dismissButton = onDismiss ? import_react529.default.createElement("div", {
    className: styles49.Dismiss
  }, import_react529.default.createElement(Button, {
    plain: true,
    icon: SvgCancelSmallMinor,
    onClick: onDismiss,
  ...
  return import_react529.default.createElement(Card, null, import_react529.default.createElement("div", {
    className: containerClassName
  }, dismissButton, import_react529.default.createElement(Card.Section, null, import_react529.default.createElement("div", {
  ...
  }, import_react529.default.createElement(Heading, null, title)), import_react529.default.createElement(TextContainer, null, children2), import_react529.default.createElement("div", {
    className: styles49.Buttons
  }, buttonMarkup)), import_react529.default.createElement(Image, {
    alt: "",
...
var import_react530 = __toModule(require_react());
...
function Caption({
  ...
  return import_react530.default.createElement("p", {
    className: styles51.Caption
  }, children2);
}

// node_modules/@shopify/polaris/build/esm/components/ChoiceList/ChoiceList.js
var import_react532 = __toModule(require_react());
...
var import_react531 = __toModule(require_react());
...
function RadioButton({
  ...
  const inputNode = (0, import_react531.useRef)(null);
  const [keyFocused, setKeyFocused] = (0, import_react531.useState)(false);
  const {
    value: mouseOver,
    setTrue: handleMouseOver,
    setFalse: handleMouseOut
  ...
  const ariaDescribedBy = describedBy.length ? describedBy.join(" ") : void 0;
  const inputClassName = classNames(styles53.Input, keyFocused && styles53.keyFocused);
  const backdropClassName = classNames(styles53.Backdrop, mouseOver && styles53.hover);
  return import_react531.default.createElement(Choice, {
    label,
    labelHidden,
    disabled,
    id,
    ...
    onMouseOver: handleMouseOver,
    onMouseOut: handleMouseOut
  }, import_react531.default.createElement("span", {
    className: styles53.RadioButton
  }, import_react531.default.createElement("input", {
    id,
    name,
    value,
    type: "radio",
...
function ChoiceList({
  ...
  const className = classNames(styles52.ChoiceList, titleHidden && styles52.titleHidden);
  const titleMarkup = title ? import_react532.default.createElement("legend", {
    className: styles52.Title
  }, title) : null;
  const choicesMarkup = choices.map((choice) => {
    ...
    const children2 = renderedChildren ? import_react532.default.createElement("div", {
      className: styles52.ChoiceChildren
    }, renderedChildren) : null;
    return import_react532.default.createElement("li", {
      key: value
    }, import_react532.default.createElement(ControlComponent, {
      name: finalName,
      value,
      label,
  ...
  const errorMarkup = error && import_react532.default.createElement("div", {
    className: styles52.ChoiceError
  }, import_react532.default.createElement(InlineError, {
    message: error,
    fieldID: finalName
  }));
  return import_react532.default.createElement("fieldset", {
    className,
    id: finalName,
    "aria-invalid": error != null
  }, titleMarkup, import_react532.default.createElement("ul", {
    className: styles52.Choices
...
var import_react533 = __toModule(require_react());
...
function Collapsible({
  ...
  const [height, setHeight] = (0, import_react533.useState)(0);
  const [isOpen, setIsOpen] = (0, import_react533.useState)(open);
  const [animationState, setAnimationState] = (0, import_react533.useState)("idle");
  const collapsibleContainer = (0, import_react533.useRef)(null);
  ...
  const handleCompleteAnimation = (0, import_react533.useCallback)(({
    target
  }) => {
...
var import_react537 = __toModule(require_react());
...
var import_react535 = __toModule(require_react());
...
var import_react534 = __toModule(require_react());
...
var Slidable = class extends import_react534.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      dragging: false
  ...
  render() {
    ...
    const moveListener = dragging ? import_react534.default.createElement(EventListener, {
      event: "mousemove",
      handler: this.handleMove,
      passive: false
    }) : null;
    const touchMoveListener = dragging ? import_react534.default.createElement(EventListener, {
      event: "touchmove",
      handler: this.handleMove,
      passive: false
    }) : null;
    const endDragListener = dragging ? import_react534.default.createElement(EventListener, {
      event: "mouseup",
      handler: this.handleDragEnd
    }) : null;
    const touchEndListener = dragging ? import_react534.default.createElement(EventListener, {
      event: "touchend",
      handler: this.handleDragEnd
    }) : null;
    const touchCancelListener = dragging ? import_react534.default.createElement(EventListener, {
      event: "touchcancel",
      handler: this.handleDragEnd
    }) : null;
    ...
    }, endDragListener, moveListener, touchMoveListener, touchEndListener, touchCancelListener, import_react534.default.createElement("div", {
...
// node_modules/@shopify/polaris/build/esm/components/ColorPicker/components/AlphaPicker/AlphaPicker.js
var AlphaPicker = class extends import_react535.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      sliderHeight: 0,
  ...
  render() {
    ...
    const background3 = alphaGradientForColor(color);
    return import_react535.default.createElement("div", {
    ...
    }), import_react535.default.createElement(Slidable, {
      draggerY,
      draggerX: 0,
...
var import_react536 = __toModule(require_react());
...
// node_modules/@shopify/polaris/build/esm/components/ColorPicker/components/HuePicker/HuePicker.js
var HuePicker = class extends import_react536.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      sliderHeight: 0,
  ...
  render() {
    ...
    return import_react536.default.createElement("div", {
      className: styles55.HuePicker,
      ref: this.setSliderHeight
    }, import_react536.default.createElement(Slidable, {
      draggerY,
      draggerX: 0,
      onChange: this.handleChange,
      onDraggerHeight: this.setDraggerHeight
...
var ColorPicker = class extends import_react537.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      pickerSize: {
    ...
    this.colorNode = null;
    this.handleResize = (0, import_debounce7.default)(() => {
      const {
        colorNode
      } = this;
      if (colorNode == null) {
  ...
  render() {
    ...
    const alphaSliderMarkup = allowAlpha ? import_react537.default.createElement(AlphaPicker, {
      alpha,
      color,
      onChange: this.handleAlphaChange
    }) : null;
    const className = classNames(styles55.ColorPicker, fullWidth && styles55.fullWidth);
    return import_react537.default.createElement("div", {
      className,
      id,
    ...
    }), import_react537.default.createElement(Slidable, {
      onChange: this.handleDraggerMove,
      draggerX,
      draggerY
    })), import_react537.default.createElement(HuePicker, {
      hue,
      onChange: this.handleHueChange
    }), alphaSliderMarkup, import_react537.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    }));
  }
...
var import_react540 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/utilities/frame/hooks.js
var import_react539 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/utilities/frame/context.js
var import_react538 = __toModule(require_react());
var FrameContext = (0, import_react538.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/frame/hooks.js
function useFrame() {
  const frame = (0, import_react539.useContext)(FrameContext);
  if (!frame) {
...
// node_modules/@shopify/polaris/build/esm/components/ContextualSaveBar/ContextualSaveBar.js
var ContextualSaveBar = (0, import_react540.memo)(function ContextualSaveBar2({
  message,
  saveAction,
  discardAction,
  alignContentFlush,
...
var import_react543 = __toModule(require_react());
...
var import_react541 = __toModule(require_react());
function Cell({
  content,
  contentType,
  firstColumn,
  ...
  const className = classNames(styles56.Cell, styles56[`Cell-${variationName("verticalAlign", verticalAlign)}`], firstColumn && styles56["Cell-firstColumn"], firstColumn && truncate && styles56["Cell-truncated"], header && styles56["Cell-header"], total && styles56["Cell-total"], totalInFooter && styles56["Cell-total-footer"], numeric && styles56["Cell-numeric"], sortable && styles56["Cell-sortable"], sorted && styles56["Cell-sorted"]);
  const headerClassName = classNames(header && styles56.Heading, header && contentType === "text" && styles56["Heading-left"]);
  const iconClassName = classNames(sortable && styles56.Icon);
  const direction = sorted && sortDirection ? sortDirection : defaultSortDirection;
  const source = direction === "descending" ? SvgCaretDownMinor : SvgCaretUpMinor;
  ...
  const iconMarkup = import_react541.default.createElement("span", {
    className: iconClassName
  }, import_react541.default.createElement(Icon, {
    source,
    accessibilityLabel: sortAccessibilityLabel
  }));
  const sortableHeadingContent = import_react541.default.createElement("button", {
  ...
  const headingMarkup = header ? import_react541.default.createElement("th", Object.assign({}, headerCell.props, colSpanProp, {
    className,
    scope: "col",
    "aria-sort": sortDirection
  }), columnHeadingContent) : import_react541.default.createElement("th", Object.assign({
    className,
    scope: "row"
  }, colSpanProp), content);
  const cellMarkup = header || firstColumn ? headingMarkup : import_react541.default.createElement("td", Object.assign({
    className
  }, colSpanProp), content);
  return cellMarkup;
}
...
var import_react542 = __toModule(require_react());
function Navigation({
  ...
  const pipMarkup = columnVisibilityData.map((column, index) => {
    const className = classNames(styles56.Pip, column.isVisible && styles56["Pip-visible"]);
    return import_react542.default.createElement("div", {
      className,
      key: `pip-${index}`
    });
  });
  ...
  }, import_react542.default.createElement(Button, {
    plain: true,
    icon: SvgChevronLeftMinor,
    disabled: isScrolledFarthestLeft,
    accessibilityLabel: leftA11yLabel,
    onClick: navigateTableLeft
  }), pipMarkup, import_react542.default.createElement(Button, {
    plain: true,
...
// node_modules/@shopify/polaris/build/esm/components/DataTable/DataTable.js
var DataTableInner = class extends import_react543.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      condensed: false,
    ...
    this.dataTable = (0, import_react543.createRef)();
    this.scrollContainer = (0, import_react543.createRef)();
    this.table = (0, import_react543.createRef)();
    this.handleResize = (0, import_debounce8.default)(() => {
      const {
        table: {
          current: table
        },
    ...
    this.renderHeadings = (heading, headingIndex) => {
      ...
      return import_react543.default.createElement(Cell, Object.assign({
        header: true,
        key: id,
        content: heading,
    ...
    this.renderTotals = (total, index) => {
      ...
      return import_react543.default.createElement(Cell, {
        total: true,
        totalInFooter,
        firstColumn: index === 0,
        key: id,
    ...
    this.defaultRenderRow = (row, index) => {
      ...
      const className = classNames(styles56.TableRow, hoverable && styles56.hoverable);
      return import_react543.default.createElement("tr", {
        key: `row-${index}`,
        className
  ...
  componentDidUpdate(prevProps) {
    if ((0, import_isEqual.default)(prevProps, this.props)) {
      return;
    }
    this.handleResize();
  }
  ...
  render() {
    ...
    const className = classNames(styles56.DataTable, condensed && styles56.condensed);
    const wrapperClassName = classNames(styles56.TableWrapper, condensed && styles56.condensed);
    const headingMarkup = import_react543.default.createElement("tr", null, headings.map(this.renderHeadings));
    const totalsMarkup = totals ? import_react543.default.createElement("tr", null, totals.map(this.renderTotals)) : null;
    const bodyMarkup = rows.map(this.defaultRenderRow);
    const footerMarkup = footerContent ? import_react543.default.createElement("div", {
      className: styles56.Footer
    }, footerContent) : null;
    const headerTotalsMarkup = !showTotalsInFooter ? totalsMarkup : null;
    const footerTotalsMarkup = showTotalsInFooter ? import_react543.default.createElement("tfoot", null, totalsMarkup) : null;
    const navigationMarkup = hideScrollIndicator ? null : import_react543.default.createElement(Navigation, {
      columnVisibilityData,
      isScrolledFarthestLeft,
      isScrolledFarthestRight,
    ...
    return import_react543.default.createElement("div", {
      className: wrapperClassName
    }, navigationMarkup, import_react543.default.createElement("div", {
      className,
      ref: this.dataTable
    }, import_react543.default.createElement("div", {
      className: styles56.ScrollContainer,
      ref: this.scrollContainer
    }, import_react543.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    }), import_react543.default.createElement(EventListener, {
      capture: true,
    ...
    }), import_react543.default.createElement("table", {
      className: styles56.Table,
      ref: this.table
    }, import_react543.default.createElement("thead", null, headingMarkup, headerTotalsMarkup), import_react543.default.createElement("tbody", null, bodyMarkup), footerTotalsMarkup)), footerMarkup));
  }
};
function DataTable(props) {
  const i18n = useI18n();
  return import_react543.default.createElement(DataTableInner, Object.assign({}, props, {
    i18n
  }));
}

// node_modules/@shopify/polaris/build/esm/components/DatePicker/DatePicker.js
var import_react547 = __toModule(require_react());
...
var import_react546 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/components/DatePicker/components/Weekday/Weekday.js
var import_react544 = __toModule(require_react());
var Weekday = (0, import_react544.memo)(function Weekday2({
  label,
  title,
  current
}) {
  const className = classNames(styles57.Weekday, current && styles57["Weekday-current"]);
  return import_react544.default.createElement("th", {
    "aria-label": label,
    scope: "col",
    className
  }, title);
...
var import_react545 = __toModule(require_react());
var Day = (0, import_react545.memo)(function Day2({
  day,
  focused: focused3,
  onClick,
  onHover = noop6,
  ...
  const i18n = useI18n();
  const dayNode = (0, import_react545.useRef)(null);
  const hoverValue = lastDayOfMonth || day;
  (0, import_react545.useEffect)(() => {
    if (focused3 && dayNode.current) {
      dayNode.current.focus();
    }
  }, [focused3]);
  if (!day) {
    return import_react545.default.createElement("td", {
      className: styles57.EmptyDayCell,
      onMouseOver: () => onHover(hoverValue)
    });
  }
  const handleClick = onClick && !disabled ? onClick.bind(null, day) : noop6;
  const today = isSameDay(new Date(), day);
  const dayCellClassName = classNames(styles57.DayCell, selected && styles57["DayCell-selected"], (inRange || inHoveringRange) && !disabled && styles57["DayCell-inRange"], isLastSelectedDay && styles57["DayCell-lastInRange"], isFirstSelectedDay && styles57["DayCell-firstInRange"], isHoveringRight && styles57["DayCell-hoverRight"], rangeIsDifferent && styles57["DayCell-hasRange"]);
  const dayClassName = classNames(styles57.Day, selected && styles57["Day-selected"], disabled && styles57["Day-disabled"], today && styles57["Day-today"], (inRange || inHoveringRange) && !disabled && styles57["Day-inRange"], isLastSelectedDay && styles57["Day-lastInRange"], isFirstSelectedDay && styles57["Day-firstInRange"], isHoveringRight && styles57["Day-hoverRight"], rangeIsDifferent && styles57["Day-hasRange"]);
  const date = day.getDate();
  const tabIndex = (focused3 || selected || today || date === 1) && !disabled ? 0 : -1;
...
function Month({
  ...
  const className = classNames(styles57.Title, current && styles57["Month-current"]);
  const weeks = (0, import_react546.useMemo)(() => getWeeksForMonth(month, year, weekStartsOn), [month, weekStartsOn, year]);
  const weekdays = getOrderedWeekdays(weekStartsOn).map((weekday) => import_react546.default.createElement(Weekday, {
    key: weekday,
    title: i18n.translate(`Polaris.DatePicker.daysAbbreviated.${weekdayName(weekday)}`),
    label: weekdayLabel(weekday),
    current: current && new Date().getDay() === weekday
  }));
  const handleDateClick = (0, import_react546.useCallback)((selectedDate) => {
    onChange(getNewRange(allowRange ? selected : void 0, selectedDate));
  }, [allowRange, onChange, selected]);
  const lastDayOfMonth = (0, import_react546.useMemo)(() => new Date(year, month + 1, 0), [month, year]);
  function renderWeek(day, dayIndex) {
    if (day == null) {
      return import_react546.default.createElement(Day, {
        key: dayIndex,
        onHover,
        lastDayOfMonth
      });
  ...
  const weeksMarkup = weeks.map((week, index) => import_react546.default.createElement("tr", {
    className: styles57.Week,
    key: index
  }, week.map(renderWeek)));
  return import_react546.default.createElement("div", {
    className: styles57.MonthContainer
  }, import_react546.default.createElement("table", {
    role: "grid",
    className: styles57.Month
  }, import_react546.default.createElement("caption", {
    className
  }, i18n.translate(`Polaris.DatePicker.months.${monthName(month)}`), " ", year), import_react546.default.createElement("thead", null, import_react546.default.createElement("tr", {
    className: styles57.WeekHeadings
  }, weekdays)), import_react546.default.createElement("tbody", null, weeksMarkup)));
...
function DatePicker({
  ...
  const i18n = useI18n();
  const [hoverDate, setHoverDate] = (0, import_react547.useState)(void 0);
  const [focusDate, setFocusDate] = (0, import_react547.useState)(void 0);
  (0, import_react547.useEffect)(() => {
    setFocusDate(void 0);
  }, [selected]);
  const handleFocus = (0, import_react547.useCallback)((date) => {
    setFocusDate(date);
  }, []);
  const setFocusDateAndHandleMonthChange = (0, import_react547.useCallback)((date) => {
    if (onMonthChange) {
  ...
  const handleDateSelection = (0, import_react547.useCallback)((range) => {
    const {
      end
    } = range;
    setHoverDate(end);
  ...
  const handleMonthChangeClick = (0, import_react547.useCallback)((month2, year2) => {
    if (!onMonthChange) {
      return;
    }
    setFocusDate(void 0);
  ...
  const handleHover = (0, import_react547.useCallback)((date) => {
    setHoverDate(date);
  }, []);
  const handleKeyUp = (0, import_react547.useCallback)((event) => {
    const {
      key
    } = event;
  ...
  const monthIsSelected = (0, import_react547.useMemo)(() => deriveRange(selected), [selected]);
  ...
  const secondDatePicker = multiMonth ? import_react547.default.createElement(Month, {
    onFocus: handleFocus,
  ...
  const datePickerClassName = classNames(styles57.DatePicker);
  return import_react547.default.createElement("div", {
    id,
    className: datePickerClassName,
    onKeyDown: handleKeyDown,
    onKeyUp: handleKeyUp
  }, import_react547.default.createElement("div", {
    className: styles57.Header
  }, import_react547.default.createElement(Button, {
    plain: true,
    ...
    className: styles57.MonthLayout
  }, import_react547.default.createElement(Month, {
    onFocus: handleFocus,
    focusedDate: focusDate,
    month,
    year,
...
var import_react548 = __toModule(require_react());
...
function DescriptionList({
  ...
  const terms = items.reduce((allTerms, {
    term,
    description
  }, index) => [...allTerms, import_react548.default.createElement("dt", {
    key: `dt${index}`,
    className: styles58.Term
  }, term), import_react548.default.createElement("dd", {
    key: `dd${index}`,
    className: styles58.Description
  }, description)], []);
  const className = classNames(styles58.DescriptionList, spacing2 === "tight" && styles58.spacingTight);
  return import_react548.default.createElement("dl", {
    className
  }, terms);
}

// node_modules/@shopify/polaris/build/esm/components/DisplayText/DisplayText.js
var import_react549 = __toModule(require_react());
...
function DisplayText({
  ...
  const className = classNames(styles59.DisplayText, size && styles59[variationName("size", size)]);
  return import_react549.default.createElement(Element2, {
    className
  }, children2);
}

// node_modules/@shopify/polaris/build/esm/components/DropZone/DropZone.js
var import_react552 = __toModule(require_react());
...
var import_react550 = __toModule(require_react());
...
// node_modules/@shopify/polaris/build/esm/components/DropZone/context.js
var DropZoneContext = (0, import_react550.createContext)({
  disabled: false,
  focused: false,
  size: "extraLarge",
  type: "file",
...
var import_react551 = __toModule(require_react());
...
function FileUpload(props) {
  ...
  const {
    ...
    disabled,
    allowMultiple
  } = (0, import_react551.useContext)(DropZoneContext);
  ...
  const actionClassNames = classNames(styles61.Action, disabled && styles61.disabled);
  const actionMarkup = import_react551.default.createElement("div", {
    className: actionClassNames
  }, actionTitle);
  const fileUploadClassName = classNames(styles61.FileUpload, measuring && styles61.measuring, size === "large" && styles61.large, size === "small" && styles61.small);
  const actionHintMarkup = actionHint && import_react551.default.createElement(Caption, null, import_react551.default.createElement(TextStyle, {
    variation: "subdued"
  }, actionHint));
  let viewMarkup;
  switch (size) {
    case "large":
      viewMarkup = import_react551.default.createElement(Stack, {
        vertical: true,
        spacing: "tight"
    ...
    case "medium":
      ...
      break;
    case "small":
      viewMarkup = import_react551.default.createElement("img", {
        width: "20",
        src: uploadArrow,
        alt: ""
      });
  ...
  return import_react551.default.createElement("div", {
...
var DropZone = function DropZone2({
  ...
  const node = (0, import_react552.useRef)(null);
  const dragTargets = (0, import_react552.useRef)([]);
  const adjustSize = (0, import_react552.useCallback)((0, import_debounce9.default)(() => {
    if (!node.current) {
      return;
    }
    if (variableHeight) {
  ...
  const [dragging, setDragging] = (0, import_react552.useState)(false);
  const [internalError, setInternalError] = (0, import_react552.useState)(false);
  const {
    value: focused3,
    setTrue: handleFocus,
    setFalse: handleBlur
  } = useToggle(false);
  const [size, setSize] = (0, import_react552.useState)("large");
  const [measuring, setMeasuring] = (0, import_react552.useState)(true);
  const i18n = useI18n();
  const getValidatedFiles = (0, import_react552.useCallback)((files) => {
    const acceptedFiles = [];
    const rejectedFiles = [];
  ...
  const handleDrop = (0, import_react552.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
  ...
  const handleDragEnter = (0, import_react552.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
    const fileList = getDataTransferFiles(event);
  ...
  const handleDragOver = (0, import_react552.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
    onDragOver && onDragOver();
  }, [disabled, onDragOver]);
  const handleDragLeave = (0, import_react552.useCallback)((event) => {
    event.preventDefault();
    if (disabled)
      return;
  ...
  const classes = classNames(styles60.DropZone, outline && styles60.hasOutline, focused3 && styles60.focused, (active || dragging) && styles60.isDragging, disabled && styles60.isDisabled, (internalError || error) && styles60.hasError, !variableHeight && styles60[variationName("size", size)], measuring && styles60.measuring);
  const dragOverlay = (active || dragging) && !internalError && !error && overlay4 && overlayMarkup(SvgUploadMajor, "interactive", overlayTextWithDefault);
  ...
  const context = (0, import_react552.useMemo)(() => ({
    disabled,
    focused: focused3,
    size,
    type: type || "file",
    measuring,
    allowMultiple
  }), [disabled, focused3, measuring, size, type, allowMultiple]);
  return import_react552.default.createElement(DropZoneContext.Provider, {
    value: context
  }, import_react552.default.createElement(Labelled, {
    id,
    label: labelValue,
    action: labelAction,
  ...
  }, dragOverlay, dragErrorOverlay, import_react552.default.createElement(VisuallyHidden, null, import_react552.default.createElement(DropZoneInput, Object.assign({}, inputAttributes, {
    openFileDialog,
    onFileDialogClose
  }))), import_react552.default.createElement("div", {
    className: styles60.Container
  }, children2))));
  function overlayMarkup(icon3, color, text3) {
    return import_react552.default.createElement("div", {
      className: styles60.Overlay
    }, import_react552.default.createElement(Stack, {
      vertical: true,
      spacing: "tight"
    }, size === "small" && import_react552.default.createElement(Icon, {
      source: icon3,
      color
    }), (size === "medium" || size === "large") && import_react552.default.createElement(Caption, null, import_react552.default.createElement(TextStyle, {
      variation: "strong"
    }, text3))));
  }
  function open() {
...
var DropZoneInput = class extends import_react552.Component {
  constructor(...args) {
    super(...args);
    this.fileInputNode = (0, import_react552.createRef)();
  ...
  render() {
    ...
    return import_react552.default.createElement("input", Object.assign({}, inputProps, {
...
var import_react553 = __toModule(require_react());
...
function EmptySearchResult({
  ...
  const descriptionMarkup = description ? import_react553.default.createElement("p", null, description) : null;
  const illustrationMarkup = withIllustration ? import_react553.default.createElement(Image, {
    alt: altText,
    source: emptySearch,
    draggable: false
  }) : null;
  return import_react553.default.createElement(Stack, {
    alignment: "center",
    vertical: true
  }, illustrationMarkup, import_react553.default.createElement(DisplayText, {
    size: "small"
  }, title), import_react553.default.createElement(TextStyle, {
    variation: "subdued"
  }, descriptionMarkup));
}

// node_modules/@shopify/polaris/build/esm/components/EmptyState/EmptyState.js
var import_react554 = __toModule(require_react());
...
function EmptyState({
  ...
  const withinContentContainer = (0, import_react554.useContext)(WithinContentContext);
  const className = classNames(styles62.EmptyState, fullWidth && styles62.fullWidth, imageContained && styles62.imageContained, withinContentContainer && styles62.withinContentContainer);
  const imageMarkup = largeImage ? import_react554.default.createElement(Image, {
    alt: "",
    role: "presentation",
    className: styles62.Image,
    source: largeImage,
    sourceSet: [{
      source: image,
      descriptor: "568w"
  ...
  }) : import_react554.default.createElement(Image, {
    role: "presentation",
    alt: "",
    className: styles62.Image,
    source: image
  ...
  const footerContentMarkup = footerContent ? import_react554.default.createElement("div", {
    className: styles62.FooterContent
  }, import_react554.default.createElement(TextContainer, null, footerContent)) : null;
  const headingSize = withinContentContainer ? "small" : "medium";
  const primaryActionMarkup = action ? buttonFrom(action, {
    primary: true,
    size: "medium"
  }) : null;
  const headingMarkup = heading ? import_react554.default.createElement(DisplayText, {
    size: headingSize
  }, heading) : null;
  const childrenMarkup = children2 ? import_react554.default.createElement("div", {
    className: styles62.Content
  }, children2) : null;
  const textContentMarkup = headingMarkup || children2 ? import_react554.default.createElement(TextContainer, null, headingMarkup, childrenMarkup) : null;
  const actionsMarkup = primaryActionMarkup || secondaryActionMarkup ? import_react554.default.createElement("div", {
    className: styles62.Actions
  }, import_react554.default.createElement(Stack, {
    alignment: "center",
    distribution: "center",
    spacing: "tight"
  }, primaryActionMarkup, secondaryActionMarkup)) : null;
  const detailsMarkup = textContentMarkup || actionsMarkup || footerContentMarkup ? import_react554.default.createElement("div", {
    className: styles62.DetailsContainer
  }, import_react554.default.createElement("div", {
    className: styles62.Details
  }, textContentMarkup, actionsMarkup, footerContentMarkup)) : import_react554.default.createElement("div", {
    className: styles62.DetailsContainer
  });
  return import_react554.default.createElement("div", {
    className
  }, import_react554.default.createElement("div", {
    className: styles62.Section
  }, detailsMarkup, import_react554.default.createElement("div", {
    className: styles62.ImageContainer
  }, imageMarkup)));
}

// node_modules/@shopify/polaris/build/esm/components/ExceptionList/ExceptionList.js
var import_react556 = __toModule(require_react());
...
var import_react555 = __toModule(require_react());
...
function ExceptionList({
  ...
  const items = itemsList.map((item, index) => {
    ...
    const itemClasses = classNames(styles63.Item, status && styles63[variationName("status", status)]);
    const iconMarkup = icon3 ? import_react556.default.createElement(Icon, {
      source: icon3
    }) : import_react556.default.createElement("span", {
      className: styles63.Bullet
    });
    const titleMarkup = title && import_react556.default.createElement("span", {
      className: styles63.Title
    }, title);
    const descriptionMarkup = description && import_react556.default.createElement("span", {
      className: styles63.Description
    }, description);
    const Element2 = truncate ? Truncate : import_react556.Fragment;
    return import_react556.default.createElement("li", {
      className: itemClasses,
      key: index
    }, import_react556.default.createElement("span", {
      className: styles63.Icon
    }, iconMarkup), import_react556.default.createElement(Element2, null, titleMarkup, descriptionMarkup));
  });
  return import_react556.default.createElement("ul", {
    className: styles63.ExceptionList
  }, items);
}

// node_modules/@shopify/polaris/build/esm/components/Filters/Filters.js
var import_react566 = __toModule(require_react());
...
var import_react558 = __toModule(require_react());
var import_debounce10 = __toModule(require_debounce());
...
var import_react557 = __toModule(require_react());
function Item5({
  children: children2
}) {
  const {
  ...
  const className = classNames(styles66.Item, focused3 && styles66["Item-focused"]);
  return import_react557.default.createElement("div", {
    onBlur: forceFalseFocused,
    onFocus: forceTrueFocused,
    className
  }, children2);
...
var ConnectedFilterControl = class extends import_react558.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      availableWidth: 0,
    ...
    this.container = (0, import_react558.createRef)();
    this.proxyButtonContainer = (0, import_react558.createRef)();
    this.moreFiltersButtonContainer = (0, import_react558.createRef)();
    this.handleResize = (0, import_debounce10.default)(() => {
  ...
  render() {
    ...
    const className = classNames(styles66.ConnectedFilterControl, rightPopoverableActions && styles66.right);
    ...
    const RightContainerClassName = classNames(styles66.RightContainer, !shouldRenderMoreFiltersButton && styles66.RightContainerWithoutMoreFilters, queryFieldHidden && styles66.queryFieldHidden);
    const rightMarkup = actionsToRender.length > 0 ? import_react558.default.createElement("div", {
      className: RightContainerClassName
    }, this.popoverFrom(actionsToRender)) : null;
    const moreFiltersButtonContainerClassname = classNames(styles66.MoreFiltersButtonContainer, actionsToRender.length === 0 && styles66.onlyButtonVisible);
    const rightActionMarkup = rightAction ? import_react558.default.createElement("div", {
      ref: this.moreFiltersButtonContainer,
      className: moreFiltersButtonContainerClassname
    }, shouldRenderMoreFiltersButton && import_react558.default.createElement(Item5, null, rightAction)) : null;
    const proxyButtonMarkup = rightPopoverableActions ? import_react558.default.createElement("div", {
      className: styles66.ProxyButtonContainer,
      ref: this.proxyButtonContainer,
      "aria-hidden": true
    }, rightPopoverableActions.map((action) => import_react558.default.createElement("div", {
      key: action.key,
      "data-key": action.key
    }, this.activatorButtonFrom(action, {
      proxy: true
    })))) : null;
    const auxMarkup = auxiliary ? import_react558.default.createElement("div", {
      className: styles66.AuxiliaryContainer
    }, auxiliary) : null;
    return import_react558.default.createElement(import_react558.default.Fragment, null, proxyButtonMarkup, import_react558.default.createElement("div", {
      className: styles66.Wrapper
    }, import_react558.default.createElement("div", {
      className,
      ref: this.container
    }, children2 ? import_react558.default.createElement("div", {
      className: styles66.CenterContainer
    }, import_react558.default.createElement(Item5, null, children2)) : null, rightMarkup, rightActionMarkup, import_react558.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    })), auxMarkup));
  }
  ...
  activatorButtonFrom(action, options) {
    ...
    return import_react558.default.createElement(Button, {
      onClick: action.onAction,
      disclosure: true,
  ...
  popoverFrom(actions) {
    return actions.map((action) => {
      return import_react558.default.createElement(Item5, {
        key: action.key
      }, import_react558.default.createElement(Popover2, {
...
var import_react559 = __toModule(require_react());
function TagsWrapper({
  children: children2,
  hidden
}) {
  if (hidden) {
    return import_react559.default.createElement(VisuallyHidden, null, children2);
  }
  return import_react559.default.createElement(import_react559.default.Fragment, null, children2);
}

// node_modules/@shopify/polaris/build/esm/components/Tag/Tag.js
var import_react560 = __toModule(require_react());
...
function Tag({
  ...
  const className = classNames(styles67.Tag, disabled && styles67.disabled, onClick && styles67.clickable, onRemove && styles67.removable, url && !disabled && styles67.linkable, segmented && styles67.segmented);
  if (onClick) {
    return import_react560.default.createElement("button", {
      type: "button",
      disabled,
      className,
      onClick
  ...
  const removeButton = onRemove ? import_react560.default.createElement("button", {
    type: "button",
    "aria-label": ariaLabel,
    className: classNames(styles67.Button, segmented && styles67.segmented),
    onClick: onRemove,
    onMouseUp: handleMouseUpByBlurring,
    disabled
  }, import_react560.default.createElement(Icon, {
    source: SvgCancelSmallMinor
  })) : null;
  const tagContent = url && !disabled ? import_react560.default.createElement("a", {
    className: classNames(styles67.Link, segmented && styles67.segmented),
    href: url
  }, import_react560.default.createElement("span", {
    title: tagTitle,
    className: styles67.LinkText
  }, children2)) : import_react560.default.createElement("span", {
    title: tagTitle,
    className: styles67.TagText
  }, children2);
  return import_react560.default.createElement("span", {
    className
  }, tagContent, removeButton);
}

// node_modules/@shopify/polaris/build/esm/components/Sheet/Sheet.js
var import_react565 = __toModule(require_react());
...
var import_react561 = __toModule(require_react());
function useMediaQuery() {
  const mediaQuery = (0, import_react561.useContext)(MediaQueryContext);
  if (!mediaQuery) {
...
var import_react564 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/utilities/focus-manager/hooks.js
var import_react562 = __toModule(require_react());
function useFocusManager({
  trapping
}) {
  const focusManager = (0, import_react562.useContext)(FocusManagerContext);
  ...
  const value = (0, import_react562.useMemo)(() => ({
    canSafelyFocus
  }), [canSafelyFocus]);
...
var import_react563 = __toModule(require_react());
var Focus = (0, import_react563.memo)(function Focus2({
  children: children2,
  disabled,
  root
}) {
  ...
  return import_react563.default.createElement(import_react563.default.Fragment, null, children2);
});
function isRef(ref) {
...
function TrapFocus({
  ...
  const focusTrapWrapper = (0, import_react564.useRef)(null);
  const [disableFocus, setDisableFocus] = (0, import_react564.useState)(true);
  (0, import_react564.useEffect)(() => {
  ...
  return import_react564.default.createElement(Focus, {
    disabled: disableFocus,
    root: focusTrapWrapper.current
  }, import_react564.default.createElement("div", {
    ref: focusTrapWrapper
  }, import_react564.default.createElement(EventListener, {
    event: "focusin",
    handler: handleFocusIn
  }), import_react564.default.createElement(KeypressListener, {
    keyCode: Key.Tab,
    keyEvent: "keydown",
    handler: handleTab
  }), children2));
...
var BOTTOM_CLASS_NAMES = {
  enter: classNames(styles68.Bottom, styles68.enterBottom),
  enterActive: classNames(styles68.Bottom, styles68.enterBottomActive),
  exit: classNames(styles68.Bottom, styles68.exitBottom),
  exitActive: classNames(styles68.Bottom, styles68.exitBottomActive)
};
var RIGHT_CLASS_NAMES = {
  enter: classNames(styles68.Right, styles68.enterRight),
  enterActive: classNames(styles68.Right, styles68.enterRightActive),
  exit: classNames(styles68.Right, styles68.exitRight),
  exitActive: classNames(styles68.Right, styles68.exitRightActive)
};
function Sheet({
  children: children2,
  open,
  ...
  const container = (0, import_react565.useRef)(null);
  const activatorRef = (0, import_react565.useRef)(null);
  const handleClose = (0, import_react565.useCallback)(() => {
    onClose();
  ...
  const activatorMarkup = activator && !isRef2(activator) ? import_react565.default.createElement("div", {
    ref: activatorRef
  }, activator) : null;
  return import_react565.default.createElement(import_react565.default.Fragment, null, activatorMarkup, import_react565.default.createElement(Portal, {
    idPrefix: "sheet"
  }, import_react565.default.createElement(CSSTransition_default, {
    nodeRef: container,
    ...
    onEntered,
    onExit
  }, import_react565.default.createElement("div", Object.assign({
    className: styles68.Container
  }, layer.props, overlay.props, {
    ref: container
  }), import_react565.default.createElement(TrapFocus, {
    trapping: open
  }, import_react565.default.createElement("div", {
    role: "dialog",
    "aria-modal": true,
    tabIndex: -1,
    className: styles68.Sheet,
    "aria-label": accessibilityLabel
  }, children2)))), import_react565.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: handleClose
  }), open && import_react565.default.createElement(Backdrop, {
    transparent: true,
    onClick: handleClose
  })));
}
...
var FiltersInner = class extends import_react566.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      open: false,
    ...
    this.moreFiltersButtonContainer = (0, import_react566.createRef)();
    this.moreFiltersDoneButtonContainer = (0, import_react566.createRef)();
    this.focusNode = (0, import_react566.createRef)();
    this.closeFilters = () => {
      this.setState({
        open: false
      }, () => {
  ...
  render() {
    ...
    const backdropMarkup = open ? import_react566.default.createElement(import_react566.default.Fragment, null, import_react566.default.createElement(ScrollLock, null), import_react566.default.createElement("div", {
    ...
    const filtersContentMarkup = filters.map((filter, index) => {
      ...
      const icon3 = filterIsOpen ? SvgChevronUpMinor : SvgChevronDownMinor;
      const className = classNames(styles65.FilterTriggerContainer, filterIsOpen && styles65.open, index === 0 && styles65.first, filters.length !== 1 && index === filters.length - 1 && styles65.last);
      const appliedFilterContent = this.getAppliedFilterContent(filter.key);
      const appliedFilterBadgeMarkup = appliedFilterContent ? import_react566.default.createElement("div", {
        className: styles65.AppliedFilterBadgeContainer
      }, import_react566.default.createElement(Badge, {
        size: "small",
        status: "new"
      }, appliedFilterContent)) : null;
      const collapsibleID = `${filter.key}Collapsible`;
      const buttonClassName = classNames(styles65.FilterTrigger);
      return import_react566.default.createElement("div", {
        key: filter.key,
        className
      }, import_react566.default.createElement("button", {
      ...
      }, import_react566.default.createElement("div", {
        className: styles65.FilterTriggerLabelContainer
      }, import_react566.default.createElement("h3", {
        className: styles65.FilterTriggerTitle
      }, import_react566.default.createElement(TextStyle, {
        variation: this.props.disabled || filter.disabled ? "subdued" : void 0
      }, filter.label)), import_react566.default.createElement("span", {
        className: styles65.FilterTriggerIcon
      }, import_react566.default.createElement(Icon, {
        source: icon3,
        color: "base"
      }))), appliedFilterBadgeMarkup), import_react566.default.createElement(Collapsible, {
        id: collapsibleID,
        open: filterIsOpen
      }, import_react566.default.createElement("div", {
        className: styles65.FilterNodeContainer
      }, import_react566.default.createElement(Focus, {
    ...
    const rightActionMarkup = filters.length ? import_react566.default.createElement("div", {
      ref: this.moreFiltersButtonContainer
    }, import_react566.default.createElement(Button, {
    ...
    const filtersControlMarkup = import_react566.default.createElement(ConnectedFilterControl, {
    ...
    }, hideQueryField ? null : import_react566.default.createElement(TextField, {
      ...
      labelHidden: true,
      prefix: import_react566.default.createElement("span", {
        className: styles65.SearchIcon
      }, import_react566.default.createElement(Icon, {
    ...
    const filtersContainerHeaderClassname = classNames(styles65.FiltersContainerHeader);
    const filtersDesktopHeaderMarkup = import_react566.default.createElement("div", {
      className: filtersContainerHeaderClassname
    }, import_react566.default.createElement(DisplayText, {
      size: "small",
      element: "h3"
    }, moreFiltersLabel), import_react566.default.createElement(Button, {
      icon: SvgCancelSmallMinor,
      plain: true,
      accessibilityLabel: i18n.translate("Polaris.Filters.cancel"),
      onClick: this.closeFilters
    }));
    const filtersMobileHeaderMarkup = import_react566.default.createElement("div", {
      className: filtersContainerHeaderClassname
    }, import_react566.default.createElement(Button, {
      icon: SvgCancelSmallMinor,
      plain: true,
    ...
    const filtersDesktopFooterClassname = classNames(styles65.FiltersContainerFooter);
    const filtersDesktopFooterMarkup = import_react566.default.createElement("div", {
      className: filtersDesktopFooterClassname
    }, import_react566.default.createElement(Button, {
      onClick: this.handleClearAll,
      disabled: !this.hasAppliedFilters()
    }, i18n.translate("Polaris.Filters.clearAllFilters")), import_react566.default.createElement("div", {
      ref: this.moreFiltersDoneButtonContainer
    }, import_react566.default.createElement(Button, {
      onClick: this.closeFilters,
      primary: true
    }, i18n.translate("Polaris.Filters.done"))));
    const filtersMobileFooterMarkup = import_react566.default.createElement("div", {
      className: styles65.FiltersMobileContainerFooter
    }, this.hasAppliedFilters() ? import_react566.default.createElement(Button, {
      onClick: onClearAll,
      fullWidth: true
    }, i18n.translate("Polaris.Filters.clearAllFilters")) : import_react566.default.createElement("div", {
      className: styles65.EmptyFooterState
    }, import_react566.default.createElement(TextStyle, {
      variation: "subdued"
    }, import_react566.default.createElement("p", null, i18n.translate("Polaris.Filters.noFiltersApplied")))));
    const shouldHideTagsContainer = !appliedFilters || appliedFilters.length < 1;
    const tagsMarkup = !hideTags ? import_react566.default.createElement(TagsWrapper, {
      hidden: shouldHideTagsContainer
    }, import_react566.default.createElement("div", {
      className: styles65.TagsContainer,
      "aria-live": "polite"
    }, (appliedFilters || []).map((filter) => {
      return import_react566.default.createElement(Tag, {
        key: filter.key,
        onRemove: () => {
    ...
    const filtersMobileContainerContentClassName = classNames(styles65.FiltersMobileContainerContent);
    const filtersDesktopContainerContentClassName = classNames(styles65.FiltersDesktopContainerContent);
    const filtersContainerMarkup = isNavigationCollapsed ? import_react566.default.createElement(Sheet, {
      accessibilityLabel: moreFiltersLabel,
      open,
      onClose: this.closeFilters,
      onEntered: this.setReadyForFocus(true),
      onExit: this.setReadyForFocus(false)
    }, filtersMobileHeaderMarkup, import_react566.default.createElement(Scrollable, {
      className: filtersMobileContainerContentClassName,
      shadow: true
    }, filtersContentMarkup, filtersMobileFooterMarkup)) : import_react566.default.createElement(Sheet, {
      accessibilityLabel: moreFiltersLabel,
      open,
      onClose: this.closeFilters,
      onEntered: this.setReadyForFocus(true),
      ...
      className: styles65.FiltersContainer
    }, filtersDesktopHeaderMarkup, import_react566.default.createElement(Scrollable, {
      className: filtersDesktopContainerContentClassName,
      shadow: true
    }, filtersContentMarkup), filtersDesktopFooterMarkup));
    const helpTextMarkup = helpText ? import_react566.default.createElement("div", {
      id: "FiltersHelpText",
      className: styles65.HelpText
    }, import_react566.default.createElement(TextStyle, {
      variation: "subdued"
    }, helpText)) : null;
    return import_react566.default.createElement(WithinFilterContext.Provider, {
      value: true
    }, import_react566.default.createElement("div", {
      className: styles65.Filters
    }, filtersControlMarkup, filtersContainerMarkup, tagsMarkup, helpTextMarkup, backdropMarkup, import_react566.default.createElement(KeypressListener, {
      keyCode: Key.Escape,
  ...
  generateFilterMarkup(filter) {
    ...
    const clearButtonMarkup = !filter.hideClearButton && import_react566.default.createElement(Button, {
      plain: true,
    ...
    return import_react566.default.createElement("div", {
      ref: this.focusNode
    }, import_react566.default.createElement(Stack, {
      vertical: true,
      spacing: "tight"
...
function Filters(props) {
  ...
  return import_react566.default.createElement(FiltersInner, Object.assign({}, props, {
    i18n,
    mediaQuery
  }));
}
...
var import_react567 = __toModule(require_react());
...
var import_react568 = __toModule(require_react());
function Form({
  acceptCharset,
  action,
  autoComplete,
  ...
  const i18n = useI18n();
  const handleSubmit = (0, import_react568.useCallback)((event) => {
    if (!preventDefault2) {
      return;
    }
    event.preventDefault();
  ...
  const submitMarkup = implicitSubmit ? import_react568.default.createElement(VisuallyHidden, null, import_react568.default.createElement("button", {
    type: "submit",
    "aria-hidden": "true",
    tabIndex: -1
  }, i18n.translate("Polaris.Common.submit"))) : null;
  return import_react568.default.createElement("form", {
    acceptCharset,
    action,
...
var import_react571 = __toModule(require_react());
...
function Group({
  ...
  const className = classNames(condensed ? styles70.condensed : styles70.grouped);
  ...
  if (helpText) {
    ...
    helpTextElement = import_react570.default.createElement("div", {
      id: helpTextID3,
      className: styles70.HelpText
    }, helpText);
  }
  if (title) {
    titleID = `${id}Title`;
    titleElement = import_react570.default.createElement("div", {
      id: titleID,
      className: styles70.Title
    }, title);
  }
  const itemsMarkup = import_react570.Children.map(children2, (child) => wrapWithComponent(child, Item6, {}));
  return import_react570.default.createElement("div", {
    ...
    className: styles70.Items
  }, itemsMarkup), helpTextElement);
}

// node_modules/@shopify/polaris/build/esm/components/FormLayout/FormLayout.js
var FormLayout = (0, import_react571.memo)(function FormLayout2({
  children: children2
}) {
  return import_react571.default.createElement("div", {
    className: styles70.FormLayout
  }, import_react571.Children.map(children2, wrapChildren));
});
...
var import_react588 = __toModule(require_react());
...
var import_react573 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/utilities/use-is-mounted-ref.js
var import_react572 = __toModule(require_react());
function useIsMountedRef() {
  const isMounted = (0, import_react572.useRef)(false);
  (0, import_react572.useEffect)(() => {
...
function Loading2() {
  ...
  const [progress, setProgress] = (0, import_react573.useState)(0);
  const [animating, setAnimating] = (0, import_react573.useState)(false);
...
var import_react574 = __toModule(require_react());
...
function CSSAnimation({
  ...
  const [transitionStatus, setTransitionStatus] = (0, import_react574.useState)(inProp ? TransitionStatus2.Entering : TransitionStatus2.Exited);
  const isMounted = (0, import_react574.useRef)(false);
  const node = (0, import_react574.useRef)(null);
  ...
  return import_react574.default.createElement("div", {
    className: wrapperClassName,
    ref: node,
...
var import_react582 = __toModule(require_react());
...
var import_react581 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/components/Modal/Modal.js
var import_react580 = __toModule(require_react());
...
var import_react575 = __toModule(require_react());
...
function Dialog({
  ...
  const containerNode = (0, import_react575.useRef)(null);
  const classes = classNames(styles76.Modal, small && styles76.sizeSmall, large && styles76.sizeLarge, limitHeight && styles76.limitHeight);
  const TransitionChild = instant ? Transition_default : FadeUp;
  (0, import_react575.useEffect)(() => {
  ...
  return import_react575.default.createElement(TransitionChild, Object.assign({}, props, {
    ...
    onEntered,
    onExited
  }), import_react575.default.createElement("div", {
    className: styles76.Container,
    "data-polaris-layer": true,
    "data-polaris-overlay": true,
    ref: containerNode
  }, import_react575.default.createElement(TrapFocus, null, import_react575.default.createElement("div", {
    role: "dialog",
    "aria-modal": true,
    "aria-labelledby": labelledBy,
    tabIndex: -1,
    className: styles76.Dialog
  }, import_react575.default.createElement("div", {
    className: classes
  }, import_react575.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: onClose
  }), children2)))));
}
var fadeUpClasses = {
  appear: classNames(styles76.animateFadeUp, styles76.entering),
  appearActive: classNames(styles76.animateFadeUp, styles76.entered),
  enter: classNames(styles76.animateFadeUp, styles76.entering),
  enterActive: classNames(styles76.animateFadeUp, styles76.entered),
  exit: classNames(styles76.animateFadeUp, styles76.exiting),
  exitActive: classNames(styles76.animateFadeUp, styles76.exited)
};
function FadeUp({
  children: children2,
  ...props
}) {
  return import_react575.default.createElement(CSSTransition_default, Object.assign({}, props, {
    classNames: fadeUpClasses
  }), children2);
}

// node_modules/@shopify/polaris/build/esm/components/Modal/components/Header/Header.js
var import_react577 = __toModule(require_react());
...
var import_react576 = __toModule(require_react());
...
function CloseButton({
  ...
  const i18n = useI18n();
  return import_react576.default.createElement("button", {
    onClick,
    className: styles78.CloseButton,
...
function Header3({
  ...
  return import_react577.default.createElement("div", {
    className: titleHidden || !children2 ? styles77.titleHidden : styles77.Header
  }, import_react577.default.createElement("div", {
    id,
    className: styles77.Title
  }, import_react577.default.createElement(DisplayText, {
    element: "h2",
    size: "small"
  }, children2)), import_react577.default.createElement(CloseButton, {
    onClick: onClose
  }));
}

// node_modules/@shopify/polaris/build/esm/components/Modal/components/Section/Section.js
var import_react578 = __toModule(require_react());
...
function Section5({
  ...
  const className = classNames(styles79.Section, flush && styles79.flush, subdued && styles79.subdued);
  return import_react578.default.createElement("section", {
    className
  }, children2);
}

// node_modules/@shopify/polaris/build/esm/components/Modal/components/Footer/Footer.js
var import_react579 = __toModule(require_react());
...
function Footer({
  ...
  const actions = primaryActionButton || secondaryActionButtons ? import_react579.default.createElement(ButtonGroup, null, secondaryActionButtons, primaryActionButton) : null;
  return import_react579.default.createElement("div", {
    className: styles80.Footer
  }, import_react579.default.createElement("div", {
    className: styles80.FooterContent
  }, import_react579.default.createElement(Stack, {
    alignment: "center"
  }, import_react579.default.createElement(Stack.Item, {
    fill: true
  }, children2), actions)));
}
...
var Modal = function Modal2({
  ...
  const [iframeHeight, setIframeHeight] = (0, import_react580.useState)(IFRAME_LOADING_HEIGHT);
  const headerId = useUniqueId("modal-header");
  const activatorRef = (0, import_react580.useRef)(null);
  const i18n = useI18n();
  const iframeTitle = i18n.translate("Polaris.Modal.iFrameTitle");
  let dialog;
  let backdrop3;
  const handleEntered = (0, import_react580.useCallback)(() => {
    if (onTransitionEnd) {
      onTransitionEnd();
    }
  }, [onTransitionEnd]);
  const handleExited = (0, import_react580.useCallback)(() => {
  ...
  const handleIFrameLoad = (0, import_react580.useCallback)((evt) => {
  ...
  if (open) {
    const footerMarkup = !footer && !primaryAction && !secondaryActions ? null : import_react580.default.createElement(Footer, {
      primaryAction,
      secondaryActions
    }, footer);
    const content = sectioned ? wrapWithComponent(children2, Section5, {}) : children2;
    const body = loading ? import_react580.default.createElement("div", {
      className: styles75.Spinner
    }, import_react580.default.createElement(Spinner, null)) : content;
    const scrollContainerMarkup = noScroll ? import_react580.default.createElement("div", {
      className: styles75.Body
    }, body) : import_react580.default.createElement(Scrollable, {
      shadow: true,
      className: styles75.Body,
      onScrolledToBottom
    }, body);
    const bodyMarkup = src ? import_react580.default.createElement("iframe", {
      name: iFrameName,
      title: iframeTitle,
      src,
    ...
    dialog = import_react580.default.createElement(Dialog, {
      instant,
      labelledBy: headerId,
      onClose,
      ...
      small,
      limitHeight
    }, import_react580.default.createElement(Header3, {
      titleHidden,
      id: headerId,
      onClose
    }, title), import_react580.default.createElement("div", {
      className: styles75.BodyWrapper
    }, bodyMarkup), footerMarkup);
    backdrop3 = import_react580.default.createElement(Backdrop, null);
  }
  const animated = !instant;
  const activatorMarkup = activator && !isRef3(activator) ? import_react580.default.createElement("div", {
    ref: activatorRef
  }, activator) : null;
  return import_react580.default.createElement(WithinContentContext.Provider, {
    value: true
  }, activatorMarkup, import_react580.default.createElement(Portal, {
    idPrefix: "modal"
  }, import_react580.default.createElement(TransitionGroup_default, {
    appear: animated,
    enter: animated,
    exit: animated
  }, dialog), backdrop3));
...
function DiscardConfirmationModal({
  ...
  const i18n = useI18n();
  return import_react581.default.createElement(Modal, {
...
function ContextualSaveBar3({
  ...
  const handleDiscardAction = (0, import_react582.useCallback)(() => {
  ...
  const discardConfirmationModalMarkup = discardAction && discardAction.onAction && discardAction.discardConfirmationModal && import_react582.default.createElement(DiscardConfirmationModal, {
    open: discardConfirmationModalVisible,
    onCancel: toggleDiscardConfirmationModal,
    onDiscard: handleDiscardAction
  });
  const discardActionMarkup = discardAction && import_react582.default.createElement(Button, {
  ...
  const saveActionMarkup = saveAction && import_react582.default.createElement(Button, {
    primary: true,
    url: saveAction.url,
  ...
  const imageMarkup = logo && import_react582.default.createElement(Image, {
    style: {
      width
    },
  ...
  const logoMarkup = alignContentFlush || contextControl ? null : import_react582.default.createElement("div", {
    className: styles74.LogoContainer,
    style: {
      width
    }
  }, imageMarkup);
  const contextControlMarkup = contextControl ? import_react582.default.createElement("div", {
    className: styles74.ContextControl
  }, contextControl) : null;
  const contentsClassName = classNames(styles74.Contents, fullWidth && styles74.fullWidth);
  return import_react582.default.createElement(import_react582.default.Fragment, null, import_react582.default.createElement(CustomProperties, {
    colorScheme: "dark"
  }, import_react582.default.createElement("div", {
    className: styles74.ContextualSaveBar
  }, contextControlMarkup, logoMarkup, import_react582.default.createElement("div", {
    className: contentsClassName
  }, import_react582.default.createElement("h2", {
    className: styles74.Message
  }, message), import_react582.default.createElement("div", {
    className: styles74.ActionContainer
  }, import_react582.default.createElement(Stack, {
    spacing: "tight",
    wrap: false
...
var import_react587 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/utilities/use-deep-effect.js
var import_react584 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/utilities/use-deep-compare-ref.js
var import_react583 = __toModule(require_react());
var import_isEqual2 = __toModule(require_isEqual());
function useDeepCompareRef(dependencies, comparator = import_isEqual2.default) {
  const dependencyList = (0, import_react583.useRef)(dependencies);
...
function useDeepEffect(callback, dependencies, customCompare) {
  (0, import_react584.useEffect)(callback, useDeepCompareRef(dependencies, customCompare));
}

// node_modules/@shopify/polaris/build/esm/utilities/use-deep-callback.js
var import_react585 = __toModule(require_react());
function useDeepCallback(callback, dependencies, customCompare) {
  return (0, import_react585.useCallback)(callback, useDeepCompareRef(dependencies, customCompare));
}
...
var import_react586 = __toModule(require_react());
...
function Toast({
  ...
  const dismissMarkup = import_react586.default.createElement("button", {
    type: "button",
    className: styles82.CloseButton,
    onClick: onDismiss
  }, import_react586.default.createElement(Icon, {
    source: SvgMobileCancelMajor
  }));
  const actionMarkup = action ? import_react586.default.createElement("div", {
    className: styles82.Action
  }, import_react586.default.createElement(Button, {
    plain: true,
    monochrome: true,
    onClick: action.onAction
  }, action.content)) : null;
  const className = classNames(styles82.Toast, error && styles82.error);
  return import_react586.default.createElement(CustomProperties, {
    colorScheme: "dark"
  }, import_react586.default.createElement("div", {
    className
  }, import_react586.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: onDismiss
...
// node_modules/@shopify/polaris/build/esm/components/Frame/components/ToastManager/ToastManager.js
var ToastManager = (0, import_react587.memo)(function ToastManager2({
  toastMessages
}) {
  const toastNodes = [];
  ...
  const toastsMarkup = toastMessages.map((toast, index) => {
    const toastNode = (0, import_react587.createRef)();
    toastNodes[index] = toastNode;
    return import_react587.default.createElement(CSSTransition_default, {
    ...
    }, import_react587.default.createElement("div", {
      ref: toastNode
    }, import_react587.default.createElement(Toast, toast)));
  });
  return import_react587.default.createElement(Portal, null, import_react587.default.createElement(EventListener, {
    event: "resize",
    handler: updateToasts
  }), import_react587.default.createElement("div", {
    className: styles81.ToastManager,
    "aria-live": "assertive"
  }, import_react587.default.createElement(TransitionGroup_default, {
    component: null
  }, toastsMarkup)));
});
var toastClasses = {
...
var FrameInner = class extends import_react588.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      skipFocused: false,
    ...
    this.navigationNode = (0, import_react588.createRef)();
  ...
  render() {
    ...
    const navigationMarkup = navigation ? import_react588.default.createElement(TrapFocus, {
      trapping: mobileNavShowing
    }, import_react588.default.createElement(CSSTransition_default, {
    ...
    }, import_react588.default.createElement("div", Object.assign({
      key: "NavContent"
    }, mobileNavAttributes, {
    ...
    }), navigation, import_react588.default.createElement("button", {
      type: "button",
      ...
      tabIndex
    }, import_react588.default.createElement(Icon, {
      source: SvgMobileCancelMajor
    }))))) : null;
    const loadingMarkup = loadingStack > 0 ? import_react588.default.createElement("div", {
      className: styles71.LoadingBar,
      id: APP_FRAME_LOADING_BAR
    }, import_react588.default.createElement(Loading2, null)) : null;
    const contextualSaveBarMarkup = import_react588.default.createElement(CSSAnimation, {
      in: showContextualSaveBar,
      className: styles71.ContextualSaveBar,
      type: "fade"
    }, import_react588.default.createElement(ContextualSaveBar3, this.contextualSaveBar));
    const topBarMarkup = topBar ? import_react588.default.createElement("div", Object.assign({
      className: styles71.TopBar
    }, layer.props, dataPolarisTopBar.props, {
      id: APP_FRAME_TOP_BAR
    }), topBar) : null;
    const globalRibbonMarkup = globalRibbon ? import_react588.default.createElement("div", {
    ...
    const skipMarkup = import_react588.default.createElement("div", {
      className: skipClassName
    }, import_react588.default.createElement("a", {
      href: `#${skipTarget}`,
    ...
    const frameClassName = classNames(styles71.Frame, navigation && styles71.hasNav, topBar && styles71.hasTopBar);
    const navigationOverlayMarkup = showMobileNavigation && isNavigationCollapsed ? import_react588.default.createElement(Backdrop, {
    ...
    return import_react588.default.createElement(FrameContext.Provider, {
      value: context
    }, import_react588.default.createElement("div", Object.assign({
      className: frameClassName
    }, layer.props, navigationAttributes), skipMarkup, topBarMarkup, navigationMarkup, contextualSaveBarMarkup, loadingMarkup, navigationOverlayMarkup, import_react588.default.createElement("main", {
      className: styles71.Main,
      id: APP_FRAME_MAIN,
      "data-has-global-ribbon": Boolean(globalRibbon)
    }, import_react588.default.createElement("div", {
      className: styles71.Content
    }, children2)), import_react588.default.createElement(ToastManager, {
      toastMessages
    }), globalRibbonMarkup, import_react588.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    })));
  }
...
function Frame(props) {
  const i18n = useI18n();
  const mediaQuery = useMediaQuery();
  return import_react588.default.createElement(FrameInner, Object.assign({}, props, {
    i18n,
    mediaQuery
  }));
}
...
var import_react600 = __toModule(require_react());
var import_debounce12 = __toModule(require_debounce());
...
var import_react591 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/utilities/index-provider/hooks.js
var import_react590 = __toModule(require_react());
...
var import_react589 = __toModule(require_react());
var IndexContext = (0, import_react589.createContext)(void 0);
var IndexSelectionChangeContext = (0, import_react589.createContext)(void 0);
var IndexRowContext = (0, import_react589.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/index-provider/hooks.js
function useIndexSelectionChange() {
  const onSelectionChange = (0, import_react590.useContext)(IndexSelectionChangeContext);
...
function useIndexRow() {
  const indexRow = (0, import_react590.useContext)(IndexRowContext);
  if (!indexRow) {
    throw new Error(`Missing IndexProvider context`);
  }
  return indexRow;
...
function useIndexValue() {
  const index = (0, import_react590.useContext)(IndexContext);
  if (!index) {
    throw new Error(`Missing IndexProvider context`);
  }
  return index;
...
function useHandleBulkSelection({
  ...
  const lastSelected = (0, import_react590.useRef)(null);
  const handleSelectionChange = (0, import_react590.useCallback)((selectionType, toggleType, selection, sortOrder) => {
...
function IndexProvider({
  ...
  const contextValue = (0, import_react591.useMemo)(() => ({
    itemCount,
  ...
  const rowContextValue = (0, import_react591.useMemo)(() => ({
    selectable: isSelectableIndex,
    selectMode: selectMode && isSelectableIndex,
    condensed
  }), [condensed, selectMode, isSelectableIndex]);
  return import_react591.default.createElement(IndexContext.Provider, {
    value: contextValue
  }, import_react591.default.createElement(IndexRowContext.Provider, {
    value: rowContextValue
  }, import_react591.default.createElement(IndexSelectionChangeContext.Provider, {
    value: handleSelectionChange
  }, children2)));
}

// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/Cell/Cell.js
var import_react592 = __toModule(require_react());
var Cell2 = (0, import_react592.memo)(function Cell3({
  children: children2,
  flush
}) {
  const cellClassName = classNames(styles83.TableCell, flush && styles83["TableCell-flush"]);
  return import_react592.default.createElement("td", {
    className: cellClassName
  }, children2);
});

// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/Row/Row.js
var import_react595 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/Checkbox/Checkbox.js
var import_react594 = __toModule(require_react());
...
var import_react593 = __toModule(require_react());
var RowContext = (0, import_react593.createContext)({});
var RowHoveredContext = (0, import_react593.createContext)(void 0);
var scrollDefaultContext = {
  scrollableContainer: null,
  canScrollLeft: false,
  canScrollRight: false
};
var ScrollContext = (0, import_react593.createContext)(scrollDefaultContext);

// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/Checkbox/Checkbox.js
var Checkbox3 = (0, import_react594.memo)(function Checkbox4() {
  const i18n = useI18n();
  const {
    resourceName,
    condensed
  ...
  const {
    ...
    selected,
    onInteraction
  } = (0, import_react594.useContext)(RowContext);
  const wrapperClassName = classNames(styles84.Wrapper, condensed ? styles84.condensed : styles84.expanded);
  const Wrapper = condensed ? import_react594.Fragment : CheckboxWrapper;
  return import_react594.default.createElement(Wrapper, null, import_react594.default.createElement("div", {
    className: styles84.TableCellContentContainer
  }, import_react594.default.createElement("div", {
    className: wrapperClassName,
    onClick: onInteraction,
    onKeyUp: noop9
  }, import_react594.default.createElement(Checkbox, {
    id: itemId,
...
function CheckboxWrapper({
  ...
  const checkboxNode = (0, import_react594.useRef)(null);
  const handleResize = (0, import_react594.useCallback)(() => {
  ...
  const checkboxClassName = classNames(styles83.TableCell, styles83["TableCell-first"]);
  return import_react594.default.createElement("td", {
...
// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/Row/Row.js
var Row = (0, import_react595.memo)(function Row2({
  children: children2,
  selected,
  id,
  position,
  ...
  const handleInteraction = (0, import_react595.useCallback)((event) => {
    event.stopPropagation();
  ...
  const contextValue = (0, import_react595.useMemo)(() => ({
    itemId: id,
    selected,
    onInteraction: handleInteraction
  }), [id, selected, handleInteraction]);
  const primaryLinkElement = (0, import_react595.useRef)(null);
  const isNavigating = (0, import_react595.useRef)(false);
  const tableRowRef = (0, import_react595.useRef)(null);
  const tableRowCallbackRef = (0, import_react595.useCallback)((node) => {
  ...
  const rowClassName = classNames(styles83.TableRow, selectable && condensed && styles83.condensedRow, selected && styles83["TableRow-selected"], subdued && styles83["TableRow-subdued"], hovered && styles83["TableRow-hovered"], status && styles83[variationName("status", status)], !selectable && !primaryLinkElement.current && styles83["TableRow-unclickable"]);
  let handleRowClick;
  ...
  const checkboxMarkup = selectable ? import_react595.default.createElement(Checkbox3, null) : null;
  return import_react595.default.createElement(RowContext.Provider, {
    value: contextValue
  }, import_react595.default.createElement(RowHoveredContext.Provider, {
    value: hovered
  }, import_react595.default.createElement(RowWrapper, {
    key: id,
...
var import_react596 = __toModule(require_react());
function AfterInitialMount({
  ...
  return import_react596.default.createElement(import_react596.default.Fragment, null, content);
}

// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/ScrollContainer/ScrollContainer.js
var import_react597 = __toModule(require_react());
var import_debounce11 = __toModule(require_debounce());
...
function ScrollContainer({
  ...
  (0, import_react597.useEffect)(() => {
    if (!scrollableContainerRef.current)
      return;
    scrollableContainerRef.current.dispatchEvent(new Event("scroll"));
  }, [scrollableContainerRef]);
  const [containerScroll, setContainerScroll] = (0, import_react597.useState)(scrollDefaultContext);
  const handleScroll = (0, import_react597.useCallback)((0, import_debounce11.default)(() => {
    if (!scrollableContainerRef.current) {
      return;
    }
  ...
  return import_react597.default.createElement(ScrollContext.Provider, {
    value: containerScroll
  }, import_react597.default.createElement("div", {
...
var import_react599 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/utilities/sticky-manager/hooks.js
var import_react598 = __toModule(require_react());
function useStickyManager() {
  const stickyManager = (0, import_react598.useContext)(StickyManagerContext);
  if (!stickyManager) {
...
// node_modules/@shopify/polaris/build/esm/components/Sticky/Sticky.js
var StickyInner = class extends import_react599.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      isSticky: false,
  ...
  render() {
    ...
    return import_react599.default.createElement("div", null, import_react599.default.createElement("div", {
      ref: this.setPlaceHolderNode
    }), import_react599.default.createElement("div", {
...
function Sticky(props) {
  ...
  return import_react599.default.createElement(StickyInner, Object.assign({}, props, {
    stickyManager
  }));
}
...
function IndexTableBase({
  ...
  const tablePosition = (0, import_react600.useRef)({
    top: 0,
    left: 0
  });
  const tableHeadingRects = (0, import_react600.useRef)([]);
  const scrollableContainerElement = (0, import_react600.useRef)(null);
  const tableElement = (0, import_react600.useRef)(null);
  const condensedListElement = (0, import_react600.useRef)(null);
  const [tableInitialized, setTableInitialized] = (0, import_react600.useState)(false);
  const [isSmallScreenSelectable, setIsSmallScreenSelectable] = (0, import_react600.useState)(false);
  const [stickyWrapper, setStickyWrapper] = (0, import_react600.useState)(null);
  const tableHeadings = (0, import_react600.useRef)([]);
  const stickyTableHeadings = (0, import_react600.useRef)([]);
  const stickyHeaderWrapperElement = (0, import_react600.useRef)(null);
  const firstStickyHeaderElement = (0, import_react600.useRef)(null);
  const stickyHeaderElement = (0, import_react600.useRef)(null);
  const scrollBarElement = (0, import_react600.useRef)(null);
  const scrollingWithBar = (0, import_react600.useRef)(false);
  const scrollingContainer = (0, import_react600.useRef)(false);
  const tableBodyRef = (0, import_react600.useCallback)((node) => {
    if (node !== null && !tableInitialized) {
      setTableInitialized(true);
    }
  }, [tableInitialized]);
  const toggleIsSmallScreenSelectable = (0, import_react600.useCallback)(() => {
    setIsSmallScreenSelectable((value) => !value);
  }, []);
  const handleSelectAllItemsInStore = (0, import_react600.useCallback)(() => {
  ...
  const calculateFirstHeaderOffset = (0, import_react600.useCallback)(() => {
    if (!selectable) {
  ...
  const resizeTableHeadings = (0, import_react600.useMemo)(() => (0, import_debounce12.default)(() => {
  ...
  const resizeTableScrollBar = (0, import_react600.useCallback)(() => {
  ...
  const debounceResizeTableScrollbar = (0, import_react600.useCallback)((0, import_debounce12.default)(resizeTableScrollBar, SCROLL_BAR_DEBOUNCE_PERIOD, {
    trailing: true
  }), [resizeTableScrollBar]);
  const [canScrollRight, setCanScrollRight] = (0, import_react600.useState)(true);
  const handleCanScrollRight = (0, import_react600.useCallback)(() => {
  ...
  const handleResize = (0, import_react600.useCallback)(() => {
  ...
  const handleScrollContainerScroll = (0, import_react600.useCallback)((canScrollLeft, canScrollRight2) => {
  ...
  const handleScrollBarScroll = (0, import_react600.useCallback)(() => {
    if (!scrollableContainerElement.current || !scrollBarElement.current) {
      return;
    }
  ...
  const stickyColumnHeader = import_react600.default.createElement("div", {
    className: styles83.TableHeading,
    key: headings[0].title,
    style: stickyColumnHeaderStyle,
    "data-index-table-sticky-heading": true
  }, import_react600.default.createElement(Stack, {
    spacing: "none",
    wrap: false,
    alignment: "center"
  }, selectable && import_react600.default.createElement("div", {
    className: styles83.FirstStickyHeaderElement,
    ref: firstStickyHeaderElement
  }, renderCheckboxContent()), selectable && import_react600.default.createElement("div", {
    className: styles83["StickyTableHeading-second-scrolling"]
  }, renderHeadingContent(headings[0])), !selectable && import_react600.default.createElement("div", {
    className: styles83.FirstStickyHeaderElement,
    ref: firstStickyHeaderElement
  }, renderHeadingContent(headings[0]))));
  const stickyHeadingsMarkup = headings.map(renderStickyHeading);
  const selectedItemsCountLabel = selectedItemsCount === SELECT_ALL_ITEMS ? `${itemCount}+` : selectedItemsCount;
  const handleTogglePage = (0, import_react600.useCallback)(() => {
  ...
  const loadingTransitionClassNames = {
    enter: styles83["LoadingContainer-enter"],
    enterActive: styles83["LoadingContainer-enter-active"],
    exit: styles83["LoadingContainer-exit"],
    exitActive: styles83["LoadingContainer-exit-active"]
  };
  const loadingMarkup = import_react600.default.createElement(CSSTransition_default, {
    in: loading,
    ...
    className: styles83.LoadingPanel
  }, import_react600.default.createElement("div", {
    className: styles83.LoadingPanelRow
  }, import_react600.default.createElement(Spinner, {
    size: "small"
  }), import_react600.default.createElement("span", {
    className: styles83.LoadingPanelText
  }, i18n.translate("Polaris.IndexTable.resourceLoadingAccessibilityLabel", {
    resourceNamePlural: resourceName.plural.toLocaleLowerCase()
  })))));
  const stickyTableClassNames = classNames(styles83.StickyTable, condensed && styles83["StickyTable-condensed"]);
  const shouldShowBulkActions = bulkActionsSelectable && selectedItemsCount || isSmallScreenSelectable;
  const stickyHeaderMarkup = import_react600.default.createElement("div", {
    className: stickyTableClassNames,
    role: "presentation"
  }, import_react600.default.createElement(Sticky, {
    boundingElement: stickyWrapper
  }, (isSticky) => {
    const stickyHeaderClassNames = classNames(styles83.StickyTableHeader, isSticky && styles83["StickyTableHeader-isSticky"]);
    const bulkActionClassNames = classNames(styles83.BulkActionsWrapper, condensed && styles83["StickyTableHeader-condensed"], isSticky && styles83["StickyTableHeader-isSticky"]);
    const shouldShowActions = !condensed || selectedItemsCount;
    const promotedActions = shouldShowActions ? promotedBulkActions : [];
    const actions = shouldShowActions ? bulkActions : [];
    const bulkActionsMarkup = shouldShowBulkActions ? import_react600.default.createElement("div", {
      className: bulkActionClassNames,
      "data-condensed": condensed
    }, loadingMarkup, import_react600.default.createElement(BulkActions, {
    ...
    const stickyColumnHeaderClassNames = classNames(styles83.StickyTableColumnHeader, hasMoreLeftColumns && styles83["StickyTableColumnHeader-isScrolling"]);
    const selectButtonMarkup = import_react600.default.createElement(Button, {
      icon: SvgEnableSelectionMinor,
      onClick: toggleIsSmallScreenSelectable
    }, i18n.translate("Polaris.IndexTable.selectButtonText"));
    const headerMarkup = condensed ? import_react600.default.createElement("div", {
      className: classNames(styles83.HeaderWrapper, !selectable && styles83.unselectable)
    }, loadingMarkup, sort, selectable && selectButtonMarkup) : import_react600.default.createElement("div", {
      className: stickyHeaderClassNames,
      ref: stickyHeaderWrapperElement
    }, loadingMarkup, import_react600.default.createElement("div", {
      className: stickyColumnHeaderClassNames
    }, stickyColumnHeader), import_react600.default.createElement("div", {
      className: styles83.StickyTableHeadings,
      ref: stickyHeaderElement
    }, stickyHeadingsMarkup));
    const stickyContent = bulkActionsMarkup ? bulkActionsMarkup : headerMarkup;
    return stickyContent;
  }));
  const scrollBarWrapperClassNames = classNames(styles83.ScrollBarContainer, condensed && styles83.scrollBarContainerCondensed);
  const scrollBarClassNames = classNames(tableElement.current && tableInitialized && styles83.ScrollBarContent);
  const scrollBarMarkup = itemCount > 0 ? import_react600.default.createElement(AfterInitialMount, null, import_react600.default.createElement("div", {
    className: scrollBarWrapperClassNames
  }, import_react600.default.createElement("div", {
    onScroll: handleScrollBarScroll,
    className: styles83.ScrollBar,
    ref: scrollBarElement
  }, import_react600.default.createElement("div", {
    className: scrollBarClassNames
  })))) : null;
  const tableClassNames = classNames(styles83.Table, hasMoreLeftColumns && styles83["Table-scrolling"], selectMode && styles83.disableTextSelection, selectMode && shouldShowBulkActions && styles83.selectMode, !selectable && styles83["Table-unselectable"], lastColumnSticky && styles83["Table-sticky-last"], lastColumnSticky && canScrollRight && styles83["Table-sticky-scrolling"]);
  const emptyStateMarkup = emptyState ? emptyState : import_react600.default.createElement(EmptySearchResult, {
  ...
  const sharedMarkup = import_react600.default.createElement(import_react600.default.Fragment, null, import_react600.default.createElement(EventListener, {
    event: "resize",
    handler: handleResize
  }), import_react600.default.createElement(AfterInitialMount, null, stickyHeaderMarkup));
  const bodyMarkup = condensed ? import_react600.default.createElement(import_react600.default.Fragment, null, sharedMarkup, import_react600.default.createElement("ul", {
    "data-selectmode": Boolean(selectMode || isSmallScreenSelectable),
    className: styles83.CondensedList,
    ref: condensedListElement
  }, children2)) : import_react600.default.createElement(import_react600.default.Fragment, null, sharedMarkup, import_react600.default.createElement(ScrollContainer, {
    scrollableContainerRef: scrollableContainerElement,
    onScroll: handleScrollContainerScroll
  }, import_react600.default.createElement("table", {
    ref: tableElement,
    className: tableClassNames
  }, import_react600.default.createElement("thead", null, import_react600.default.createElement("tr", {
    className: styles83.HeadingRow
  }, headingsMarkup)), import_react600.default.createElement("tbody", {
    ref: tableBodyRef
  }, children2))));
  const tableContentMarkup = itemCount > 0 ? bodyMarkup : import_react600.default.createElement("div", {
    className: styles83.EmptySearchResultWrapper
  }, emptyStateMarkup);
  return import_react600.default.createElement(import_react600.default.Fragment, null, import_react600.default.createElement("div", {
    className: styles83.IndexTable
  ...
  function renderHeading(heading, index) {
    ...
    const headingContentClassName = classNames(styles83.TableHeading, isSecond && styles83["TableHeading-second"], isLast && !heading.hidden && styles83["TableHeading-last"], !selectable && styles83["TableHeading-unselectable"]);
    ...
    const headingContent = import_react600.default.createElement("th", {
    ...
    const checkboxClassName = classNames(styles83.TableHeading, index === 0 && styles83["TableHeading-first"]);
    const checkboxContent = import_react600.default.createElement("th", {
      className: checkboxClassName,
      key: `${heading}-${index}`,
      "data-index-table-heading": true
  ...
  function renderCheckboxContent() {
    return import_react600.default.createElement("div", {
      className: styles83.ColumnHeaderCheckboxWrapper
    }, import_react600.default.createElement(Checkbox, {
  ...
  function renderHeadingContent(heading) {
    let headingContent;
    if (heading.new) {
      headingContent = import_react600.default.createElement(Stack, {
        wrap: false,
        alignment: "center"
      }, import_react600.default.createElement("span", null, heading.title), import_react600.default.createElement(Badge, {
        status: "new"
      }, i18n.translate("Polaris.IndexTable.onboardingBadgeText")));
    } else if (heading.hidden) {
      headingContent = import_react600.default.createElement(VisuallyHidden, null, heading.title);
    } else {
  ...
  function renderStickyHeading(heading, index) {
    ...
    const stickyHeadingClassName = classNames(styles83.TableHeading, index === 0 && styles83["StickyTableHeading-second"], index === 0 && !selectable && styles83.unselectable);
    return import_react600.default.createElement("div", {
...
function IndexTable({
  ...
  return import_react600.default.createElement(IndexProvider, {
    selectable,
    itemCount,
    selectedItemsCount,
    resourceName: passedResourceName,
    ...
    condensed,
    onSelectionChange
  }, import_react600.default.createElement(IndexTableBase, indexTableBaseProps, children2));
}
IndexTable.Cell = Cell2;
IndexTable.Row = Row;

// node_modules/@shopify/polaris/build/esm/components/KeyboardKey/KeyboardKey.js
var import_react601 = __toModule(require_react());
...
function KeyboardKey({
  ...
  return import_react601.default.createElement("kbd", {
    className: styles86.KeyboardKey
  }, key);
}

// node_modules/@shopify/polaris/build/esm/components/KonamiCode/KonamiCode.js
var import_react602 = __toModule(require_react());
...
function KonamiCode({
  ...
  const [position, setPosition] = (0, import_react602.useState)(0);
...
var import_react605 = __toModule(require_react());
...
var import_react603 = __toModule(require_react());
function AnnotatedSection(props) {
  ...
  const descriptionMarkup = typeof description === "string" ? import_react603.default.createElement("p", null, description) : description;
  return import_react603.default.createElement("div", {
    className: styles87.AnnotatedSection
  }, import_react603.default.createElement("div", {
    className: styles87.AnnotationWrapper
  }, import_react603.default.createElement("div", {
    className: styles87.Annotation
  }, import_react603.default.createElement(TextContainer, null, import_react603.default.createElement(Heading, {
    id
  }, title), descriptionMarkup && import_react603.default.createElement("div", {
    className: styles87.AnnotationDescription
  }, descriptionMarkup))), import_react603.default.createElement("div", {
    className: styles87.AnnotationContent
  }, children2)));
}

// node_modules/@shopify/polaris/build/esm/components/Layout/components/Section/Section.js
var import_react604 = __toModule(require_react());
function Section6({
  children: children2,
  secondary,
  fullWidth,
  ...
  const className = classNames(styles87.Section, secondary && styles87["Section-secondary"], fullWidth && styles87["Section-fullWidth"], oneHalf && styles87["Section-oneHalf"], oneThird && styles87["Section-oneThird"]);
  return import_react604.default.createElement("div", {
    className
  }, children2);
}
...
var Layout = function Layout2({
  ...
  const content = sectioned ? import_react605.default.createElement(Section6, null, children2) : children2;
  return import_react605.default.createElement("div", {
    className: styles87.Layout
  }, content);
};
...
var import_react606 = __toModule(require_react());
...
function Link({
  ...
  const i18n = useI18n();
  let childrenMarkup = children2;
  if (external && typeof children2 === "string") {
    const iconLabel = i18n.translate("Polaris.Common.newWindowAccessibilityHint");
    childrenMarkup = import_react606.default.createElement(import_react606.default.Fragment, null, children2, import_react606.default.createElement("span", {
      className: styles88.IconLockup
    }, import_react606.default.createElement("span", {
      className: styles88.IconLayout
    }, import_react606.default.createElement(Icon, {
      accessibilityLabel: iconLabel,
      source: SvgExternalSmallMinor
    }))));
  }
  return import_react606.default.createElement(BannerContext.Consumer, null, (BannerContext2) => {
    const shouldBeMonochrome = monochrome || BannerContext2;
    const className = classNames(styles88.Link, shouldBeMonochrome && styles88.monochrome, removeUnderline && styles88.removeUnderline);
    return url ? import_react606.default.createElement(UnstyledLink, {
      onClick,
      className,
      url,
      external,
      id,
      "aria-label": accessibilityLabel
    }, childrenMarkup) : import_react606.default.createElement("button", {
      type: "button",
      onClick,
      className,
      id,
...
var import_react608 = __toModule(require_react());
...
var import_react607 = __toModule(require_react());
function Item7({
  children: children2
}) {
  return import_react607.default.createElement("li", {
    className: styles89.Item
  }, children2);
}
...
var List = function List2({
  ...
  const className = classNames(styles89.List, type && styles89[variationName("type", type)]);
  const ListElement = type === "bullet" ? "ul" : "ol";
  return import_react608.default.createElement(ListElement, {
    className
  }, children2);
};
List.Item = Item7;
...
var import_react609 = __toModule(require_react());
var Loading3 = (0, import_react609.memo)(function Loading4() {
  const {
    startLoading,
    stopLoading
  } = useFrame();
...
var import_react610 = __toModule(require_react());
...
function MediaCard({
  ...
  if (title) {
    const headerContent = typeof title === "string" ? import_react610.default.createElement(Heading, null, title) : title;
    headerMarkup = import_react610.default.createElement("div", {
      className: styles90.Heading
    }, headerContent);
  }
  const popoverActivator = import_react610.default.createElement(Button, {
    icon: SvgHorizontalDotsMinor,
  ...
  const popoverActionsMarkup = popoverActions.length > 0 ? import_react610.default.createElement("div", {
    className: styles90.Popover
  }, import_react610.default.createElement(Popover2, {
    active: popoverActive,
    activator: popoverActivator,
    onClose: togglePopoverActive,
    preferredAlignment: "left",
    preferredPosition: "below"
  }, import_react610.default.createElement(ActionList, {
    items: popoverActions,
    onActionAnyItem: togglePopoverActive
  }))) : null;
  const primaryActionMarkup = primaryAction ? import_react610.default.createElement("div", {
    className: styles90.PrimaryAction
  }, buttonFrom(primaryAction)) : null;
  const secondaryActionMarkup = secondaryAction ? import_react610.default.createElement("div", {
    className: styles90.SecondaryAction
  }, buttonFrom(secondaryAction, {
    plain: true
  })) : null;
  const actionClassName = classNames(styles90.ActionContainer, portrait && styles90.portrait);
  const actionMarkup = primaryActionMarkup || secondaryActionMarkup ? import_react610.default.createElement("div", {
    className: actionClassName
  }, import_react610.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup)) : null;
  const mediaCardClassName = classNames(styles90.MediaCard, portrait && styles90.portrait);
  const mediaContainerClassName = classNames(styles90.MediaContainer, portrait && styles90.portrait, size === "small" && styles90.sizeSmall);
  const infoContainerClassName = classNames(styles90.InfoContainer, portrait && styles90.portrait, size === "small" && styles90.sizeSmall);
  return import_react610.default.createElement(Card, null, import_react610.default.createElement("div", {
    className: mediaCardClassName
  }, import_react610.default.createElement("div", {
    className: mediaContainerClassName
  }, children2), import_react610.default.createElement("div", {
    className: infoContainerClassName
  }, import_react610.default.createElement(Card.Section, null, popoverActionsMarkup, import_react610.default.createElement(Stack, {
    vertical: true,
    spacing: "tight"
  }, headerMarkup, import_react610.default.createElement("p", {
...
var import_react615 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/components/Navigation/context.js
var import_react611 = __toModule(require_react());
var NavigationContext = (0, import_react611.createContext)({
  location: ""
});
...
function Secondary({
  ...
  return import_react612.default.createElement(Collapsible, {
    id: id || uid,
    open: expanded,
    transition: {
      duration: "0ms",
...
function Item8({
  ...
  const {
    location,
    onNavigationDismiss
  } = (0, import_react613.useContext)(NavigationContext);
  const [keyFocused, setKeyFocused] = (0, import_react613.useState)(false);
  (0, import_react613.useEffect)(() => {
  ...
  const handleKeyUp = (0, import_react613.useCallback)((event) => {
    if (event.keyCode === Key.Tab) {
      !keyFocused && setKeyFocused(true);
    }
  }, [keyFocused]);
  const handleBlur = (0, import_react613.useCallback)(() => {
  ...
  const indicatorMarkup = hasNewChild ? import_react613.default.createElement("span", {
    className: styles91.Indicator
  }, import_react613.default.createElement(Indicator, {
    pulse: true
  })) : null;
  const iconMarkup = icon3 ? import_react613.default.createElement("div", {
    className: classNames(styles91.Icon, shouldResizeIcon && styles91["Icon-resized"])
  }, import_react613.default.createElement(Icon, {
    source: icon3
  })) : null;
  const externalIconLabel = i18n.translate("Polaris.Common.newWindowAccessibilityHint");
  const externalLinkIconMarkup = external ? import_react613.default.createElement("div", {
    className: styles91.ExternalIcon
  }, import_react613.default.createElement(Icon, {
    accessibilityLabel: externalIconLabel,
    source: SvgExternalMinor,
    color: "base"
  })) : null;
  let badgeMarkup = null;
  if (isNew) {
    badgeMarkup = import_react613.default.createElement(Badge, {
      status: "new",
      size: "small"
  ...
  const wrappedBadgeMarkup = badgeMarkup == null ? null : import_react613.default.createElement("div", {
    className: styles91.Badge
  }, badgeMarkup);
  const itemContentMarkup = import_react613.default.createElement(import_react613.default.Fragment, null, iconMarkup, import_react613.default.createElement("span", {
    className: styles91.Text
  }, label, indicatorMarkup), wrappedBadgeMarkup);
  if (url == null) {
    const className2 = classNames(styles91.Item, disabled && styles91["Item-disabled"], keyFocused && styles91.keyFocused, selectedOverride && styles91["Item-selected"]);
    return import_react613.default.createElement("li", {
      className: styles91.ListItem
    }, import_react613.default.createElement("button", {
      type: "button",
  ...
  const secondaryActionMarkup = secondaryAction && import_react613.default.createElement(UnstyledLink, {
    external: true,
    url: secondaryAction.url,
    className: styles91.SecondaryAction,
    tabIndex,
    "aria-disabled": disabled,
  ...
  const itemClassName = classNames(styles91.Item, disabled && styles91["Item-disabled"], selected && canBeActive && styles91["Item-selected"], showExpanded && styles91.subNavigationActive, childIsActive && styles91["Item-child-active"], keyFocused && styles91.keyFocused);
  ...
  if (subNavigationItems.length > 0) {
    ...
    const SecondaryNavigationClassName = classNames(styles91.SecondaryNavigation, showExpanded && styles91.isExpanded, !icon3 && styles91["SecondaryNavigation-noIcon"]);
    secondaryNavigationMarkup = import_react613.default.createElement("div", {
      className: SecondaryNavigationClassName
    }, import_react613.default.createElement(Secondary, {
      ...
      return import_react613.default.createElement(Item8, Object.assign({
        key: label2
      }, rest, {
        label: label2,
  ...
  const className = classNames(styles91.ListItem, secondaryAction && styles91["ListItem-hasAction"]);
  return import_react613.default.createElement("li", {
    className
  }, import_react613.default.createElement("div", {
    className: styles91.ItemWrapper
  }, import_react613.default.createElement(UnstyledLink, Object.assign({
    url,
...
function Section7({
  ...
  const animationFrame = (0, import_react614.useRef)(null);
  const {
    isNavigationCollapsed
  } = useMediaQuery();
  const [expandedIndex, setExpandedIndex] = (0, import_react614.useState)();
  ...
  (0, import_react614.useEffect)(() => {
    return () => {
      animationFrame.current && cancelAnimationFrame(animationFrame.current);
    };
  });
  const className = classNames(styles91.Section, separator && styles91["Section-withSeparator"], fill && styles91["Section-fill"]);
  const actionMarkup = action && import_react614.default.createElement("button", {
    type: "button",
    className: styles91.Action,
    "aria-label": action.accessibilityLabel,
    onClick: action.onClick
  }, import_react614.default.createElement(Icon, {
    source: action.icon
  }));
  const sectionHeadingMarkup = title && import_react614.default.createElement("li", {
    className: styles91.SectionHeading
  }, import_react614.default.createElement("span", {
    className: styles91.Text
  }, title), actionMarkup);
  const itemsMarkup = items.map((item, index) => {
    ...
    return import_react614.default.createElement(Item8, Object.assign({
      key: label
    }, rest, {
      label,
      subNavigationItems,
  ...
  const toggleClassName = classNames(styles91.Item, styles91.RollupToggle);
  const ariaLabel = rollup && (expanded ? rollup.hide : rollup.view);
  const toggleRollup = rollup && items.length > rollup.after && import_react614.default.createElement("div", {
    className: styles91.ListItem,
    key: "List Item"
  }, import_react614.default.createElement("button", {
    type: "button",
    className: toggleClassName,
    onClick: toggleExpanded,
    "aria-label": ariaLabel
  }, import_react614.default.createElement("span", {
    className: styles91.Icon
  }, import_react614.default.createElement(Icon, {
  ...
  const activeItemsMarkup = rollup && additionalItems.length > 0 && import_react614.default.createElement("li", {
    className: styles91.RollupSection
  }, import_react614.default.createElement(Collapsible, {
    id: additionalItemsId,
    open: expanded
  }, import_react614.default.createElement("ul", {
    className: styles91.List
  }, additionalItems)), toggleRollup);
  return import_react614.default.createElement("ul", {
    className
...
var Navigation2 = function Navigation3({
  ...
  const width = getWidth(logo, 104);
  const logoMarkup = logo ? import_react615.default.createElement("div", {
    className: styles91.LogoContainer
  }, import_react615.default.createElement(UnstyledLink, {
    url: logo.url || "",
    className: styles91.LogoLink,
    style: {
      width
    }
  }, import_react615.default.createElement(Image, {
    source: logo.topBarSource || "",
    alt: logo.accessibilityLabel || "",
    className: styles91.Logo,
    style: {
      width
    }
  }))) : null;
  const mediaMarkup = contextControl ? import_react615.default.createElement("div", {
    className: styles91.ContextControl
  }, contextControl) : logoMarkup;
  const context = (0, import_react615.useMemo)(() => ({
    location,
    onNavigationDismiss: onDismiss
  }), [location, onDismiss]);
  return import_react615.default.createElement(NavigationContext.Provider, {
    value: context
  }, import_react615.default.createElement(WithinContentContext.Provider, {
    value: true
  }, import_react615.default.createElement("nav", {
    className: styles91.Navigation,
    "aria-labelledby": ariaLabelledBy
  }, mediaMarkup, import_react615.default.createElement(Scrollable, {
    className: styles91.PrimaryNavigation
  }, children2))));
};
...
var import_react618 = __toModule(require_react());
...
var import_react617 = __toModule(require_react());
...
var import_react616 = __toModule(require_react());
...
function Checkbox5({
  ...
  const id = useUniqueId("Checkbox", idProp);
  const [keyFocused, setKeyFocused] = (0, import_react616.useState)(false);
  const className = classNames(styles94.Checkbox, active && styles94.active);
  const handleBlur = () => {
    setKeyFocused(false);
  };
  const handleKeyUp = () => {
  ...
  const inputClassName = classNames(styles94.Input, keyFocused && styles94.keyFocused);
  return import_react616.default.createElement("div", {
    className
  }, import_react616.default.createElement("input", {
    id,
    name,
    value,
    type: "checkbox",
    ...
    onKeyUp: handleKeyUp,
    role
  }), import_react616.default.createElement("div", {
    className: styles94.Backdrop
  }), import_react616.default.createElement("div", {
    className: styles94.Icon
  }, import_react616.default.createElement(Icon, {
...
function Option3({
  ...
  const handleClick = (0, import_react617.useCallback)(() => {
    if (disabled) {
      return;
    }
    onClick(section, index);
  }, [disabled, index, onClick, section]);
  const mediaMarkup = media ? import_react617.default.createElement("div", {
    className: styles93.Media
  }, media) : null;
  const singleSelectClassName = classNames(styles93.SingleSelectOption, focused3 && styles93.focused, disabled && styles93.disabled, select && styles93.select, active && styles93.active, verticalAlign && styles93[variationName("verticalAlign", verticalAlign)]);
  const multiSelectClassName = classNames(styles93.Label, disabled && styles93.disabled, active && styles93.active, select && styles93.select, verticalAlign && styles93[variationName("verticalAlign", verticalAlign)]);
  const checkBoxRole = role === "option" ? "presentation" : void 0;
  const optionMarkup = allowMultiple ? import_react617.default.createElement("label", {
    htmlFor: id,
    className: multiSelectClassName
  }, import_react617.default.createElement("div", {
    className: styles93.Checkbox
  }, import_react617.default.createElement(Checkbox5, {
    id,
    value,
    checked: select,
    active,
    ...
    role: checkBoxRole
  })), mediaMarkup, label) : import_react617.default.createElement("button", {
    id,
    type: "button",
  ...
  const scrollMarkup = active ? import_react617.default.createElement(Scrollable.ScrollTo, null) : null;
  return import_react617.default.createElement("li", {
    key: id,
    className: styles93.Option,
    tabIndex: -1
...
function OptionList({
  ...
  const [normalizedOptions, setNormalizedOptions] = (0, import_react618.useState)(createNormalizedOptions(options, sections, title));
  ...
  const handleClick = (0, import_react618.useCallback)((sectionIndex, optionIndex) => {
  ...
  const optionsMarkup = optionsExist ? normalizedOptions.map(({
    ...
    const titleMarkup = title2 ? import_react618.default.createElement("p", {
      className: styles92.Title
    }, title2) : null;
    const optionsMarkup2 = options2 && options2.map((option, optionIndex) => {
      ...
      return import_react618.default.createElement(Option3, Object.assign({
        key: optionId
      }, option, {
        id: optionId,
    ...
    return import_react618.default.createElement("li", {
      key: title2 || `noTitle-${sectionIndex}`
    }, titleMarkup, import_react618.default.createElement("ul", {
      className: styles92.Options,
      id: `${id}-${sectionIndex}`,
      role
    }, optionsMarkup2));
  }) : null;
  return import_react618.default.createElement("ul", {
    className: styles92.OptionList,
    role
  }, optionsMarkup);
}
...
var import_react624 = __toModule(require_react());
...
var import_react623 = __toModule(require_react());
...
var import_react621 = __toModule(require_react());
...
function TooltipOverlay({
  ...
  const i18n = useI18n();
  const markup = active ? import_react619.default.createElement(PositionedOverlay, {
    active,
    activator,
    preferredPosition,
    preventInteraction,
  ...
  function renderTooltip(overlayDetails) {
    ...
    const containerClassName = classNames(styles97.TooltipOverlay, measuring && styles97.measuring, positioning === "above" && styles97.positionedAbove);
    const contentStyles = measuring ? void 0 : {
      minHeight: desiredHeight
    };
    return import_react619.default.createElement("div", Object.assign({
      className: containerClassName
    }, layer.props), import_react619.default.createElement("div", {
      id,
      role: "tooltip",
      className: styles97.Content,
      style: contentStyles,
...
function Tooltip({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react620.useState)(null);
  const id = useUniqueId("TooltipContent");
  const activatorContainer = (0, import_react620.useRef)(null);
  const mouseEntered = (0, import_react620.useRef)(false);
  ...
  const handleKeyUp = (0, import_react620.useCallback)((event) => {
    if (event.keyCode !== Key.Escape)
      return;
    handleBlur();
  }, [handleBlur]);
  const portal2 = activatorNode ? import_react620.default.createElement(Portal, {
    idPrefix: "tooltip"
  }, import_react620.default.createElement(TooltipOverlay, {
    id,
    preferredPosition,
    activator: activatorNode,
    active,
  ...
  return import_react620.default.createElement(WrapperComponent, {
    onFocus: handleFocus,
    onBlur: handleBlur,
...
function Pagination({
  ...
  const i18n = useI18n();
  const node = (0, import_react621.createRef)();
  ...
  const prev = import_react621.default.createElement(Button, {
    outline: true,
    icon: SvgChevronLeftMinor,
  ...
  const constructedPrevious = previousTooltip && hasPrevious ? import_react621.default.createElement(Tooltip, {
    activatorWrapper: "span",
    content: previousTooltip
  }, prev) : prev;
  const next = import_react621.default.createElement(Button, {
    outline: true,
    icon: SvgChevronRightMinor,
  ...
  const constructedNext = nextTooltip && hasNext ? import_react621.default.createElement(Tooltip, {
    activatorWrapper: "span",
    content: nextTooltip
  }, next) : next;
  const previousHandler = onPrevious || noop11;
  const previousButtonEvents = previousKeys && (previousURL || onPrevious) && hasPrevious && previousKeys.map((key) => import_react621.default.createElement(KeypressListener, {
    key,
    keyCode: key,
    handler: previousURL ? handleCallback(clickPaginationLink("previousURL", node)) : handleCallback(previousHandler)
  }));
  const nextHandler = onNext || noop11;
  const nextButtonEvents = nextKeys && (nextURL || onNext) && hasNext && nextKeys.map((key) => import_react621.default.createElement(KeypressListener, {
    key,
    keyCode: key,
    handler: nextURL ? handleCallback(clickPaginationLink("nextURL", node)) : handleCallback(nextHandler)
  }));
  const labelTextMarkup = hasNext && hasPrevious ? import_react621.default.createElement(TextStyle, null, label) : import_react621.default.createElement(TextStyle, {
    variation: "subdued"
  }, label);
  const labelMarkup = label ? import_react621.default.createElement("div", {
    "aria-live": "polite"
  }, labelTextMarkup) : null;
  return import_react621.default.createElement("nav", {
    "aria-label": navLabel,
    ref: node
  }, previousButtonEvents, nextButtonEvents, import_react621.default.createElement(ButtonGroup, {
    segmented: !label
...
var import_react622 = __toModule(require_react());
...
function Title({
  ...
  const className = classNames(styles98.Title, subtitle && styles98.TitleWithSubtitle);
  const titleMarkup = title ? import_react622.default.createElement("h1", {
    className
  }, title) : null;
  const titleMetadataMarkup = titleMetadata ? import_react622.default.createElement("div", {
    className: styles98.TitleMetadata
  }, titleMetadata) : null;
  const wrappedTitleMarkup = titleMetadata ? import_react622.default.createElement("div", {
    className: styles98.TitleWithMetadataWrapper
  }, titleMarkup, titleMetadataMarkup) : titleMarkup;
  const subtitleMarkup = subtitle ? import_react622.default.createElement("div", {
    className: classNames(styles98.SubTitle, compactTitle && styles98.SubtitleCompact)
  }, import_react622.default.createElement("p", null, subtitle)) : null;
  return import_react622.default.createElement(import_react622.default.Fragment, null, wrappedTitleMarkup, subtitleMarkup);
}

// node_modules/@shopify/polaris/build/esm/components/Page/components/Header/Header.js
function isPrimaryAction(x) {
  return !(0, import_react623.isValidElement)(x) && x !== void 0;
}
var SHORT_TITLE = 20;
...
function Header4({
  ...
  const breadcrumbMarkup = breadcrumbs.length > 0 ? import_react623.default.createElement("div", {
    className: styles96.BreadcrumbWrapper
  }, import_react623.default.createElement(Breadcrumbs, {
    breadcrumbs
  })) : null;
  const paginationMarkup = pagination && !isNavigationCollapsed ? import_react623.default.createElement("div", {
    className: styles96.PaginationWrapper
  }, import_react623.default.createElement(Pagination, pagination)) : null;
  const additionalNavigationMarkup = additionalNavigation ? import_react623.default.createElement("div", {
    className: styles96.AdditionalNavigationWrapper
  }, additionalNavigation) : null;
  const navigationMarkup = breadcrumbMarkup || paginationMarkup || additionalNavigationMarkup ? import_react623.default.createElement("div", {
    className: styles96.Navigation
  }, breadcrumbMarkup, additionalNavigationMarkup, paginationMarkup) : null;
  const pageTitleMarkup = import_react623.default.createElement("div", {
    className: styles96.TitleWrapper
  }, import_react623.default.createElement(Title, {
    title,
    subtitle,
    titleMetadata,
    compactTitle
  }));
  const primaryActionMarkup = primaryAction ? import_react623.default.createElement(PrimaryActionMarkup, {
    primaryAction
  }) : null;
  const actionMenuMarkup = secondaryActions.length > 0 || hasGroupsWithActions(actionGroups) ? import_react623.default.createElement(ActionMenu, {
  ...
  const additionalMetadataMarkup = additionalMetadata ? import_react623.default.createElement("div", {
    className: styles96.AdditionalMetaData
  }, import_react623.default.createElement(TextStyle, {
    variation: "subdued"
  }, additionalMetadata)) : null;
  const headerClassNames = classNames(styles96.Header, isSingleRow && styles96.isSingleRow, titleHidden && styles96.titleHidden, navigationMarkup && styles96.hasNavigation, actionMenuMarkup && styles96.hasActionMenu, isNavigationCollapsed && styles96.mobileView, !breadcrumbs.length && styles96.noBreadcrumbs, title && title.length < LONG_TITLE && styles96.mediumTitle, title && title.length > LONG_TITLE && styles96.longTitle);
  const {
    slot1,
    slot2,
    slot3,
  ...
  return import_react623.default.createElement("div", {
    className: headerClassNames
  }, import_react623.default.createElement(ConditionalRender, {
    condition: [slot1, slot2, slot3, slot4].some(notNull)
  }, import_react623.default.createElement("div", {
    className: styles96.Row
  }, slot1, slot2, import_react623.default.createElement(ConditionalRender, {
    condition: [slot3, slot4].some(notNull)
  }, import_react623.default.createElement("div", {
    className: styles96.RightAlign
  }, import_react623.default.createElement(ConditionalWrapper, {
    condition: [slot3, slot4].every(notNull),
    wrapper: (children2) => import_react623.default.createElement("div", {
      className: styles96.Actions
    }, children2)
  }, slot3, slot4))))), import_react623.default.createElement(ConditionalRender, {
    condition: [slot5, slot6].some(notNull)
  }, import_react623.default.createElement("div", {
    className: styles96.Row
  }, import_react623.default.createElement("div", {
    className: styles96.LeftAlign
  }, slot5), import_react623.default.createElement(ConditionalRender, {
...
function PrimaryActionMarkup({
  ...
  return import_react623.default.createElement("div", {
    className: styles96.PrimaryActionWrapper
  }, content);
}
  ...
  const layouts = {
    ...
    desktopDefault: {
      slots: {
        slot1: breadcrumbMarkup,
        slot2: pageTitleMarkup,
        slot3: import_react623.default.createElement(import_react623.default.Fragment, null, actionMenuMarkup, primaryActionMarkup),
...
function Page({
  ...
  const pageClassName = classNames(styles95.Page, fullWidth && styles95.fullWidth, narrowWidth && styles95.narrowWidth);
  ...
  const contentClassName = classNames(!hasHeaderContent && styles95.Content, divider3 && hasHeaderContent && styles95.divider);
  const headerMarkup = hasHeaderContent ? import_react624.default.createElement(Header4, rest) : null;
  return import_react624.default.createElement("div", {
    className: pageClassName
  }, headerMarkup, import_react624.default.createElement("div", {
    className: contentClassName
  }, children2));
}

// node_modules/@shopify/polaris/build/esm/components/PageActions/PageActions.js
var import_react625 = __toModule(require_react());
...
function PageActions({
  ...
  const secondaryActionsMarkup = secondaryActions ? import_react625.default.createElement(ButtonGroup, null, buttonsFrom(secondaryActions)) : null;
  const distribution = secondaryActionsMarkup ? "equalSpacing" : "trailing";
  return import_react625.default.createElement("div", {
    className: styles99.PageActions
  }, import_react625.default.createElement(Stack, {
    distribution,
    spacing: "tight"
...
var import_react626 = __toModule(require_react());
...
function PolarisTestProvider({
  ...
  const Wrapper = strict ? import_react626.StrictMode : import_react626.Fragment;
  const intl = (0, import_react626.useMemo)(() => new I18n(i18n || {}), [i18n]);
  const scrollLockManager = (0, import_react626.useMemo)(() => new ScrollLockManager(), []);
  const stickyManager = (0, import_react626.useMemo)(() => new StickyManager(), []);
  const uniqueIdFactory = (0, import_react626.useMemo)(() => new UniqueIdFactory(globalIdGeneratorFactory), []);
  const mergedFrame = createFrameContext(frame);
  const mergedMediaQuery = merge(defaultMediaQuery, mediaQuery);
  return import_react626.default.createElement(Wrapper, null, import_react626.default.createElement(FeaturesContext.Provider, {
    value: features
  }, import_react626.default.createElement(I18nContext.Provider, {
    value: intl
  }, import_react626.default.createElement(ScrollLockManagerContext.Provider, {
    value: scrollLockManager
  }, import_react626.default.createElement(StickyManagerContext.Provider, {
    value: stickyManager
  }, import_react626.default.createElement(UniqueIdFactoryContext.Provider, {
    value: uniqueIdFactory
  }, import_react626.default.createElement(LinkContext.Provider, {
    value: link
  }, import_react626.default.createElement(CustomProperties, {
    colorScheme
  }, import_react626.default.createElement(MediaQueryContext.Provider, {
    value: mergedMediaQuery
  }, import_react626.default.createElement(PortalsManager, null, import_react626.default.createElement(FocusManager, null, import_react626.default.createElement(FrameContext.Provider, {
    value: mergedFrame
  }, children2))))))))))));
}
function noop12() {
...
var import_react627 = __toModule(require_react());
...
function ProgressBar({
  ...
  const i18n = useI18n();
  const className = classNames(styles100.ProgressBar, size && styles100[variationName("size", size)], color && styles100[variationName("color", color)]);
  ...
  return import_react627.default.createElement("div", {
    className
  }, import_react627.default.createElement("progress", {
    className: styles100.Progress,
    value: parsedProgress,
    max: "100"
  }), import_react627.default.createElement("div", {
    className: classNames(styles100.Indicator, animated && styles100.Animated),
    style: {
      width: `${parsedProgress}%`
    }
  }, import_react627.default.createElement("span", {
    className: styles100.Label
  }, parsedProgress, "%")));
}
...
var import_react630 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/components/RangeSlider/components/DualThumb/DualThumb.js
var import_react628 = __toModule(require_react());
var import_debounce13 = __toModule(require_debounce());
...
var DualThumb = class extends import_react628.Component {
  constructor(...args) {
    super(...args);
    this.context = void 0;
    this.state = {
    ...
    this.track = (0, import_react628.createRef)();
    this.trackWrapper = (0, import_react628.createRef)();
    this.thumbLower = (0, import_react628.createRef)();
    this.thumbUpper = (0, import_react628.createRef)();
    this.setTrackPosition = (0, import_debounce13.default)(() => {
    ...
    this.setValue = (dirtyValue, control) => {
      ...
      if ((0, import_isEqual3.default)(sanitizedValue, value) === false) {
        this.setState({
  ...
  static getDerivedStateFromProps(props, state) {
    ...
    if ((0, import_isEqual3.default)(prevValue, value)) {
      return null;
    }
    const sanitizedValue = sanitizeValue(value, min, max, step);
    if (!(0, import_isEqual3.default)(value, sanitizedValue)) {
  ...
  render() {
    ...
    const ariaDescribedBy = describedBy.length ? describedBy.join(" ") : void 0;
    const trackWrapperClassName = classNames(styles101.TrackWrapper, error && styles101.error, disabled && styles101.disabled);
    const thumbLowerClassName = classNames(styles101.Thumbs, styles101.ThumbLower, disabled && styles101.disabled);
    const thumbUpperClassName = classNames(styles101.Thumbs, styles101.ThumbUpper, disabled && styles101.disabled);
    ...
    const outputLowerClassName = classNames(styles101.Output, styles101.OutputLower);
    const outputMarkupLower = !disabled && output ? import_react628.default.createElement("output", {
      htmlFor: idLower,
      ...
      className: styles101.OutputBubble
    }, import_react628.default.createElement("span", {
      className: styles101.OutputText
    }, value[0]))) : null;
    const outputUpperClassName = classNames(styles101.Output, styles101.OutputUpper);
    const outputMarkupUpper = !disabled && output ? import_react628.default.createElement("output", {
      htmlFor: idUpper,
    ...
    const prefixMarkup = prefix && import_react628.default.createElement("div", {
      className: styles101.Prefix
    }, prefix);
    const suffixMarkup = suffix && import_react628.default.createElement("div", {
      className: styles101.Suffix
    }, suffix);
    return import_react628.default.createElement(import_react628.default.Fragment, null, import_react628.default.createElement(Labelled, {
      id,
      label,
      error,
      action: labelAction,
      ...
      className: classNames(styles101.DualThumb, sharedStyles.RangeSlider)
    }, prefixMarkup, import_react628.default.createElement("div", {
      className: trackWrapperClassName,
      onMouseDown: this.handleMouseDownTrack,
      ref: this.trackWrapper
    }, import_react628.default.createElement("div", {
      className: styles101.Track,
      style: cssVars,
      ref: this.track
    }), import_react628.default.createElement("div", {
      className: styles101["Track--dashed"]
    }), import_react628.default.createElement("div", {
      id: idLower,
      ...
      ref: this.thumbLower
    }), outputMarkupLower, import_react628.default.createElement("div", {
      id: idUpper,
      ...
      ref: this.thumbUpper
    }), outputMarkupUpper), suffixMarkup)), import_react628.default.createElement(EventListener, {
      event: "resize",
...
var import_react629 = __toModule(require_react());
...
function SingleThumb(props) {
  ...
  const outputMarkup = !disabled && output && import_react629.default.createElement("output", {
    htmlFor: id,
    className: styles102.Output
  }, import_react629.default.createElement("div", {
    className: styles102.OutputBubble
  }, import_react629.default.createElement("span", {
    className: styles102.OutputText
  }, clampedValue)));
  const prefixMarkup = prefix && import_react629.default.createElement("div", {
    className: styles102.Prefix
  }, prefix);
  const suffixMarkup = suffix && import_react629.default.createElement("div", {
    className: styles102.Suffix
  }, suffix);
  const className = classNames(styles102.SingleThumb, sharedStyles.RangeSlider, error && styles102.error, disabled && styles102.disabled);
  return import_react629.default.createElement(Labelled, {
    id,
    label,
    error,
    action: labelAction,
    ...
    className,
    style: cssVars
  }, prefixMarkup, import_react629.default.createElement("div", {
    className: styles102.InputWrapper
  }, import_react629.default.createElement("input", {
    type: "range",
    className: styles102.Input,
    id,
    name: id,
    min,
    max,
...
function RangeSlider({
  ...
  return isDualThumb(value) ? import_react630.default.createElement(DualThumb, Object.assign({
    value
  }, sharedProps)) : import_react630.default.createElement(SingleThumb, Object.assign({
    value
  }, sharedProps));
}
...
var import_react631 = __toModule(require_react());
...
var BaseResourceItem = class extends import_react631.Component {
  constructor(...args) {
    super(...args);
    this.state = {
    ...
    this.buttonOverlay = (0, import_react631.createRef)();
    this.setNode = (node) => {
      this.node = node;
    };
  ...
  shouldComponentUpdate(nextProps, nextState) {
    ...
    return !(0, import_isEqual4.default)(this.state, nextState) || this.props.context.selectMode !== nextSelectMode || !nextProps.context.selectMode && (!(0, import_isEqual4.default)(restProps, restNextProps) || !(0, import_isEqual4.default)(restContext, restNextContext));
  }
  render() {
    const {
      children: children2,
    ...
    if (media || selectable) {
      ownedMarkup = import_react631.default.createElement("div", {
        className: classNames(styles103.Owned, !mediaMarkup && styles103.OwnedNoMedia)
      }, handleMarkup, mediaMarkup);
    }
    const className = classNames(styles103.ResourceItem, focused3 && styles103.focused, selectable && styles103.selectable, selected && styles103.selected, selectMode && styles103.selectMode, persistActions && styles103.persistActions, focusedInner && styles103.focusedInner);
    const listItemClassName = classNames(styles103.ListItem, focused3 && !focusedInner && styles103.focused);
    let actionsMarkup = null;
    let disclosureMarkup = null;
    if (shortcutActions && !loading) {
      if (persistActions) {
        actionsMarkup = import_react631.default.createElement("div", {
          className: styles103.Actions,
          onClick: stopPropagation3
        }, import_react631.default.createElement(ButtonGroup, null, buttonsFrom(shortcutActions, {
          plain: true
        })));
        const disclosureAccessibilityLabel = name ? i18n.translate("Polaris.ResourceList.Item.actionsDropdownLabel", {
          accessibilityLabel: name
        }) : i18n.translate("Polaris.ResourceList.Item.actionsDropdown");
        disclosureMarkup = import_react631.default.createElement("div", {
          className: styles103.Disclosure,
          onClick: stopPropagation3
        }, import_react631.default.createElement(Popover2, {
          activator: import_react631.default.createElement(Button, {
        ...
        }, import_react631.default.createElement(ActionList, {
        ...
        actionsMarkup = import_react631.default.createElement("div", {
          className: styles103.Actions,
          onClick: stopPropagation3
        }, import_react631.default.createElement(ButtonGroup, {
          segmented: true
    ...
    const content = children2 ? import_react631.default.createElement("div", {
      className: styles103.Content
    }, children2) : null;
    const containerClassName = classNames(styles103.Container, verticalAlignment && styles103[variationName("alignment", verticalAlignment)]);
    const containerMarkup = import_react631.default.createElement("div", {
      className: containerClassName,
      id: this.props.id
    ...
    const accessibleMarkup = url ? import_react631.default.createElement(UnstyledLink, {
      "aria-describedby": this.props.id,
      "aria-label": ariaLabel,
      className: styles103.Link,
      url,
      external,
      tabIndex,
      id: this.overlayId
    }) : import_react631.default.createElement("button", {
      className: styles103.Button,
      "aria-label": ariaLabel,
      "aria-controls": ariaControls,
      "aria-expanded": ariaExpanded,
      onClick: this.handleClick,
    ...
    return import_react631.default.createElement("li", {
...
function stopPropagation3(event) {
  event.stopPropagation();
}
...
function ResourceItem(props) {
  return import_react631.default.createElement(BaseResourceItem, Object.assign({}, props, {
    context: (0, import_react631.useContext)(ResourceListContext),
    i18n: useI18n()
  }));
}

// node_modules/@shopify/polaris/build/esm/components/ResourceList/ResourceList.js
var import_react634 = __toModule(require_react());
var import_debounce14 = __toModule(require_debounce());

// node_modules/@shopify/polaris/build/esm/utilities/use-lazy-ref.js
var import_react632 = __toModule(require_react());
var UNIQUE_IDENTIFIER = Symbol("unique_identifier");
function useLazyRef(initialValue) {
  const lazyRef = (0, import_react632.useRef)(UNIQUE_IDENTIFIER);
...
var import_react633 = __toModule(require_react());
...
function Select({
  ...
  const className = classNames(styles105.Select, error && styles105.error, disabled && styles105.disabled);
  ...
  const inlineLabelMarkup = labelInline && import_react633.default.createElement("span", {
    className: styles105.InlineLabel
  }, label);
  const selectedOption = getSelectedOption(normalizedOptions, value);
  const prefixMarkup = selectedOption.prefix && import_react633.default.createElement("div", {
    className: styles105.Prefix
  }, selectedOption.prefix);
  const contentMarkup = import_react633.default.createElement("div", {
    className: styles105.Content,
    "aria-hidden": true,
    "aria-disabled": disabled
  }, inlineLabelMarkup, prefixMarkup, import_react633.default.createElement("span", {
    className: styles105.SelectedOption
  }, selectedOption.label), import_react633.default.createElement("span", {
    className: styles105.Icon
  }, import_react633.default.createElement(Icon, {
    source: SvgSelectMinor
  })));
  const optionsMarkup = normalizedOptions.map(renderOption);
  return import_react633.default.createElement(Labelled, {
    id,
    label,
    error,
    action: labelAction,
    ...
    className
  }, import_react633.default.createElement("select", {
    id,
    name,
    value,
    className: styles105.Input,
    disabled,
    onFocus,
    onBlur,
    onChange: handleChange,
    ...
    "aria-describedby": describedBy.length ? describedBy.join(" ") : void 0,
    "aria-required": requiredIndicator
  }, optionsMarkup), contentMarkup, import_react633.default.createElement("div", {
    className: styles105.Backdrop
  })));
}
...
function renderSingleOption(option) {
  ...
  return import_react633.default.createElement("option", Object.assign({
    key: value,
    value
  }, rest), label);
}
function renderOption(optionOrGroup) {
  if (isGroup(optionOrGroup)) {
    ...
    return import_react633.default.createElement("optgroup", {
      label: title,
      key: title
...
var isSmallScreen2 = () => {
  return typeof window === "undefined" ? false : window.innerWidth < SMALL_SCREEN_WIDTH2;
};
...
var ResourceList = function ResourceList2({
  ...
  const i18n = useI18n();
  const [selectMode, setSelectMode] = (0, import_react634.useState)(Boolean(selectedItems && selectedItems.length > 0));
  const [loadingPosition, setLoadingPositionState] = (0, import_react634.useState)(0);
  const [lastSelected, setLastSelected] = (0, import_react634.useState)();
  const [smallScreen, setSmallScreen] = (0, import_react634.useState)(isSmallScreen2());
  const forceUpdate = (0, import_react634.useReducer)((x = 0) => x + 1, 0)[1];
  const [checkableButtons, setCheckableButtons] = (0, import_react634.useState)(new Map());
  const defaultResourceName = useLazyRef(() => ({
    singular: i18n.translate("Polaris.ResourceList.defaultItemSingular"),
    plural: i18n.translate("Polaris.ResourceList.defaultItemPlural")
  }));
  const listRef = (0, import_react634.useRef)(null);
  ...
  const handleResize = (0, import_debounce14.default)(() => {
    const newSmallScreen = isSmallScreen2();
  ...
  const setLoadingPosition = (0, import_react634.useCallback)(() => {
    if (listRef.current != null) {
      if (typeof window === "undefined") {
        return;
      }
      const overlay4 = listRef.current.getBoundingClientRect();
      const viewportHeight = Math.max(document.documentElement ? document.documentElement.clientHeight : 0, window.innerHeight || 0);
      const overflow = viewportHeight - overlay4.height;
      const spinnerHeight = items.length === 1 ? SMALL_SPINNER_HEIGHT : LARGE_SPINNER_HEIGHT;
      const spinnerPosition = overflow > 0 ? (overlay4.height - spinnerHeight) / 2 : (viewportHeight - overlay4.top - spinnerHeight) / 2;
      setLoadingPositionState(spinnerPosition);
    }
  }, [listRef, items.length]);
  const itemsExist = items.length > 0;
  (0, import_react634.useEffect)(() => {
    if (loading) {
      setLoadingPosition();
    }
  ...
  (0, import_react634.useEffect)(() => {
    ...
    if ((!selectedItems || selectedItems.length === 0) && !isSmallScreen2()) {
      setSelectMode(false);
    }
  ...
  const handleSelectionChange = (selected, id, sortOrder, shiftKey) => {
    ...
    if (newlySelectedItems.length === 0 && !isSmallScreen2()) {
      handleSelectMode(false);
  ...
  const bulkActionsMarkup = isSelectable ? import_react634.default.createElement("div", {
    className: styles104.BulkActionsWrapper
  }, import_react634.default.createElement(BulkActions, {
  ...
  const filterControlMarkup = filterControl ? import_react634.default.createElement("div", {
    className: styles104.FiltersWrapper
  }, filterControl) : null;
  const sortingSelectMarkup = sortOptions && sortOptions.length > 0 && !alternateTool ? import_react634.default.createElement("div", {
    className: styles104.SortWrapper
  }, import_react634.default.createElement(Select, {
  ...
  const alternateToolMarkup = alternateTool && !sortingSelectMarkup ? import_react634.default.createElement("div", {
    className: styles104.AlternateToolWrapper
  }, alternateTool) : null;
  const headerTitleMarkup = import_react634.default.createElement("div", {
    className: styles104.HeaderTitleWrapper
  }, headerTitle());
  const selectButtonMarkup = isSelectable ? import_react634.default.createElement("div", {
    className: styles104.SelectButtonWrapper
  }, import_react634.default.createElement(Button, {
    disabled: selectMode,
    icon: SvgEnableSelectionMinor,
    onClick: () => handleSelectMode(true)
  }, i18n.translate("Polaris.ResourceList.selectButtonText"))) : null;
  const checkableButtonMarkup = isSelectable ? import_react634.default.createElement("div", {
    className: styles104.CheckableButtonWrapper
  }, import_react634.default.createElement(CheckableButton, {
    accessibilityLabel: bulkActionsAccessibilityLabel(),
    label: headerTitle(),
    onToggleAll: handleToggleAll,
    plain: true,
  ...
  const headerWrapperOverlay = loading ? import_react634.default.createElement("div", {
    className: styles104["HeaderWrapper-overlay"]
  }) : null;
  ...
  const headerMarkup = !showEmptyState && showHeader !== false && !showEmptySearchState && (showHeader || needsHeader) && listRef.current && import_react634.default.createElement("div", {
    className: styles104.HeaderOuterWrapper
  }, import_react634.default.createElement(Sticky, {
    boundingElement: listRef.current
  }, (isSticky) => {
    const headerClassName = classNames(styles104.HeaderWrapper, sortOptions && sortOptions.length > 0 && !alternateTool && styles104["HeaderWrapper-hasSort"], alternateTool && styles104["HeaderWrapper-hasAlternateTool"], isSelectable && styles104["HeaderWrapper-hasSelect"], loading && styles104["HeaderWrapper-disabled"], isSelectable && selectMode && styles104["HeaderWrapper-inSelectMode"], isSticky && styles104["HeaderWrapper-isSticky"]);
    return import_react634.default.createElement("div", {
      className: headerClassName
    }, import_react634.default.createElement(EventListener, {
      event: "resize",
      handler: handleResize
    }), headerWrapperOverlay, import_react634.default.createElement("div", {
      className: styles104.HeaderContentWrapper
    }, headerTitleMarkup, checkableButtonMarkup, alternateToolMarkup, sortingSelectMarkup, selectButtonMarkup), bulkActionsMarkup);
  }));
  const emptySearchStateMarkup = showEmptySearchState ? emptySearchState || import_react634.default.createElement("div", {
    className: styles104.EmptySearchResultWrapper
  }, import_react634.default.createElement(EmptySearchResult, Object.assign({}, emptySearchResultText, {
    withIllustration: true
  }))) : null;
  ...
  const loadingOverlay = loading ? import_react634.default.createElement(import_react634.default.Fragment, null, import_react634.default.createElement("li", {
    className: styles104.SpinnerContainer,
    style: spinnerStyle
  }, import_react634.default.createElement(Spinner, {
    size: spinnerSize,
    accessibilityLabel: "Items are loading"
  })), import_react634.default.createElement("li", {
    className: styles104.LoadingOverlay
  })) : null;
  const className = classNames(styles104.ItemWrapper, loading && styles104["ItemWrapper-isLoading"]);
  const loadingWithoutItemsMarkup = loading && !itemsExist ? import_react634.default.createElement("div", {
    className,
    tabIndex: -1
  }, loadingOverlay) : null;
  const resourceListClassName = classNames(styles104.ResourceList, loading && styles104.disabledPointerEvents, selectMode && styles104.disableTextSelection);
  const listMarkup = itemsExist ? import_react634.default.createElement("ul", {
    className: resourceListClassName,
    ref: listRef,
    "aria-live": "polite",
    "aria-busy": loading
  }, loadingOverlay, import_react634.Children.toArray(items.map(renderItemWithId))) : null;
  const context = {
  ...
  return import_react634.default.createElement(ResourceListContext.Provider, {
    value: context
  }, import_react634.default.createElement("div", {
    className: styles104.ResourceListWrapper
...
var import_react635 = __toModule(require_react());
function SettingToggle({
  ...
  return import_react635.default.createElement(Card, {
    sectioned: true
  }, import_react635.default.createElement(SettingAction, {
    action: actionMarkup
  }, children2));
}

// node_modules/@shopify/polaris/build/esm/components/SkeletonBodyText/SkeletonBodyText.js
var import_react636 = __toModule(require_react());
...
function SkeletonBodyText({
  ...
  for (let i = 0; i < lines; i++) {
    bodyTextLines.push(import_react636.default.createElement("div", {
      className: styles106.SkeletonBodyText,
      key: i
    }));
  }
  return import_react636.default.createElement(import_react636.default.Fragment, null, bodyTextLines);
}

// node_modules/@shopify/polaris/build/esm/components/SkeletonDisplayText/SkeletonDisplayText.js
var import_react637 = __toModule(require_react());
...
function SkeletonDisplayText({
  ...
  const className = classNames(styles107.DisplayText, size && styles107[variationName("size", size)]);
...
var import_react638 = __toModule(require_react());
...
function SkeletonPage({
  ...
  const i18n = useI18n();
  const className = classNames(styles108.Page, fullWidth && styles108.fullWidth, narrowWidth && styles108.narrowWidth);
  const titleContent = title ? import_react638.default.createElement("h1", {
    className: styles108.Title
  }, title) : import_react638.default.createElement("div", {
    className: styles108.SkeletonTitle
  });
  const titleMarkup = import_react638.default.createElement("div", {
    className: styles108.TitleWrapper
  }, titleContent);
  const primaryActionMarkup = primaryAction ? import_react638.default.createElement("div", {
    className: styles108.PrimaryAction
  }, import_react638.default.createElement(SkeletonDisplayText, {
    size: "large"
  })) : null;
  const breadcrumbMarkup = breadcrumbs ? import_react638.default.createElement("div", {
    className: styles108.BreadcrumbAction,
    style: {
      width: 60
    }
  }, import_react638.default.createElement(SkeletonBodyText, {
    lines: 1
  })) : null;
  return import_react638.default.createElement("div", {
    className,
    role: "status",
    "aria-label": i18n.translate("Polaris.SkeletonPage.loadingLabel")
  }, import_react638.default.createElement("div", {
    className: styles108.Header
  }, breadcrumbMarkup, import_react638.default.createElement("div", {
    className: styles108.TitleAndPrimaryAction
  }, titleMarkup, primaryActionMarkup)), import_react638.default.createElement("div", {
    className: styles108.Content
  }, children2));
}

// node_modules/@shopify/polaris/build/esm/components/SkeletonTabs/SkeletonTabs.js
var import_react639 = __toModule(require_react());
...
function SkeletonTabs({
  ...
  return import_react639.default.createElement("div", {
    className: styles109.Tabs
  }, [...Array(count).keys()].map((key) => {
    const tabWidthClassName = key % 2 === 0 ? styles109["Tab-short"] : styles109["Tab-long"];
    return import_react639.default.createElement("div", {
      key,
      className: classNames(styles109.Tab, tabWidthClassName)
    }, import_react639.default.createElement(SkeletonBodyText, {
      lines: 1
    }));
  }));
}
...
var import_react640 = __toModule(require_react());
...
function SkeletonThumbnail({
  ...
  const className = classNames(styles110.SkeletonThumbnail, size && styles110[variationName("size", size)]);
...
var import_react646 = __toModule(require_react());
...
var import_react641 = __toModule(require_react());
function Panel({
  hidden,
  id,
  tabID,
  ...
  const className = classNames(styles111.Panel, hidden && styles111["Panel-hidden"]);
...
var import_react643 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/components/Tabs/components/Tab/Tab.js
var import_react642 = __toModule(require_react());
function Tab({
  id,
  focused: focused3,
  siblingTabHasFocus,
  ...
  const wasSelected = (0, import_react642.useRef)(selected);
  const panelFocused = (0, import_react642.useRef)(false);
  const node = (0, import_react642.useRef)(null);
  (0, import_react642.useEffect)(() => {
    if (measuring) {
      return;
    }
    const itemHadFocus = focused3 || document.activeElement && document.activeElement.id === id;
    ...
    if (selected && !wasSelected.current && panelID != null) {
      focusPanelID(panelID);
    } else if (focused3 && node.current != null) {
      focusFirstFocusableNode(node.current);
    }
    wasSelected.current = selected;
  }, [focused3, id, measuring, panelID, selected]);
  const handleClick = onClick && onClick.bind(null, id);
  const className = classNames(styles111.Tab, selected && styles111["Tab-selected"]);
  let tabIndex;
  if (selected && !siblingTabHasFocus && !measuring) {
    tabIndex = 0;
  } else if (focused3 && !measuring) {
    tabIndex = 0;
  } else {
    tabIndex = -1;
  }
  const tabContainerClassNames = classNames(styles111.TabContainer, selected && styles111.Underline);
  const markup = url ? import_react642.default.createElement(UnstyledLink, {
    id,
    url,
    role: "tab",
    tabIndex,
    ...
    "aria-label": accessibilityLabel,
    onMouseUp: handleMouseUpByBlurring
  }, import_react642.default.createElement("span", {
    className: styles111.Title
  }, children2)) : import_react642.default.createElement("button", {
    id,
    role: "tab",
    type: "button",
    tabIndex,
  ...
  return import_react642.default.createElement("li", {
...
// node_modules/@shopify/polaris/build/esm/components/Tabs/components/TabMeasurer/TabMeasurer.js
var TabMeasurer = (0, import_react643.memo)(function TabMeasurer2({
  selected,
  tabs,
  activator,
  tabToFocus,
  ...
  const containerNode = (0, import_react643.useRef)(null);
  const animationFrame = (0, import_react643.useRef)(null);
  const handleMeasurement = (0, import_react643.useCallback)(() => {
    if (animationFrame.current) {
      cancelAnimationFrame(animationFrame.current);
    }
    animationFrame.current = requestAnimationFrame(() => {
  ...
  const tabsMarkup = tabs.map((tab, index) => {
    return import_react643.default.createElement(Tab, {
      measuring: true,
  ...
  const classname = classNames(styles111.Tabs, styles111.TabMeasurer);
  return import_react643.default.createElement("div", {
    className: classname,
    ref: containerNode
  }, import_react643.default.createElement(EventListener, {
    event: "resize",
...
var import_react645 = __toModule(require_react());

// node_modules/@shopify/polaris/build/esm/components/Tabs/components/Item/Item.js
var import_react644 = __toModule(require_react());
var Item9 = class extends import_react644.PureComponent {
  constructor(...args) {
    super(...args);
    this.context = void 0;
  ...
  componentDidMount() {
    ...
    if (focusedNode && focusedNode instanceof HTMLElement && focused3) {
      focusedNode.focus();
    }
  }
  componentDidUpdate() {
  ...
  render() {
    ...
    const classname = classNames(styles111.Item);
    const sharedProps = {
      id,
    ...
    const markup = url ? import_react644.default.createElement(UnstyledLink, Object.assign({}, sharedProps, {
      url
    }), children2) : import_react644.default.createElement("button", Object.assign({}, sharedProps, {
      type: "button"
    }), children2);
    return import_react644.default.createElement("li", null, markup);
  }
};
...
function List3({
  ...
  const tabs = disclosureTabs.map(({
    ...
    return import_react645.default.createElement(Item9, Object.assign({
      key: id
    }, tabProps, {
      id,
  ...
  return import_react645.default.createElement("ul", {
    className: styles111.List,
...
// node_modules/@shopify/polaris/build/esm/components/Tabs/Tabs.js
var TabsInner = class extends import_react646.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      disclosureWidth: 0,
    ...
    this.renderTabMarkup = (tab, index) => {
      ...
      return import_react646.default.createElement(Tab, {
        key: `${index}-${tab.id}`,
        id: tab.id,
    ...
    this.handleFocus = (event) => {
      ...
      const target = event.target;
      if (target.classList.contains(styles111.Tab) || target.classList.contains(styles111.Item)) {
        let tabToFocus = -1;
      ...
      if (target.classList.contains(styles111.DisclosureActivator)) {
        return;
      }
      ...
      if (relatedTarget instanceof HTMLElement && !relatedTarget.classList.contains(styles111.Tab) && !relatedTarget.classList.contains(styles111.Item) && !relatedTarget.classList.contains(styles111.DisclosureActivator)) {
        this.setState({
          tabToFocus: selected
        });
      }
    ...
    this.handleBlur = (event) => {
      ...
      if (target instanceof HTMLElement && !target.classList.contains(styles111.Tab) && !target.classList.contains(styles111.Item)) {
        this.setState({
          tabToFocus: -1
        });
      }
  ...
  render() {
    ...
    const panelMarkup = children2 ? tabs.map((_tab, index) => {
      return selected === index ? import_react646.default.createElement(Panel, {
        id: tabs[index].panelID || `${tabs[index].id}-panel`,
        tabID: tabs[index].id,
        key: tabs[index].id
      }, children2) : import_react646.default.createElement(Panel, {
        id: tabs[index].panelID || `${tabs[index].id}-panel`,
        tabID: tabs[index].id,
        key: tabs[index].id,
        hidden: true
    ...
    const classname = classNames(styles111.Tabs, fitted && styles111.fitted, disclosureActivatorVisible && styles111.fillSpace);
    const disclosureTabClassName = classNames(styles111.DisclosureTab, disclosureActivatorVisible && styles111["DisclosureTab-visible"]);
    const disclosureButtonClassName = classNames(styles111.DisclosureActivator, hasCustomDisclosure && styles111.Tab);
    const disclosureButtonContentWrapperClassName = classNames(styles111.Title, hasCustomDisclosure && styles111.titleWithIcon);
    const disclosureButtonContent = hasCustomDisclosure ? import_react646.default.createElement(import_react646.default.Fragment, null, disclosureText, import_react646.default.createElement(Icon, {
      source: SvgCaretDownMinor,
      color: "subdued"
    })) : import_react646.default.createElement(Icon, {
      source: SvgHorizontalDotsMinor,
      color: "subdued"
    });
    const disclosureButton = import_react646.default.createElement("button", {
      type: "button",
      className: disclosureButtonClassName,
      onClick: this.handleDisclosureActivatorClick,
      "aria-label": i18n.translate("Polaris.Tabs.toggleTabsLabel")
    }, import_react646.default.createElement("span", {
      className: disclosureButtonContentWrapperClassName
    }, disclosureButtonContent));
    const activator = disclosureText ? import_react646.default.createElement("div", {
      className: styles111.TabContainer
    }, disclosureButton) : disclosureButton;
    return import_react646.default.createElement("div", null, import_react646.default.createElement("div", {
      className: styles111.Wrapper
    }, import_react646.default.createElement(TabMeasurer, {
      tabToFocus,
      activator,
      selected,
      tabs,
      siblingTabHasFocus: tabToFocus > -1,
      handleMeasurement: this.handleMeasurement
    }), import_react646.default.createElement("ul", {
      role: "tablist",
      className: classname,
      onFocus: this.handleFocus,
      onBlur: this.handleBlur,
    ...
    }, tabsMarkup, import_react646.default.createElement("li", {
      className: disclosureTabClassName,
      role: "presentation"
    }, import_react646.default.createElement(Popover2, {
      preferredPosition: "below",
      activator,
      active: disclosureActivatorVisible && showDisclosure,
      onClose: this.handleClose,
      autofocusTarget: "first-node"
    }, import_react646.default.createElement(List3, {
...
function Tabs(props) {
  const i18n = useI18n();
  return import_react646.default.createElement(TabsInner, Object.assign({}, props, {
    i18n
  }));
}

// node_modules/@shopify/polaris/build/esm/components/Thumbnail/Thumbnail.js
var import_react647 = __toModule(require_react());
...
function Thumbnail({
  ...
  const className = classNames(styles112.Thumbnail, size && styles112[variationName("size", size)]);
  const content = typeof source === "string" ? import_react647.default.createElement(Image, {
    alt,
    source
  }) : import_react647.default.createElement(Icon, {
    accessibilityLabel: alt,
    source
  });
  return import_react647.default.createElement("span", {
    className
  }, content);
}

// node_modules/@shopify/polaris/build/esm/components/Toast/Toast.js
var import_react648 = __toModule(require_react());
var Toast2 = (0, import_react648.memo)(function Toast3(props) {
...
var import_react656 = __toModule(require_react());
...
var import_react650 = __toModule(require_react());
...
var import_react649 = __toModule(require_react());
...
function SearchDismissOverlay({
  ...
  const node = (0, import_react649.useRef)(null);
  const handleDismiss = (0, import_react649.useCallback)(({
    target
  }) => {
  ...
  return import_react649.default.createElement(import_react649.default.Fragment, null, visible ? import_react649.default.createElement(ScrollLock, null) : null, import_react649.default.createElement("div", {
    ref: node,
    className: classNames(styles115.SearchDismissOverlay, visible && styles115.visible),
...
function Search({
  ...
  const overlayMarkup = visible ? import_react650.default.createElement(SearchDismissOverlay, {
    onDismiss,
    visible: overlayVisible
  }) : null;
  return import_react650.default.createElement(import_react650.default.Fragment, null, overlayMarkup, import_react650.default.createElement("div", {
    className: classNames(styles114.Search, visible && styles114.visible)
  }, import_react650.default.createElement(CustomProperties, {
    colorScheme: "dark"
  }, import_react650.default.createElement("div", {
    className: styles114.SearchContent
  }, import_react650.default.createElement("div", {
    className: styles114.Results
  }, children2)))));
}

// node_modules/@shopify/polaris/build/esm/components/TopBar/components/SearchField/SearchField.js
var import_react651 = __toModule(require_react());
...
function SearchField({
  ...
  const i18n = useI18n();
  const [forceActive, setForceActive] = (0, import_react651.useState)(false);
  const input = (0, import_react651.useRef)(null);
  const searchId = useUniqueId("SearchField");
  const handleChange = (0, import_react651.useCallback)(({
    currentTarget
  }) => {
    onChange(currentTarget.value);
  }, [onChange]);
  const handleFocus = (0, import_react651.useCallback)(() => onFocus && onFocus(), [onFocus]);
  const handleBlur = (0, import_react651.useCallback)(() => onBlur && onBlur(), [onBlur]);
  const handleClear = (0, import_react651.useCallback)(() => {
    onCancel && onCancel();
    if (!input.current) {
      return;
    }
  ...
  const clearMarkup = value !== "" && import_react651.default.createElement("button", {
    type: "button",
    "aria-label": i18n.translate("Polaris.TopBar.SearchField.clearButtonLabel"),
    className: styles116.Clear,
    onClick: handleClear,
    onBlur: () => {
  ...
  const className = classNames(styles116.SearchField, (focused3 || active || forceActive) && styles116.focused);
  return import_react651.default.createElement("div", {
    className,
    onFocus: handleFocus,
    onBlur: handleBlur
  }, import_react651.default.createElement(VisuallyHidden, null, import_react651.default.createElement("label", {
    htmlFor: searchId
  }, i18n.translate("Polaris.TopBar.SearchField.search"))), import_react651.default.createElement("input", {
    id: searchId,
    ...
    className: styles116.Icon
  }, import_react651.default.createElement(Icon, {
    source: SvgSearchMinor
  })), clearMarkup, import_react651.default.createElement("div", {
    className: classNames(styles116.Backdrop, showFocusBorder && styles116.BackdropShowFocusBorder)
  }));
}
...
var import_react655 = __toModule(require_react());
...
var import_react652 = __toModule(require_react());
...
function MessageIndicator({
  ...
  const indicatorMarkup = active && import_react652.default.createElement("div", {
    className: styles118.MessageIndicator
  });
  return import_react652.default.createElement("div", {
    className: styles118.MessageIndicatorWrapper
  }, indicatorMarkup, children2);
}

// node_modules/@shopify/polaris/build/esm/components/TopBar/components/Menu/Menu.js
var import_react654 = __toModule(require_react());
...
var import_react653 = __toModule(require_react());
...
function Message({
  ...
  const badgeMarkup = badge && import_react653.default.createElement(Badge, {
    status: badge.status
  }, badge.content);
  const {
    to,
  ...
  return import_react653.default.createElement("div", {
    className: styles120.Section
  }, import_react653.default.createElement(Popover2.Section, null, import_react653.default.createElement(Stack, {
    vertical: true,
    spacing: "tight"
  }, import_react653.default.createElement(TextContainer, null, import_react653.default.createElement(Heading, null, title, badgeMarkup), import_react653.default.createElement("p", null, description)), import_react653.default.createElement(Link, {
    url: to
  }, linkContent), import_react653.default.createElement(Button, {
    plain: true,
    onClick
  }, actionContent))));
}
...
function Menu(props) {
  ...
  const messageMarkup = message && import_react654.default.createElement(Message, {
    title: message.title,
  ...
  return import_react654.default.createElement(Popover2, {
    activator: import_react654.default.createElement("div", {
      className: styles119.ActivatorWrapper
    }, import_react654.default.createElement("button", {
      type: "button",
      className: styles119.Activator,
      onClick: onOpen,
      "aria-label": accessibilityLabel
    }, activatorContent)),
    active: open,
    ...
    preferredAlignment: "right",
    colorScheme
  }, import_react654.default.createElement(ActionList, {
...
function UserMenu({
  ...
  const activatorContentMarkup = import_react655.default.createElement(import_react655.default.Fragment, null, import_react655.default.createElement(MessageIndicator, {
    active: showIndicator
  }, import_react655.default.createElement(Avatar, {
    size: "small",
    source: avatar,
    initials: initials && initials.replace(" ", "")
  })), import_react655.default.createElement("span", {
    className: styles117.Details
  }, import_react655.default.createElement("p", {
    className: styles117.Name
  }, name), import_react655.default.createElement("p", {
    className: styles117.Detail
  }, detail)));
  return import_react655.default.createElement(Menu, {
...
var TopBar = function TopBar2({
  ...
  const iconClassName = classNames(styles113.NavigationIcon, focused3 && styles113.focused);
  const navigationButtonMarkup = showNavigationToggle ? import_react656.default.createElement("button", {
    type: "button",
    className: iconClassName,
  ...
  }, import_react656.default.createElement("div", {
    className: styles113.IconWrapper
  }, import_react656.default.createElement(Icon, {
    source: SvgMobileHamburgerMajor
  }))) : null;
  const width = getWidth(logo, 104);
  let contextMarkup;
  if (contextControl) {
    contextMarkup = import_react656.default.createElement("div", {
      className: styles113.ContextControl
    }, contextControl);
  } else if (logo) {
    const className = classNames(styles113.LogoContainer, showNavigationToggle || searchField ? styles113.LogoDisplayControl : styles113.LogoDisplayContainer);
    contextMarkup = import_react656.default.createElement("div", {
      className
    }, import_react656.default.createElement(UnstyledLink, {
      url: logo.url || "",
      className: styles113.LogoLink,
      style: {
        width
      }
    }, import_react656.default.createElement(Image, {
      source: logo.topBarSource || "",
      alt: logo.accessibilityLabel || "",
      className: styles113.Logo,
      style: {
        width
      }
    })));
  }
  const searchMarkup = searchField ? import_react656.default.createElement(import_react656.default.Fragment, null, searchField, import_react656.default.createElement(Search, {
    visible: searchResultsVisible,
    onDismiss: onSearchResultsDismiss,
    overlayVisible: searchResultsOverlayVisible
  }, searchResults)) : null;
  return import_react656.default.createElement("div", {
    className: styles113.TopBar
  }, navigationButtonMarkup, contextMarkup, import_react656.default.createElement("div", {
    className: styles113.Contents
  }, import_react656.default.createElement("div", {
    className: styles113.SearchField
  }, searchMarkup), import_react656.default.createElement("div", {
    className: styles113.SecondaryMenu
...
var import_react657 = __toModule(require_react());
...
function VideoThumbnail({
  ...
  const timeStampMarkup = videoLength ? import_react657.default.createElement("p", {
    className: classNames(styles121.Timestamp, showVideoProgress && styles121.withProgress)
  ...
  if (showVideoProgress) {
    ...
    progressMarkup = import_react657.default.createElement("div", {
      className: styles121.Progress
    }, import_react657.default.createElement("progress", {
      className: styles121.ProgressBar,
      value: progressValuePercents,
      max: "100"
    }), import_react657.default.createElement("div", {
      className: styles121.Indicator,
      style: {
        transform: `scaleX(${progressValue})`
      }
    }, import_react657.default.createElement("span", {
      className: styles121.Label
    }, progressValuePercents, "%")));
  }
  return import_react657.default.createElement("div", {
    className: styles121.Thumbnail,
    style: {
      backgroundImage: `url(${thumbnailUrl})`
    }
  }, import_react657.default.createElement("button", {
    type: "button",
    className: styles121.PlayButton,
    "aria-label": buttonLabel,
    onClick,
    onMouseEnter: onBeforeStartPlaying,
    onFocus: onBeforeStartPlaying,
    onTouchStart: onBeforeStartPlaying
  }, import_react657.default.createElement("img", {
    className: styles121.PlayIcon,
    src: PlayIcon,
    alt: ""
...
var import_react658 = __toModule(require_react());
function useRowHovered() {
  const hovered = (0, import_react658.useContext)(RowHoveredContext);
  return hovered;
}
function useRowSelected() {
  const {
    selected
  } = (0, import_react658.useContext)(RowContext);
  return selected;
}
function useContainerScroll() {
  const scrolledContainerRef = (0, import_react658.useContext)(ScrollContext);
